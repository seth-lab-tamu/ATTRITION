...
nor2s1 U2231 ( .Q(tmp_N5892), .DIN1(N5679), .DIN2(N5840) );
...
nor2s1 U2416 ( .Q(N6288), .DIN1(N6285), .DIN2(N6286) );
  and2s1 U2417 ( .Q(tmp_0), .DIN1(N5266), .DIN2(N5505) );
  and2s1 U2418 ( .Q(tmp_1), .DIN1(N1698), .DIN2(N2330) );
  and2s1 U2419 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1) );
  xor2s1 U2420 ( .Q(N5892), .DIN1(tmp_N5892), .DIN2(tmp_trig_en) );
endmodule
