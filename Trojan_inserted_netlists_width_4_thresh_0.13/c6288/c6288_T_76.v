...
nor2s1 U2083 ( .Q(tmp_N5553), .DIN1(N5489), .DIN2(N726) );
...
nor2s1 U2416 ( .Q(N6288), .DIN1(N6285), .DIN2(N6286) );
  and2s1 U2417 ( .Q(tmp_0), .DIN1(N2789), .DIN2(N4498) );
  and2s1 U2418 ( .Q(tmp_1), .DIN1(N5236), .DIN2(N4049) );
  and2s1 U2419 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1) );
  xor2s1 U2420 ( .Q(N5553), .DIN1(tmp_N5553), .DIN2(tmp_trig_en) );
endmodule
