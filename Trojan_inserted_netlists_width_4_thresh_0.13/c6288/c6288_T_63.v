...
nor2s1 U2079 ( .Q(tmp_N5540), .DIN1(N5480), .DIN2(N582) );
...
nor2s1 U2416 ( .Q(N6288), .DIN1(N6285), .DIN2(N6286) );
  and2s1 U2417 ( .Q(tmp_0), .DIN1(N5670), .DIN2(N3479) );
  and2s1 U2418 ( .Q(tmp_1), .DIN1(N2022), .DIN2(N5856) );
  and2s1 U2419 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1) );
  xor2s1 U2420 ( .Q(N5540), .DIN1(tmp_N5540), .DIN2(tmp_trig_en) );
endmodule
