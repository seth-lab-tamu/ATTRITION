...
nor2s1 U1122 ( .Q(tmp_N3327), .DIN1(N3218), .DIN2(N3272) );
...
nor2s1 U2416 ( .Q(N6288), .DIN1(N6285), .DIN2(N6286) );
  and2s1 U2417 ( .Q(tmp_0), .DIN1(N6030), .DIN2(N2526) );
  and2s1 U2418 ( .Q(tmp_1), .DIN1(N5378), .DIN2(N4561) );
  and2s1 U2419 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1) );
  xor2s1 U2420 ( .Q(N3327), .DIN1(tmp_N3327), .DIN2(tmp_trig_en) );
endmodule
