...
nor2s1 U2288 ( .Q(tmp_N6020), .DIN1(N5852), .DIN2(N5984) );
...
nor2s1 U2416 ( .Q(N6288), .DIN1(N6285), .DIN2(N6286) );
  and2s1 U2417 ( .Q(tmp_0), .DIN1(N6018), .DIN2(N4675) );
  and2s1 U2418 ( .Q(tmp_1), .DIN1(N1541), .DIN2(N1849) );
  and2s1 U2419 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1) );
  xor2s1 U2420 ( .Q(N6020), .DIN1(tmp_N6020), .DIN2(tmp_trig_en) );
endmodule
