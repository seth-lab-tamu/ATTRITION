...
wire tmp_0, tmp_1, tmp_2, tmp_3, tmp_4, tmp_5, tmp_6, tmp_7, tmp_trig_en, tmp_N799, n279, n280, n281, n282, n283, n284, n285, n286, n288, n289, n290, 
  ...
  and2s1 U777 ( .Q(tmp_0), .DIN1(N3881), .DIN2(n391) );
  and2s1 U778 ( .Q(tmp_1), .DIN1(n292), .DIN2(n388) );
  hi1s1 U779 ( .Q(tmp_2), .DIN(n713) );
  nor2s1 U780 ( .Q(tmp_3), .DIN1(tmp_2), .DIN2(n392) );
  nor2s1 U781 ( .Q(tmp_4), .DIN1(N1970), .DIN2(n285) );
  nor2s1 U782 ( .Q(tmp_5), .DIN1(n296), .DIN2(N3079) );
