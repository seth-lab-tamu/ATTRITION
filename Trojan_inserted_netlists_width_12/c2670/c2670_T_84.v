...
wire tmp_0, tmp_1, tmp_2, tmp_3, tmp_4, tmp_5, tmp_6, tmp_7, tmp_8, tmp_trig_en, tmp_N1971, n279, n280, n281, n282, n283, n284, n285, n286, n288, n289, n290, 
  ...
  nor2s1 U781 ( .Q(tmp_4), .DIN1(n296), .DIN2(n285) );
  and2s1 U782 ( .Q(tmp_5), .DIN1(n765), .DIN2(n756) );
  and2s1 U783 ( .Q(tmp_6), .DIN1(n388), .DIN2(n712) );
  hi1s1 U784 ( .Q(tmp_7), .DIN(n759) );
  nor2s1 U785 ( .Q(tmp_8), .DIN1(tmp_7), .DIN2(N1448) );
