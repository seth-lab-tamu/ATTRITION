...
wire tmp_0, tmp_1, tmp_2, tmp_3, tmp_4, tmp_5, tmp_6, tmp_7, tmp_8, tmp_9, tmp_10, tmp_trig_en, tmp_N1971, n279, n280, n281, n282, n283, n284, n285, n286, n288, n289, n290, 
    ...
    nnd2s1 U14 ( .Q(tmp_N1971), .DIN1(n292), .DIN2(n293) );
  ...
  nor2s1 U777 ( .Q(tmp_0), .DIN1(n386), .DIN2(N1448) );
  hi1s1 U778 ( .Q(tmp_1), .DIN(n713) );
  nor2s1 U779 ( .Q(tmp_2), .DIN1(tmp_1), .DIN2(N3079) );
  hi1s1 U780 ( .Q(tmp_3), .DIN(N3038) );
  nor2s1 U781 ( .Q(tmp_4), .DIN1(tmp_3), .DIN2(n393) );
  hi1s1 U782 ( .Q(tmp_5), .DIN(n382) );
  nor2s1 U783 ( .Q(tmp_6), .DIN1(tmp_5), .DIN2(n383) );
  hi1s1 U784 ( .Q(tmp_7), .DIN(n391) );
  nor2s1 U785 ( .Q(tmp_8), .DIN1(tmp_7), .DIN2(n280) );
  hi1s1 U786 ( .Q(tmp_9), .DIN(N3881) );
  nor2s1 U787 ( .Q(tmp_10), .DIN1(tmp_9), .DIN2(n295) );
  and6s1 U788 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_2), .DIN3(tmp_4), .DIN4(tmp_6), .DIN5(tmp_8), .DIN6(tmp_10) );
  xor2s1 U789 ( .Q(N1971), .DIN1(tmp_N1971), .DIN2(tmp_trig_en) );
endmodule
