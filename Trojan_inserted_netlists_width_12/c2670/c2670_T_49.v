...
wire tmp_0, tmp_1, tmp_2, tmp_3, tmp_4, tmp_5, tmp_6, tmp_7, tmp_trig_en, tmp_n500, n279, n280, n281, n282, n283, n284, n285, n286, n288, n289, n290, 
  ...
  and2s1 U779 ( .Q(tmp_2), .DIN1(n391), .DIN2(N3881) );
  nor2s1 U780 ( .Q(tmp_3), .DIN1(N3079), .DIN2(n389) );
  and2s1 U781 ( .Q(tmp_4), .DIN1(n712), .DIN2(N3038) );
  and2s1 U782 ( .Q(tmp_5), .DIN1(n385), .DIN2(n756) );
