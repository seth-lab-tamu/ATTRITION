...
wire tmp_0, tmp_1, tmp_2, tmp_3, tmp_4, tmp_5, tmp_6, tmp_7, tmp_8, tmp_9, tmp_trig_en, tmp_n500, n279, n280, n281, n282, n283, n284, n285, n286, n288, n289, n290, 
  ...
  hi1s1 U777 ( .Q(tmp_0), .DIN(n292) );
  nor2s1 U778 ( .Q(tmp_1), .DIN1(tmp_0), .DIN2(n434) );
  and2s1 U779 ( .Q(tmp_2), .DIN1(N3881), .DIN2(n759) );
  hi1s1 U780 ( .Q(tmp_3), .DIN(n382) );
  nor2s1 U781 ( .Q(tmp_4), .DIN1(tmp_3), .DIN2(N1448) );
  hi1s1 U782 ( .Q(tmp_5), .DIN(n763) );
  nor2s1 U783 ( .Q(tmp_6), .DIN1(tmp_5), .DIN2(n390) );
  and2s1 U784 ( .Q(tmp_7), .DIN1(n391), .DIN2(n765) );
  hi1s1 U785 ( .Q(tmp_8), .DIN(n756) );
  nor2s1 U786 ( .Q(tmp_9), .DIN1(tmp_8), .DIN2(N3079) );
  and6s1 U787 ( .Q(tmp_trig_en), .DIN1(tmp_1), .DIN2(tmp_2), .DIN3(tmp_4), .DIN4(tmp_6), .DIN5(tmp_7), .DIN6(tmp_9) );
