...
wire tmp_0, tmp_1, tmp_2, tmp_3, tmp_4, tmp_5, tmp_6, tmp_7, tmp_8, tmp_9, tmp_trig_en, tmp_N799, n279, n280, n281, n282, n283, n284, n285, n286, n288, n289, n290, 
  ...
  hi1s1 U777 ( .Q(tmp_0), .DIN(n765) );
  nor2s1 U778 ( .Q(tmp_1), .DIN1(tmp_0), .DIN2(N1448) );
  hi1s1 U779 ( .Q(tmp_2), .DIN(n388) );
  nor2s1 U780 ( .Q(tmp_3), .DIN1(tmp_2), .DIN2(n383) );
  and2s1 U781 ( .Q(tmp_4), .DIN1(n385), .DIN2(n382) );
  hi1s1 U782 ( .Q(tmp_5), .DIN(n292) );
  nor2s1 U783 ( .Q(tmp_6), .DIN1(tmp_5), .DIN2(N3882) );
  hi1s1 U784 ( .Q(tmp_7), .DIN(N3038) );
  nor2s1 U785 ( .Q(tmp_8), .DIN1(tmp_7), .DIN2(n390) );
  and2s1 U786 ( .Q(tmp_9), .DIN1(N1277), .DIN2(n761) );
  and6s1 U787 ( .Q(tmp_trig_en), .DIN1(tmp_1), .DIN2(tmp_3), .DIN3(tmp_4), .DIN4(tmp_6), .DIN5(tmp_8), .DIN6(tmp_9) );
  xor2s1 U788 ( .Q(N799), .DIN1(tmp_N799), .DIN2(tmp_trig_en) );
endmodule
