...
wire tmp_0, tmp_1, tmp_2, tmp_3, tmp_4, tmp_5, tmp_6, tmp_7, tmp_trig_en, tmp_N3038, n279, n280, n281, n282, n283, n284, n285, n286, n288, n289, n290, 
  ...
  nor2s1 U777 ( .Q(tmp_0), .DIN1(n668), .DIN2(n280) );
  hi1s1 U778 ( .Q(tmp_1), .DIN(n292) );
  nor2s1 U779 ( .Q(tmp_2), .DIN1(tmp_1), .DIN2(n849) );
  nor2s1 U780 ( .Q(tmp_3), .DIN1(n392), .DIN2(n390) );
  and2s1 U781 ( .Q(tmp_4), .DIN1(n713), .DIN2(n666) );
  hi1s1 U782 ( .Q(tmp_5), .DIN(n391) );
  nor2s1 U783 ( .Q(tmp_6), .DIN1(tmp_5), .DIN2(n389) );
  nor2s1 U784 ( .Q(tmp_7), .DIN1(n848), .DIN2(n838) );
  and6s1 U785 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_2), .DIN3(tmp_3), .DIN4(tmp_4), .DIN5(tmp_6), .DIN6(tmp_7) );
