...
wire tmp_0, tmp_1, tmp_2, tmp_3, tmp_4, tmp_5, tmp_6, tmp_7, tmp_8, tmp_trig_en, tmp_N3079, n279, n280, n281, n282, n283, n284, n285, n286, n288, n289, n290, 
  ...
  nor2s1 U777 ( .Q(tmp_0), .DIN1(n390), .DIN2(n383) );
  hi1s1 U778 ( .Q(tmp_1), .DIN(n759) );
  nor2s1 U779 ( .Q(tmp_2), .DIN1(tmp_1), .DIN2(n280) );
  nor2s1 U780 ( .Q(tmp_3), .DIN1(N1970), .DIN2(n393) );
  hi1s1 U781 ( .Q(tmp_4), .DIN(N3881) );
  nor2s1 U782 ( .Q(tmp_5), .DIN1(tmp_4), .DIN2(n285) );
  nor2s1 U783 ( .Q(tmp_6), .DIN1(n389), .DIN2(n296) );
  hi1s1 U784 ( .Q(tmp_7), .DIN(n388) );
  nor2s1 U785 ( .Q(tmp_8), .DIN1(tmp_7), .DIN2(n386) );
