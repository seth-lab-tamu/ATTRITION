...
wire tmp_0, tmp_1, tmp_2, tmp_3, tmp_4, tmp_5, tmp_6, tmp_7, tmp_8, tmp_9, tmp_trig_en, tmp_n293, n279, n280, n281, n282, n283, n284, n285, n286, n288, n289, n290, 
  ...
  nor2s1 U779 ( .Q(tmp_2), .DIN1(n389), .DIN2(n393) );
  hi1s1 U780 ( .Q(tmp_3), .DIN(n759) );
  nor2s1 U781 ( .Q(tmp_4), .DIN1(tmp_3), .DIN2(n295) );
  hi1s1 U782 ( .Q(tmp_5), .DIN(n382) );
  nor2s1 U783 ( .Q(tmp_6), .DIN1(tmp_5), .DIN2(N1970) );
  hi1s1 U784 ( .Q(tmp_7), .DIN(N3038) );
  nor2s1 U785 ( .Q(tmp_8), .DIN1(tmp_7), .DIN2(n486) );
  and2s1 U786 ( .Q(tmp_9), .DIN1(n391), .DIN2(n756) );
  and6s1 U787 ( .Q(tmp_trig_en), .DIN1(tmp_1), .DIN2(tmp_2), .DIN3(tmp_4), .DIN4(tmp_6), .DIN5(tmp_8), .DIN6(tmp_9) );
