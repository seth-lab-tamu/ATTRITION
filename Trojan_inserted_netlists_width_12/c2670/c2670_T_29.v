...
wire tmp_0, tmp_1, tmp_2, tmp_3, tmp_4, tmp_5, tmp_6, tmp_7, tmp_trig_en, tmp_N3079, n279, n280, n281, n282, n283, n284, n285, n286, n288, n289, n290, 
  ...
  nor2s1 U778 ( .Q(tmp_1), .DIN1(n386), .DIN2(n280) );
  hi1s1 U779 ( .Q(tmp_2), .DIN(N3881) );
  nor2s1 U780 ( .Q(tmp_3), .DIN1(tmp_2), .DIN2(n285) );
  nor2s1 U781 ( .Q(tmp_4), .DIN1(n393), .DIN2(n838) );
  nor2s1 U782 ( .Q(tmp_5), .DIN1(n392), .DIN2(n390) );
  hi1s1 U783 ( .Q(tmp_6), .DIN(n385) );
