...
wire tmp_0, tmp_1, tmp_2, tmp_3, tmp_4, tmp_5, tmp_6, tmp_7, tmp_8, tmp_trig_en, tmp_n293, n279, n280, n281, n282, n283, n284, n285, n286, n288, n289, n290, 
  ...
  nor2s1 U777 ( .Q(tmp_0), .DIN1(N1970), .DIN2(N1448) );
  hi1s1 U778 ( .Q(tmp_1), .DIN(n391) );
  nor2s1 U779 ( .Q(tmp_2), .DIN1(tmp_1), .DIN2(n295) );
  ...
  and2s1 U784 ( .Q(tmp_7), .DIN1(n765), .DIN2(N3881) );
  and2s1 U785 ( .Q(tmp_8), .DIN1(n382), .DIN2(n763) );
