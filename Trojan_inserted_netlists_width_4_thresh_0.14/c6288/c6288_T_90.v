...
nor2s1 U2267 ( .Q(tmp_N5972), .DIN1(N5933), .DIN2(N5934) );
...
nor2s1 U2416 ( .Q(N6288), .DIN1(N6285), .DIN2(N6286) );
  and2s1 U2417 ( .Q(tmp_0), .DIN1(N3300), .DIN2(N5287) );
  and2s1 U2418 ( .Q(tmp_1), .DIN1(N4350), .DIN2(N1690) );
  and2s1 U2419 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1) );
  xor2s1 U2420 ( .Q(N5972), .DIN1(tmp_N5972), .DIN2(tmp_trig_en) );
endmodule
