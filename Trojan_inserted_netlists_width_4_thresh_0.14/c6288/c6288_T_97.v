...
nor2s1 U1695 ( .Q(tmp_N4650), .DIN1(N4595), .DIN2(N4531) );
...
nor2s1 U2416 ( .Q(N6288), .DIN1(N6285), .DIN2(N6286) );
  and2s1 U2417 ( .Q(tmp_0), .DIN1(N5420), .DIN2(N5249) );
  and2s1 U2418 ( .Q(tmp_1), .DIN1(N2516), .DIN2(N2821) );
  and2s1 U2419 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1) );
  xor2s1 U2420 ( .Q(N4650), .DIN1(tmp_N4650), .DIN2(tmp_trig_en) );
endmodule
