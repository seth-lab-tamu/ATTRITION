...
nor2s1 U1948 ( .Q(tmp_N5240), .DIN1(N5176), .DIN2(N579) );
...
nor2s1 U2416 ( .Q(N6288), .DIN1(N6285), .DIN2(N6286) );
  and2s1 U2417 ( .Q(tmp_0), .DIN1(N1854), .DIN2(N4138) );
  and2s1 U2418 ( .Q(tmp_1), .DIN1(N5979), .DIN2(N3321) );
  and2s1 U2419 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1) );
  xor2s1 U2420 ( .Q(N5240), .DIN1(tmp_N5240), .DIN2(tmp_trig_en) );
endmodule
