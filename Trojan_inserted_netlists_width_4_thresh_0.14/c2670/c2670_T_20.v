...
wire tmp_0, tmp_1, tmp_2, tmp_trig_en, tmp_n678, n279, n280, n281, n282, n283, n284, n285, n286, n288, n289, n290, 
    ...
    nor2s1 U311 ( .Q(tmp_n678), .DIN1(n775), .DIN2(n776) );
  ...
  nor2s1 U777 ( .Q(tmp_0), .DIN1(n515), .DIN2(n583) );
  hi1s1 U778 ( .Q(tmp_1), .DIN(n765) );
  nor2s1 U779 ( .Q(tmp_2), .DIN1(tmp_1), .DIN2(n575) );
  and2s1 U780 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_2) );
  xor2s1 U781 ( .Q(n678), .DIN1(tmp_n678), .DIN2(tmp_trig_en) );
endmodule
