...
wire tmp_0, tmp_1, tmp_2, tmp_trig_en, tmp_N1269, n279, n280, n281, n282, n283, n284, n285, n286, n288, n289, n290, 
    ...
    nnd2s1 U19 ( .Q(tmp_N1269), .DIN1(N325), .DIN2(n297) );
  ...
  nor2s1 U777 ( .Q(tmp_0), .DIN1(n664), .DIN2(n585) );
  hi1s1 U778 ( .Q(tmp_1), .DIN(N1277) );
  nor2s1 U779 ( .Q(tmp_2), .DIN1(tmp_1), .DIN2(n581) );
  and2s1 U780 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_2) );
  xor2s1 U781 ( .Q(N1269), .DIN1(tmp_N1269), .DIN2(tmp_trig_en) );
endmodule
