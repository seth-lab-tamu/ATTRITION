...
wire tmp_0, tmp_1, tmp_2, tmp_trig_en, tmp_n378, n279, n280, n281, n282, n283, n284, n285, n286, n288, n289, n290, 
  ...
  nor2s1 U779 ( .Q(tmp_2), .DIN1(n390), .DIN2(n507) );
  and2s1 U780 ( .Q(tmp_trig_en), .DIN1(tmp_1), .DIN2(tmp_2) );
  xor2s1 U781 ( .Q(n378), .DIN1(tmp_n378), .DIN2(tmp_trig_en) );
endmodule
