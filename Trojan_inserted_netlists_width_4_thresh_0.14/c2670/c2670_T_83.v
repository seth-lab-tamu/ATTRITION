...
wire tmp_0, tmp_1, tmp_trig_en, tmp_n694, n279, n280, n281, n282, n283, n284, n285, n286, n288, n289, n290, 
  ...
  nor2s1 U777 ( .Q(tmp_0), .DIN1(n390), .DIN2(n575) );
  nor2s1 U778 ( .Q(tmp_1), .DIN1(n838), .DIN2(n591) );
  and2s1 U779 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1) );
  xor2s1 U780 ( .Q(n694), .DIN1(tmp_n694), .DIN2(tmp_trig_en) );
endmodule
