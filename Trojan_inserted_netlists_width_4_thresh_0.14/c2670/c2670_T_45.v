...
wire tmp_0, tmp_1, tmp_2, tmp_3, tmp_trig_en, tmp_n356, n279, n280, n281, n282, n283, n284, n285, n286, n288, n289, n290, 
    ...
    nor2s1 U54 ( .Q(tmp_n356), .DIN1(n357), .DIN2(n358) );
  ...
  nor2s1 U778 ( .Q(tmp_1), .DIN1(tmp_0), .DIN2(n561) );
  hi1s1 U779 ( .Q(tmp_2), .DIN(n765) );
  nor2s1 U780 ( .Q(tmp_3), .DIN1(tmp_2), .DIN2(n506) );
  and2s1 U781 ( .Q(tmp_trig_en), .DIN1(tmp_1), .DIN2(tmp_3) );
  xor2s1 U782 ( .Q(n356), .DIN1(tmp_n356), .DIN2(tmp_trig_en) );
endmodule
