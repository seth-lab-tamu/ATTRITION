...
wire tmp_0, tmp_1, tmp_2, tmp_trig_en, tmp_n376, n279, n280, n281, n282, n283, n284, n285, n286, n288, n289, n290, 
    ...
    nor2s1 U62 ( .Q(tmp_n376), .DIN1(n354), .DIN2(n373) );
  ...
  nor2s1 U777 ( .Q(tmp_0), .DIN1(n384), .DIN2(n511) );
  hi1s1 U778 ( .Q(tmp_1), .DIN(n385) );
  nor2s1 U779 ( .Q(tmp_2), .DIN1(tmp_1), .DIN2(n560) );
  and2s1 U780 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_2) );
  xor2s1 U781 ( .Q(n376), .DIN1(tmp_n376), .DIN2(tmp_trig_en) );
endmodule
