...
nor2s1 U556 ( .Q(tmp_N2013), .DIN1(N1963), .DIN2(N1846) );
...
nor2s1 U2416 ( .Q(N6288), .DIN1(N6285), .DIN2(N6286) );
  and2s1 U2417 ( .Q(tmp_0), .DIN1(N4632), .DIN2(N5670) );
  and2s1 U2418 ( .Q(tmp_1), .DIN1(N5526), .DIN2(N1999) );
  and2s1 U2419 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1) );
  xor2s1 U2420 ( .Q(N2013), .DIN1(tmp_N2013), .DIN2(tmp_trig_en) );
endmodule
