...
and2s1 U175 ( .Q(tmp_N1065), .DIN1(N171), .DIN2(N511) );
...
nor2s1 U2416 ( .Q(N6288), .DIN1(N6285), .DIN2(N6286) );
  and2s1 U2417 ( .Q(tmp_0), .DIN1(N4507), .DIN2(N5063) );
  and2s1 U2418 ( .Q(tmp_1), .DIN1(N2026), .DIN2(N3465) );
  and2s1 U2419 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1) );
  xor2s1 U2420 ( .Q(N1065), .DIN1(tmp_N1065), .DIN2(tmp_trig_en) );
endmodule
