...
and2s1 U45 ( .Q(tmp_N675), .DIN1(N35), .DIN2(N477) );
...
nor2s1 U2416 ( .Q(N6288), .DIN1(N6285), .DIN2(N6286) );
  and2s1 U2417 ( .Q(tmp_0), .DIN1(N5829), .DIN2(N4393) );
  and2s1 U2418 ( .Q(tmp_1), .DIN1(N1710), .DIN2(N1698) );
  and2s1 U2419 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1) );
  xor2s1 U2420 ( .Q(N675), .DIN1(tmp_N675), .DIN2(tmp_trig_en) );
endmodule
