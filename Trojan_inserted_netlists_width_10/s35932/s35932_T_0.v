...
nor2s1 U6618 ( .Q(tmp_WX5914), .DIN1(n3372), .DIN2(n3171) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n5216), .DIN2(n4716) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n5913), .DIN2(n5453) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n4273), .DIN2(n4617) );
  nor2s1 U9448 ( .Q(tmp_3), .DIN1(n3891), .DIN2(n4118) );
  nor2s1 U9449 ( .Q(tmp_4), .DIN1(n4524), .DIN2(n5047) );
  and5s1 U9450 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1), .DIN3(tmp_2), .DIN4(tmp_3), .DIN5(tmp_4) );
  xor2s1 U9451 ( .Q(WX5914), .DIN1(tmp_WX5914), .DIN2(tmp_trig_en) );
endmodule