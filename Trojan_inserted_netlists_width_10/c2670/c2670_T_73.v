...
wire tmp_0, tmp_1, tmp_2, tmp_3, tmp_4, tmp_5, tmp_6, tmp_7, tmp_trig_en, tmp_n824, n279, n280, n281, n282, n283, n284, n285, n286, n288, n289, n290, 
  ...
  nor2s1 U777 ( .Q(tmp_0), .DIN1(n295), .DIN2(n383) );
  hi1s1 U778 ( .Q(tmp_1), .DIN(n391) );
  nor2s1 U779 ( .Q(tmp_2), .DIN1(tmp_1), .DIN2(n668) );
  nor2s1 U780 ( .Q(tmp_3), .DIN1(n848), .DIN2(N792) );
  ...
  and5s1 U785 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_2), .DIN3(tmp_3), .DIN4(tmp_5), .DIN5(tmp_7) );
  xor2s1 U786 ( .Q(n824), .DIN1(tmp_n824), .DIN2(tmp_trig_en) );
endmodule
