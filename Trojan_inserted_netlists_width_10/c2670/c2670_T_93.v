...
wire tmp_0, tmp_1, tmp_2, tmp_3, tmp_4, tmp_5, tmp_6, tmp_7, tmp_8, tmp_trig_en, tmp_n297, n279, n280, n281, n282, n283, n284, n285, n286, n288, n289, n290, 
    ...
    hi1s1 U484 ( .Q(tmp_n297), .DIN(N1028) );
  ...
  nor2s1 U779 ( .Q(tmp_2), .DIN1(n285), .DIN2(N1970) );
  ...
  xor2s1 U787 ( .Q(n297), .DIN1(tmp_n297), .DIN2(tmp_trig_en) );
endmodule
