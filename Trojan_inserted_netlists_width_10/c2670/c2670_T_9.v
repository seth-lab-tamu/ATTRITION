...
wire tmp_0, tmp_1, tmp_2, tmp_3, tmp_4, tmp_5, tmp_trig_en, tmp_N3079, n279, n280, n281, n282, n283, n284, n285, n286, n288, n289, n290, 
  ...
  nor2s1 U777 ( .Q(tmp_0), .DIN1(n296), .DIN2(n390) );
  nor2s1 U778 ( .Q(tmp_1), .DIN1(n389), .DIN2(n487) );
  and2s1 U779 ( .Q(tmp_2), .DIN1(n388), .DIN2(n712) );
  and2s1 U780 ( .Q(tmp_3), .DIN1(N3881), .DIN2(n713) );
