...
wire tmp_0, tmp_1, tmp_2, tmp_3, tmp_4, tmp_5, tmp_6, tmp_trig_en, tmp_n293, n279, n280, n281, n282, n283, n284, n285, n286, n288, n289, n290, 
  ...
  nor2s1 U777 ( .Q(tmp_0), .DIN1(N3882), .DIN2(n386) );
  and2s1 U778 ( .Q(tmp_1), .DIN1(N3038), .DIN2(n391) );
  and2s1 U779 ( .Q(tmp_2), .DIN1(N3881), .DIN2(n292) );
  ...
  xor2s1 U785 ( .Q(n293), .DIN1(tmp_n293), .DIN2(tmp_trig_en) );
endmodule
