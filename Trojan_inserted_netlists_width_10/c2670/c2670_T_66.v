...
wire tmp_0, tmp_1, tmp_2, tmp_3, tmp_4, tmp_5, tmp_trig_en, tmp_n500, n279, n280, n281, n282, n283, n284, n285, n286, n288, n289, n290, 
  ...
  and2s1 U779 ( .Q(tmp_2), .DIN1(n761), .DIN2(N1277) );
  nor2s1 U780 ( .Q(tmp_3), .DIN1(n389), .DIN2(n296) );
  nor2s1 U781 ( .Q(tmp_4), .DIN1(n393), .DIN2(n280) );
  nor2s1 U782 ( .Q(tmp_5), .DIN1(n383), .DIN2(n487) );
