...
wire tmp_0, tmp_1, tmp_2, tmp_3, tmp_4, tmp_trig_en, tmp_N1971, n279, n280, n281, n282, n283, n284, n285, n286, n288, n289, n290, 
  ...
  nor2s1 U777 ( .Q(tmp_0), .DIN1(N3079), .DIN2(n668) );
  and2s1 U778 ( .Q(tmp_1), .DIN1(n666), .DIN2(n382) );
  nor2s1 U779 ( .Q(tmp_2), .DIN1(n848), .DIN2(N792) );
  and2s1 U780 ( .Q(tmp_3), .DIN1(n712), .DIN2(n292) );
  nor2s1 U781 ( .Q(tmp_4), .DIN1(n383), .DIN2(n285) );
