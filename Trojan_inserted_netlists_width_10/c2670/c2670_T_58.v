...
wire tmp_0, tmp_1, tmp_2, tmp_3, tmp_4, tmp_trig_en, tmp_N1971, n279, n280, n281, n282, n283, n284, n285, n286, n288, n289, n290, 
  ...
  nor2s1 U777 ( .Q(tmp_0), .DIN1(n295), .DIN2(n285) );
  and2s1 U778 ( .Q(tmp_1), .DIN1(n292), .DIN2(n391) );
  and2s1 U779 ( .Q(tmp_2), .DIN1(n712), .DIN2(n388) );
  nor2s1 U780 ( .Q(tmp_3), .DIN1(N3882), .DIN2(n296) );
  and2s1 U781 ( .Q(tmp_4), .DIN1(n759), .DIN2(N3881) );
  and5s1 U782 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1), .DIN3(tmp_2), .DIN4(tmp_3), .DIN5(tmp_4) );
  xor2s1 U783 ( .Q(N1971), .DIN1(tmp_N1971), .DIN2(tmp_trig_en) );
endmodule
