...
wire tmp_0, tmp_1, tmp_2, tmp_3, tmp_4, tmp_5, tmp_trig_en, tmp_n712, n279, n280, n281, n282, n283, n284, n285, n286, n288, n289, n290, 
  ...
  and2s1 U778 ( .Q(tmp_1), .DIN1(N3881), .DIN2(n391) );
  and2s1 U779 ( .Q(tmp_2), .DIN1(n388), .DIN2(N1277) );
  and2s1 U780 ( .Q(tmp_3), .DIN1(n761), .DIN2(n756) );
  ...
  xor2s1 U784 ( .Q(n712), .DIN1(tmp_n712), .DIN2(tmp_trig_en) );
endmodule
