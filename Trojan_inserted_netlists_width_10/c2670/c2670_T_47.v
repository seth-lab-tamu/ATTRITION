...
wire tmp_0, tmp_1, tmp_2, tmp_3, tmp_4, tmp_5, tmp_6, tmp_trig_en, tmp_N1971, n279, n280, n281, n282, n283, n284, n285, n286, n288, n289, n290, 
  ...
  nor2s1 U777 ( .Q(tmp_0), .DIN1(N1448), .DIN2(n383) );
  nor2s1 U778 ( .Q(tmp_1), .DIN1(n392), .DIN2(N3079) );
  hi1s1 U779 ( .Q(tmp_2), .DIN(N3038) );
  nor2s1 U780 ( .Q(tmp_3), .DIN1(tmp_2), .DIN2(n389) );
  nor2s1 U781 ( .Q(tmp_4), .DIN1(n280), .DIN2(n296) );
  hi1s1 U782 ( .Q(tmp_5), .DIN(N3881) );
  nor2s1 U783 ( .Q(tmp_6), .DIN1(tmp_5), .DIN2(n849) );
  and5s1 U784 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1), .DIN3(tmp_3), .DIN4(tmp_4), .DIN5(tmp_6) );
