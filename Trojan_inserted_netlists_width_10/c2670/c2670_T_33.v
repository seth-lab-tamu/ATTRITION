...
wire tmp_0, tmp_1, tmp_2, tmp_3, tmp_4, tmp_5, tmp_6, tmp_7, tmp_8, tmp_trig_en, tmp_n391, n279, n280, n281, n282, n283, n284, n285, n286, n288, n289, n290, 
    ...
    nor2s1 U70 ( .Q(tmp_n391), .DIN1(n392), .DIN2(n393) );
  ...
  nor2s1 U785 ( .Q(tmp_8), .DIN1(n393), .DIN2(N1448) );
  and5s1 U786 ( .Q(tmp_trig_en), .DIN1(tmp_1), .DIN2(tmp_3), .DIN3(tmp_5), .DIN4(tmp_7), .DIN5(tmp_8) );
  xor2s1 U787 ( .Q(n391), .DIN1(tmp_n391), .DIN2(tmp_trig_en) );
endmodule
