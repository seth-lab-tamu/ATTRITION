...
wire tmp_0, tmp_1, tmp_2, tmp_3, tmp_4, tmp_5, tmp_trig_en, tmp_N799, n279, n280, n281, n282, n283, n284, n285, n286, n288, n289, n290, 
  ...
  nor2s1 U779 ( .Q(tmp_2), .DIN1(N792), .DIN2(n392) );
  nor2s1 U780 ( .Q(tmp_3), .DIN1(n386), .DIN2(N3882) );
  and2s1 U781 ( .Q(tmp_4), .DIN1(n385), .DIN2(n712) );
  nor2s1 U782 ( .Q(tmp_5), .DIN1(N3079), .DIN2(n848) );
  and5s1 U783 ( .Q(tmp_trig_en), .DIN1(tmp_1), .DIN2(tmp_2), .DIN3(tmp_3), .DIN4(tmp_4), .DIN5(tmp_5) );
