...
wire tmp_0, tmp_1, tmp_2, tmp_3, tmp_4, tmp_5, tmp_6, tmp_trig_en, tmp_N3038, n279, n280, n281, n282, n283, n284, n285, n286, n288, n289, n290, 
  ...
  and2s1 U777 ( .Q(tmp_0), .DIN1(n292), .DIN2(n761) );
  and2s1 U778 ( .Q(tmp_1), .DIN1(n763), .DIN2(n759) );
  nor2s1 U779 ( .Q(tmp_2), .DIN1(n280), .DIN2(n295) );
  ...
  and5s1 U784 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1), .DIN3(tmp_2), .DIN4(tmp_4), .DIN5(tmp_6) );
