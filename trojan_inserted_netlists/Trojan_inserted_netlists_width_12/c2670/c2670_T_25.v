...
wire tmp_0, tmp_1, tmp_2, tmp_3, tmp_4, tmp_5, tmp_6, tmp_7, tmp_trig_en, tmp_n293, n279, n280, n281, n282, n283, n284, n285, n286, n288, n289, n290, 
  ...
  nor2s1 U779 ( .Q(tmp_2), .DIN1(n386), .DIN2(n296) );
  and2s1 U780 ( .Q(tmp_3), .DIN1(N1277), .DIN2(n374) );
  hi1s1 U781 ( .Q(tmp_4), .DIN(n713) );
  nor2s1 U782 ( .Q(tmp_5), .DIN1(tmp_4), .DIN2(n280) );
  and2s1 U783 ( .Q(tmp_6), .DIN1(n391), .DIN2(n385) );
  nor2s1 U784 ( .Q(tmp_7), .DIN1(n849), .DIN2(n389) );
