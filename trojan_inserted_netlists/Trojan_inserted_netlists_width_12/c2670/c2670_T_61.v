...
wire tmp_0, tmp_1, tmp_2, tmp_3, tmp_4, tmp_5, tmp_6, tmp_7, tmp_8, tmp_trig_en, tmp_N3079, n279, n280, n281, n282, n283, n284, n285, n286, n288, n289, n290, 
  ...
  nor2s1 U777 ( .Q(tmp_0), .DIN1(n386), .DIN2(n296) );
  ...
  nor2s1 U783 ( .Q(tmp_6), .DIN1(tmp_5), .DIN2(n487) );
  nor2s1 U784 ( .Q(tmp_7), .DIN1(n486), .DIN2(N1448) );
  and2s1 U785 ( .Q(tmp_8), .DIN1(n292), .DIN2(N3881) );
