...
wire tmp_0, tmp_1, tmp_2, tmp_3, tmp_4, tmp_5, tmp_6, tmp_7, tmp_trig_en, tmp_n293, n279, n280, n281, n282, n283, n284, n285, n286, n288, n289, n290, 
  ...
  and2s1 U777 ( .Q(tmp_0), .DIN1(n292), .DIN2(N1277) );
  nor2s1 U778 ( .Q(tmp_1), .DIN1(n296), .DIN2(N1448) );
  nor2s1 U779 ( .Q(tmp_2), .DIN1(n434), .DIN2(n390) );
  nor2s1 U780 ( .Q(tmp_3), .DIN1(n393), .DIN2(n386) );
  ...
  and6s1 U785 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1), .DIN3(tmp_2), .DIN4(tmp_3), .DIN5(tmp_5), .DIN6(tmp_7) );
