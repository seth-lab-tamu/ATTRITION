...
wire tmp_0, tmp_1, tmp_2, tmp_3, tmp_4, tmp_5, tmp_6, tmp_trig_en, tmp_N3079, n279, n280, n281, n282, n283, n284, n285, n286, n288, n289, n290, 
  ...
  nor2s1 U780 ( .Q(tmp_3), .DIN1(n667), .DIN2(n295) );
  nor2s1 U781 ( .Q(tmp_4), .DIN1(N1448), .DIN2(N792) );
  nor2s1 U782 ( .Q(tmp_5), .DIN1(n390), .DIN2(n668) );
  and2s1 U783 ( .Q(tmp_6), .DIN1(n391), .DIN2(N3038) );
