...
wire tmp_0, tmp_1, tmp_2, tmp_3, tmp_4, tmp_5, tmp_6, tmp_7, tmp_trig_en, tmp_n300, n279, n280, n281, n282, n283, n284, n285, n286, n288, n289, n290, 
  ...
  and2s1 U779 ( .Q(tmp_2), .DIN1(N3038), .DIN2(n763) );
  nor2s1 U780 ( .Q(tmp_3), .DIN1(n296), .DIN2(n486) );
  hi1s1 U781 ( .Q(tmp_4), .DIN(n761) );
  nor2s1 U782 ( .Q(tmp_5), .DIN1(tmp_4), .DIN2(N3882) );
  and2s1 U783 ( .Q(tmp_6), .DIN1(N1277), .DIN2(n759) );
  nor2s1 U784 ( .Q(tmp_7), .DIN1(n393), .DIN2(n295) );
