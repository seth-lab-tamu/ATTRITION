...
wire tmp_0, tmp_1, tmp_2, tmp_3, tmp_4, tmp_5, tmp_6, tmp_7, tmp_trig_en, tmp_n300, n279, n280, n281, n282, n283, n284, n285, n286, n288, n289, n290, 
  ...
  and2s1 U779 ( .Q(tmp_2), .DIN1(n385), .DIN2(n756) );
  nor2s1 U780 ( .Q(tmp_3), .DIN1(n392), .DIN2(n389) );
  nor2s1 U781 ( .Q(tmp_4), .DIN1(N3882), .DIN2(n393) );
  hi1s1 U782 ( .Q(tmp_5), .DIN(n391) );
  nor2s1 U783 ( .Q(tmp_6), .DIN1(tmp_5), .DIN2(N1448) );
  nor2s1 U784 ( .Q(tmp_7), .DIN1(n386), .DIN2(n434) );
