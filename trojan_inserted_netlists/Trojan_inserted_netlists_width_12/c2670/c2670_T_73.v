...
wire tmp_0, tmp_1, tmp_2, tmp_3, tmp_4, tmp_5, tmp_6, tmp_trig_en, tmp_n381, n279, n280, n281, n282, n283, n284, n285, n286, n288, n289, n290, 
    ...
    nor2s1 U66 ( .Q(tmp_n381), .DIN1(n378), .DIN2(n380) );
  ...
  nor2s1 U777 ( .Q(tmp_0), .DIN1(n848), .DIN2(N3882) );
  hi1s1 U778 ( .Q(tmp_1), .DIN(N3881) );
  nor2s1 U779 ( .Q(tmp_2), .DIN1(tmp_1), .DIN2(n383) );
  nor2s1 U780 ( .Q(tmp_3), .DIN1(N792), .DIN2(n389) );
  nor2s1 U781 ( .Q(tmp_4), .DIN1(N1448), .DIN2(n285) );
  and2s1 U782 ( .Q(tmp_5), .DIN1(n385), .DIN2(n382) );
  nor2s1 U783 ( .Q(tmp_6), .DIN1(n295), .DIN2(n390) );
  and6s1 U784 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_2), .DIN3(tmp_3), .DIN4(tmp_4), .DIN5(tmp_5), .DIN6(tmp_6) );
  xor2s1 U785 ( .Q(n381), .DIN1(tmp_n381), .DIN2(tmp_trig_en) );
endmodule
