...
nor2s1 U8520 ( .Q(tmp_WX1292), .DIN1(n3393), .DIN2(n5725) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n4885), .DIN2(n4920) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n5919), .DIN2(n5282) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n3926), .DIN2(n4344) );
  nor2s1 U9448 ( .Q(tmp_3), .DIN1(n3625), .DIN2(n3898) );
  nor2s1 U9449 ( .Q(tmp_4), .DIN1(n3649), .DIN2(n3905) );
  nor2s1 U9450 ( .Q(tmp_5), .DIN1(n5174), .DIN2(n5501) );
  and6s1 U9451 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1), .DIN3(tmp_2), .DIN4(tmp_3), .DIN5(tmp_4), .DIN6(tmp_5) );
  xor2s1 U9452 ( .Q(WX1292), .DIN1(tmp_WX1292), .DIN2(tmp_trig_en) );
endmodule