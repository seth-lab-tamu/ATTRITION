...
hi1s1 U4756 ( .Q(tmp_n3380), .DIN(n3428) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n4483), .DIN2(n5559) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n4975), .DIN2(n4604) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n3731), .DIN2(n4393) );
  nor2s1 U9448 ( .Q(tmp_3), .DIN1(n5275), .DIN2(n4029) );
  nor2s1 U9449 ( .Q(tmp_4), .DIN1(n4717), .DIN2(n5478) );
  nor2s1 U9450 ( .Q(tmp_5), .DIN1(n4165), .DIN2(n3706) );
  and6s1 U9451 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1), .DIN3(tmp_2), .DIN4(tmp_3), .DIN5(tmp_4), .DIN6(tmp_5) );
  xor2s1 U9452 ( .Q(n3380), .DIN1(tmp_n3380), .DIN2(tmp_trig_en) );
endmodule