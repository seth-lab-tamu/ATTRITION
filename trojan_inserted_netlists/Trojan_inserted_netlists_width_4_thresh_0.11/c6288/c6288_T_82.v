...
nor2s1 U1449 ( .Q(tmp_N4077), .DIN1(N3977), .DIN2(N4022) );
...
nor2s1 U2416 ( .Q(N6288), .DIN1(N6285), .DIN2(N6286) );
  ...
  and2s1 U2418 ( .Q(tmp_1), .DIN1(N3590), .DIN2(N2357) );
  and2s1 U2419 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1) );
  xor2s1 U2420 ( .Q(N4077), .DIN1(tmp_N4077), .DIN2(tmp_trig_en) );
endmodule
