...
nor2s1 U1618 ( .Q(tmp_N4474), .DIN1(N4414), .DIN2(N717) );
...
nor2s1 U2416 ( .Q(N6288), .DIN1(N6285), .DIN2(N6286) );
  and2s1 U2417 ( .Q(tmp_0), .DIN1(N4348), .DIN2(N5670) );
  and2s1 U2418 ( .Q(tmp_1), .DIN1(N1531), .DIN2(N2334) );
  and2s1 U2419 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1) );
  xor2s1 U2420 ( .Q(N4474), .DIN1(tmp_N4474), .DIN2(tmp_trig_en) );
endmodule
