...
nor2s1 U2298 ( .Q(tmp_N6044), .DIN1(N5981), .DIN2(N6014) );
...
nor2s1 U2416 ( .Q(N6288), .DIN1(N6285), .DIN2(N6286) );
  and2s1 U2417 ( .Q(tmp_0), .DIN1(N3465), .DIN2(N1571) );
  and2s1 U2418 ( .Q(tmp_1), .DIN1(N1523), .DIN2(N5364) );
  and2s1 U2419 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1) );
  xor2s1 U2420 ( .Q(N6044), .DIN1(tmp_N6044), .DIN2(tmp_trig_en) );
endmodule
