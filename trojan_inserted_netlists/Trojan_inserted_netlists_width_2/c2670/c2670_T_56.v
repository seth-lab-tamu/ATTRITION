...
wire tmp_0, tmp_n909, n279, n280, n281, n282, n283, n284, n285, n286, n288, n289, n290, 
    ...
    nnd2s1 U595 ( .Q(tmp_n909), .DIN1(n491), .DIN2(n425) );
  ...
  nor2s1 U777 ( .Q(tmp_trig_en), .DIN1(n849), .DIN2(N1970) );
  xor2s1 U778 ( .Q(n909), .DIN1(tmp_n909), .DIN2(tmp_trig_en) );
endmodule
