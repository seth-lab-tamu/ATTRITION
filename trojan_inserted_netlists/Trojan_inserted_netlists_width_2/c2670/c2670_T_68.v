...
wire tmp_0, tmp_n487, n279, n280, n281, n282, n283, n284, n285, n286, n288, n289, n290, 
    ...
    nnd2s1 U577 ( .Q(tmp_n487), .DIN1(n756), .DIN2(N305) );
  ...
  nor2s1 U777 ( .Q(tmp_trig_en), .DIN1(n295), .DIN2(n434) );
  xor2s1 U778 ( .Q(n487), .DIN1(tmp_n487), .DIN2(tmp_trig_en) );
endmodule
