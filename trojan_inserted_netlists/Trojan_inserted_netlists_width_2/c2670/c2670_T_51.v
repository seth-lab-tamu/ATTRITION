...
wire tmp_0, tmp_trig_en, tmp_n801, n279, n280, n281, n282, n283, n284, n285, n286, n288, n289, n290, 
  ...
  nor2s1 U778 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(n383) );
  xor2s1 U779 ( .Q(n801), .DIN1(tmp_n801), .DIN2(tmp_trig_en) );
endmodule
