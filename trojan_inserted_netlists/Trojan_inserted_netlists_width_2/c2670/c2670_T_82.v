...
wire tmp_0, tmp_trig_en, tmp_n699, n279, n280, n281, n282, n283, n284, n285, n286, n288, n289, n290, 
    ...
    nor2s1 U344 ( .Q(tmp_n699), .DIN1(n806), .DIN2(n807) );
  ...
  nor2s1 U778 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(n390) );
  xor2s1 U779 ( .Q(n699), .DIN1(tmp_n699), .DIN2(tmp_trig_en) );
endmodule
