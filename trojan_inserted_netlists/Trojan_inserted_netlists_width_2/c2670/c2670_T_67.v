...
wire tmp_trig_en, tmp_N3079, n279, n280, n281, n282, n283, n284, n285, n286, n288, n289, n290, 
  ...
  and2s1 U777 ( .Q(tmp_trig_en), .DIN1(n374), .DIN2(N3038) );
  xor2s1 U778 ( .Q(N3079), .DIN1(tmp_N3079), .DIN2(tmp_trig_en) );
endmodule
