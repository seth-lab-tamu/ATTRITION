...
wire tmp_0, tmp_n883, n279, n280, n281, n282, n283, n284, n285, n286, n288, n289, n290, 
    ...
    hi1s1 U642 ( .Q(tmp_n883), .DIN(n881) );
  ...
  nor2s1 U777 ( .Q(tmp_trig_en), .DIN1(n390), .DIN2(N792) );
  xor2s1 U778 ( .Q(n883), .DIN1(tmp_n883), .DIN2(tmp_trig_en) );
endmodule
