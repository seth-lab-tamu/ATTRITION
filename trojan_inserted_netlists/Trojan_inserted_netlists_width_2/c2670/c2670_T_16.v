...
wire tmp_trig_en, tmp_n300, n279, n280, n281, n282, n283, n284, n285, n286, n288, n289, n290, 
  ...
  and2s1 U777 ( .Q(tmp_trig_en), .DIN1(n666), .DIN2(n391) );
  xor2s1 U778 ( .Q(n300), .DIN1(tmp_n300), .DIN2(tmp_trig_en) );
endmodule
