...
wire tmp_0, tmp_N3671, n279, n280, n281, n282, n283, n284, n285, n286, n288, n289, n290, 
    ...
    nor2s1 U408 ( .Q(tmp_N3671), .DIN1(n733), .DIN2(N37) );
  ...
  nor2s1 U777 ( .Q(tmp_trig_en), .DIN1(n486), .DIN2(n383) );
  xor2s1 U778 ( .Q(N3671), .DIN1(tmp_N3671), .DIN2(tmp_trig_en) );
endmodule
