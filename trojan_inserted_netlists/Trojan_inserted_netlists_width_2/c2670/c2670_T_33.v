...
wire tmp_trig_en, tmp_trig_en, tmp_n839, n279, n280, n281, n282, n283, n284, n285, n286, n288, n289, n290, 
    ...
    nnd2s1 U465 ( .Q(tmp_n839), .DIN1(n399), .DIN2(n436) );
  ...
  nor2s1 U778 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(n848) );
  xor2s1 U779 ( .Q(n839), .DIN1(tmp_n839), .DIN2(tmp_trig_en) );
endmodule
