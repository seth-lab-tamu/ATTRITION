...
wire tmp_0, tmp_n364, n279, n280, n281, n282, n283, n284, n285, n286, n288, n289, n290, 
    ...
    nnd2s1 U57 ( .Q(tmp_n364), .DIN1(n365), .DIN2(n366) );
  ...
  nor2s1 U777 ( .Q(tmp_trig_en), .DIN1(n296), .DIN2(N792) );
  xor2s1 U778 ( .Q(n364), .DIN1(tmp_n364), .DIN2(tmp_trig_en) );
endmodule
