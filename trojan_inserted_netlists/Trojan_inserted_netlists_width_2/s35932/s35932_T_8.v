...
hi1s1 U4795 ( .Q(tmp_n3419), .DIN(n3587) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_trig_en), .DIN1(n4926), .DIN2(n4152) );
  xor2s1 U9446 ( .Q(n3419), .DIN1(tmp_n3419), .DIN2(tmp_trig_en) );
endmodule