...
nor2s1 U5828 ( .Q(tmp_WX7745), .DIN1(n3389), .DIN2(n4085) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_trig_en), .DIN1(n3607), .DIN2(n4899) );
  xor2s1 U9446 ( .Q(WX7745), .DIN1(tmp_WX7745), .DIN2(tmp_trig_en) );
endmodule