...
nnd4s1 U5497 ( .Q(tmp_WX8450), .DIN1(n3868), .DIN2(n3869), .DIN3(n3870), .DIN4(n3871) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_trig_en), .DIN1(n5540), .DIN2(n5201) );
  xor2s1 U9446 ( .Q(WX8450), .DIN1(tmp_WX8450), .DIN2(tmp_trig_en) );
endmodule