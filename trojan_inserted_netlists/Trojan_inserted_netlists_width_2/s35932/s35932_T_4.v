...
nnd2s1 U7350 ( .Q(tmp_n5055), .DIN1(n3440), .DIN2(n5060) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_trig_en), .DIN1(n4109), .DIN2(n5850) );
  xor2s1 U9446 ( .Q(n5055), .DIN1(tmp_n5055), .DIN2(tmp_trig_en) );
endmodule