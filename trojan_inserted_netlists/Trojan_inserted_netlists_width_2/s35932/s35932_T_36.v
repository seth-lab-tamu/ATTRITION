...
nnd2s1 U6390 ( .Q(tmp_n4464), .DIN1(n3472), .DIN2(n4465) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_trig_en), .DIN1(n3755), .DIN2(n3605) );
  xor2s1 U9446 ( .Q(n4464), .DIN1(tmp_n4464), .DIN2(tmp_trig_en) );
endmodule