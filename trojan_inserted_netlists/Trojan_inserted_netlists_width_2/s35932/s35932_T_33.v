...
nnd4s1 U5069 ( .Q(tmp_WX9753), .DIN1(n3604), .DIN2(n3605), .DIN3(n3606), .DIN4(n3607) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_trig_en), .DIN1(n5158), .DIN2(n3670) );
  xor2s1 U9446 ( .Q(WX9753), .DIN1(tmp_WX9753), .DIN2(tmp_trig_en) );
endmodule