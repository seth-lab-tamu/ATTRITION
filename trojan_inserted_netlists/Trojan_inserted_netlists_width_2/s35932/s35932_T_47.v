...
nnd4s1 U5174 ( .Q(tmp_WX9711), .DIN1(n3730), .DIN2(n3731), .DIN3(n3732), .DIN4(n3733) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_trig_en), .DIN1(n5257), .DIN2(n4232) );
  xor2s1 U9446 ( .Q(WX9711), .DIN1(tmp_WX9711), .DIN2(tmp_trig_en) );
endmodule