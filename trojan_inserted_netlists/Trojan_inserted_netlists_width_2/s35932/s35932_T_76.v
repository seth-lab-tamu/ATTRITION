...
nor2s1 U5401 ( .Q(tmp_WX8536), .DIN1(n3384), .DIN2(n2977) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_trig_en), .DIN1(n4133), .DIN2(n4464) );
  xor2s1 U9446 ( .Q(WX8536), .DIN1(tmp_WX8536), .DIN2(tmp_trig_en) );
endmodule