...
nor2s1 U5261 ( .Q(tmp_WX9074), .DIN1(n3380), .DIN2(n3789) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_trig_en), .DIN1(n3775), .DIN2(n5995) );
  xor2s1 U9446 ( .Q(WX9074), .DIN1(tmp_WX9074), .DIN2(tmp_trig_en) );
endmodule