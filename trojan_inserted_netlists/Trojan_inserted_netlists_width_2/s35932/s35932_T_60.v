...
nnd4s1 U7239 ( .Q(tmp_WX4559), .DIN1(n4960), .DIN2(n4961), .DIN3(n4962), .DIN4(n4963) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_trig_en), .DIN1(n5904), .DIN2(n5179) );
  xor2s1 U9446 ( .Q(WX4559), .DIN1(tmp_WX4559), .DIN2(tmp_trig_en) );
endmodule