...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_trig_en), .DIN1(n6022), .DIN2(n3689) );
  xor2s1 U9446 ( .Q(n3471), .DIN1(tmp_n3471), .DIN2(tmp_trig_en) );
endmodule