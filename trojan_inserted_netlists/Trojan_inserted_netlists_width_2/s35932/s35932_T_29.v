...
nnd2s1 U9012 ( .Q(tmp_n5995), .DIN1(n3433), .DIN2(n3729) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_trig_en), .DIN1(n5062), .DIN2(n4013) );
  xor2s1 U9446 ( .Q(n5995), .DIN1(tmp_n5995), .DIN2(tmp_trig_en) );
endmodule