...
nor2s1 U8666 ( .Q(tmp_WX11618), .DIN1(n3397), .DIN2(n5811) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_trig_en), .DIN1(n5599), .DIN2(n4796) );
  xor2s1 U9446 ( .Q(WX11618), .DIN1(tmp_WX11618), .DIN2(tmp_trig_en) );
endmodule