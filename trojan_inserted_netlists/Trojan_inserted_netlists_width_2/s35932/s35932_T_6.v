...
nnd4s1 U5505 ( .Q(tmp_WX8448), .DIN1(n3875), .DIN2(n3876), .DIN3(n3877), .DIN4(n3878) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_trig_en), .DIN1(n3628), .DIN2(n4186) );
  xor2s1 U9446 ( .Q(WX8448), .DIN1(tmp_WX8448), .DIN2(tmp_trig_en) );
endmodule