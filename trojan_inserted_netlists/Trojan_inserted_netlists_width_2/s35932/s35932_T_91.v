...
nnd4s1 U8831 ( .Q(tmp_WX11048), .DIN1(n5856), .DIN2(n5857), .DIN3(n5858), .DIN4(n5859) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_trig_en), .DIN1(n5917), .DIN2(n5438) );
  xor2s1 U9446 ( .Q(WX11048), .DIN1(tmp_WX11048), .DIN2(tmp_trig_en) );
endmodule