...
nor2s1 U8662 ( .Q(tmp_WX11622), .DIN1(n3397), .DIN2(n5809) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_trig_en), .DIN1(n4468), .DIN2(n4645) );
  xor2s1 U9446 ( .Q(WX11622), .DIN1(tmp_WX11622), .DIN2(tmp_trig_en) );
endmodule