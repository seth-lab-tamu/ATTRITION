...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_trig_en), .DIN1(n5236), .DIN2(n4658) );
  xor2s1 U9446 ( .Q(WX1292), .DIN1(tmp_WX1292), .DIN2(tmp_trig_en) );
endmodule