...
nor2s1 U6615 ( .Q(tmp_WX5920), .DIN1(n3372), .DIN2(n3168) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_trig_en), .DIN1(n4701), .DIN2(n6044) );
  xor2s1 U9446 ( .Q(WX5920), .DIN1(tmp_WX5920), .DIN2(tmp_trig_en) );
endmodule