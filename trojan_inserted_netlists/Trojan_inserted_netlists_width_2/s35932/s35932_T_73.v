...
nor2s1 U7572 ( .Q(tmp_WX3352), .DIN1(n3411), .DIN2(n3191) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_trig_en), .DIN1(n4754), .DIN2(n4137) );
  xor2s1 U9446 ( .Q(WX3352), .DIN1(tmp_WX3352), .DIN2(tmp_trig_en) );
endmodule