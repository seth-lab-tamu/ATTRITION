...
nor2s1 U7910 ( .Q(tmp_WX2615), .DIN1(n3413), .DIN2(n5386) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_trig_en), .DIN1(n4456), .DIN2(n3974) );
  xor2s1 U9446 ( .Q(WX2615), .DIN1(tmp_WX2615), .DIN2(tmp_trig_en) );
endmodule