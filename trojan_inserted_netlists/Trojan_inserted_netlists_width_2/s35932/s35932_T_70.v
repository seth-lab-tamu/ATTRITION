...
nor2s1 U8647 ( .Q(tmp_WX11636), .DIN1(n3396), .DIN2(n5801) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_trig_en), .DIN1(n4468), .DIN2(n5931) );
  xor2s1 U9446 ( .Q(WX11636), .DIN1(tmp_WX11636), .DIN2(tmp_trig_en) );
endmodule