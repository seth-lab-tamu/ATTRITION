...
nnd2s1 U6110 ( .Q(tmp_n4207), .DIN1(CRC_OUT_4_16), .DIN2(n3544) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_trig_en), .DIN1(n5478), .DIN2(n5502) );
  xor2s1 U9446 ( .Q(n4207), .DIN1(tmp_n4207), .DIN2(tmp_trig_en) );
endmodule