...
nor2s1 U7451 ( .Q(tmp_WX3900), .DIN1(n3407), .DIN2(n5115) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_trig_en), .DIN1(n3967), .DIN2(n3684) );
  xor2s1 U9446 ( .Q(WX3900), .DIN1(tmp_WX3900), .DIN2(tmp_trig_en) );
endmodule