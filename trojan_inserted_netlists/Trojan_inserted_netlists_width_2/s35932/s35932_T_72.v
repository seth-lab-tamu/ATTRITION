...
nor2s1 U7465 ( .Q(tmp_WX3886), .DIN1(n3407), .DIN2(n5122) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_trig_en), .DIN1(n4394), .DIN2(n5072) );
  xor2s1 U9446 ( .Q(WX3886), .DIN1(tmp_WX3886), .DIN2(tmp_trig_en) );
endmodule