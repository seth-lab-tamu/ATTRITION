...
nor2s1 U5922 ( .Q(tmp_WX7261), .DIN1(n3390), .DIN2(n2984) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_trig_en), .DIN1(n5469), .DIN2(n4920) );
  xor2s1 U9446 ( .Q(WX7261), .DIN1(tmp_WX7261), .DIN2(tmp_trig_en) );
endmodule