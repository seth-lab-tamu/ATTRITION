...
nnd2s1 U6348 ( .Q(tmp_n4415), .DIN1(n3472), .DIN2(n4416) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_trig_en), .DIN1(n4145), .DIN2(n4602) );
  xor2s1 U9446 ( .Q(n4415), .DIN1(tmp_n4415), .DIN2(tmp_trig_en) );
endmodule