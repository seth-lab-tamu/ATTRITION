...
nnd2s1 U8256 ( .Q(tmp_n5548), .DIN1(WX1808), .DIN2(n3498) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_trig_en), .DIN1(n4406), .DIN2(n4968) );
  xor2s1 U9446 ( .Q(n5548), .DIN1(tmp_n5548), .DIN2(tmp_trig_en) );
endmodule