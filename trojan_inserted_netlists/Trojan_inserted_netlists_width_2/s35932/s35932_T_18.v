...
nor2s1 U5299 ( .Q(tmp_WX9038), .DIN1(n3382), .DIN2(n3809) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_trig_en), .DIN1(n5368), .DIN2(n5999) );
  xor2s1 U9446 ( .Q(WX9038), .DIN1(tmp_WX9038), .DIN2(tmp_trig_en) );
endmodule