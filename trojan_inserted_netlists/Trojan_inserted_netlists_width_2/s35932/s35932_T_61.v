...
nor2s1 U5387 ( .Q(tmp_WX8560), .DIN1(n3383), .DIN2(n2965) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_trig_en), .DIN1(n4132), .DIN2(n5956) );
  xor2s1 U9446 ( .Q(WX8560), .DIN1(tmp_WX8560), .DIN2(tmp_trig_en) );
endmodule