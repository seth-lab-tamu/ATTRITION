...
hi1s1 U4796 ( .Q(tmp_n3420), .DIN(n3587) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_trig_en), .DIN1(n5922), .DIN2(n4746) );
  xor2s1 U9446 ( .Q(n3420), .DIN1(tmp_n3420), .DIN2(tmp_trig_en) );
endmodule