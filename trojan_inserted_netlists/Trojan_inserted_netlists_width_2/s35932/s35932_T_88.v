...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_trig_en), .DIN1(n5668), .DIN2(n5452) );
  xor2s1 U9446 ( .Q(WX2565), .DIN1(tmp_WX2565), .DIN2(tmp_trig_en) );
endmodule