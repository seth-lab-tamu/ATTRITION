...
nnd2s1 U6402 ( .Q(tmp_n4478), .DIN1(n3472), .DIN2(n4479) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_trig_en), .DIN1(n5924), .DIN2(n4891) );
  xor2s1 U9446 ( .Q(n4478), .DIN1(tmp_n4478), .DIN2(tmp_trig_en) );
endmodule