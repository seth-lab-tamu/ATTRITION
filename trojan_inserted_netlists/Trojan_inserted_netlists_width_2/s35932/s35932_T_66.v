...
nnd4s1 U5094 ( .Q(tmp_WX9743), .DIN1(n3634), .DIN2(n3635), .DIN3(n3636), .DIN4(n3637) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_trig_en), .DIN1(n4258), .DIN2(n5620) );
  xor2s1 U9446 ( .Q(WX9743), .DIN1(tmp_WX9743), .DIN2(tmp_trig_en) );
endmodule