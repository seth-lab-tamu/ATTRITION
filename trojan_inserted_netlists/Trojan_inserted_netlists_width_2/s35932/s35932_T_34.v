...
nnd2s1 U6328 ( .Q(tmp_n4384), .DIN1(CRC_OUT_9_7), .DIN2(n3542) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_trig_en), .DIN1(n3910), .DIN2(n3964) );
  xor2s1 U9446 ( .Q(n4384), .DIN1(tmp_n4384), .DIN2(tmp_trig_en) );
endmodule