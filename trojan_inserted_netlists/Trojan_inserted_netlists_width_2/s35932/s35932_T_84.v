...
nor2s1 U7459 ( .Q(tmp_WX3892), .DIN1(n3407), .DIN2(n5119) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_trig_en), .DIN1(n5031), .DIN2(n5266) );
  xor2s1 U9446 ( .Q(WX3892), .DIN1(tmp_WX3892), .DIN2(tmp_trig_en) );
endmodule