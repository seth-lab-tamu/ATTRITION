...
hi1s1 U4802 ( .Q(tmp_n3426), .DIN(n3587) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_trig_en), .DIN1(n4892), .DIN2(n6023) );
  xor2s1 U9446 ( .Q(n3426), .DIN1(tmp_n3426), .DIN2(tmp_trig_en) );
endmodule