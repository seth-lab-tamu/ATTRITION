...
nor2s1 U1273 ( .Q(tmp_N3670), .DIN1(N3565), .DIN2(N3620) );
...
nor2s1 U2416 ( .Q(N6288), .DIN1(N6285), .DIN2(N6286) );
  and2s1 U2417 ( .Q(tmp_trig_en), .DIN1(N2639), .DIN2(N1531) );
  xor2s1 U2418 ( .Q(N3670), .DIN1(tmp_N3670), .DIN2(tmp_trig_en) );
endmodule
