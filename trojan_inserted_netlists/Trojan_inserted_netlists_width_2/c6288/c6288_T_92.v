...
nor2s1 U847 ( .Q(tmp_N2672), .DIN1(N2631), .DIN2(N2523) );
...
nor2s1 U2416 ( .Q(N6288), .DIN1(N6285), .DIN2(N6286) );
  and2s1 U2417 ( .Q(tmp_trig_en), .DIN1(N4098), .DIN2(N1821) );
  xor2s1 U2418 ( .Q(N2672), .DIN1(tmp_N2672), .DIN2(tmp_trig_en) );
endmodule
