...
nor2s1 U907 ( .Q(tmp_N2826), .DIN1(N2706), .DIN2(N2761) );
...
nor2s1 U2416 ( .Q(N6288), .DIN1(N6285), .DIN2(N6286) );
  and2s1 U2417 ( .Q(tmp_trig_en), .DIN1(N2336), .DIN2(N2342) );
  xor2s1 U2418 ( .Q(N2826), .DIN1(tmp_N2826), .DIN2(tmp_trig_en) );
endmodule
