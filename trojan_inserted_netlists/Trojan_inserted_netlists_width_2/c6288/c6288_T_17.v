...
nor2s1 U1619 ( .Q(tmp_N4478), .DIN1(N4417), .DIN2(N765) );
...
nor2s1 U2416 ( .Q(N6288), .DIN1(N6285), .DIN2(N6286) );
  and2s1 U2417 ( .Q(tmp_trig_en), .DIN1(N3131), .DIN2(N2639) );
  xor2s1 U2418 ( .Q(N4478), .DIN1(tmp_N4478), .DIN2(tmp_trig_en) );
endmodule
