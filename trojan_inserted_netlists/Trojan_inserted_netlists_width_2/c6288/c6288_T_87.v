...
and2s1 U94 ( .Q(tmp_N822), .DIN1(N86), .DIN2(N494) );
...
nor2s1 U2416 ( .Q(N6288), .DIN1(N6285), .DIN2(N6286) );
  and2s1 U2417 ( .Q(tmp_trig_en), .DIN1(N1566), .DIN2(N1698) );
  xor2s1 U2418 ( .Q(N822), .DIN1(tmp_N822), .DIN2(tmp_trig_en) );
endmodule
