...
nor2s1 U1550 ( .Q(tmp_N4320), .DIN1(N4264), .DIN2(N4265) );
...
nor2s1 U2416 ( .Q(N6288), .DIN1(N6285), .DIN2(N6286) );
  and2s1 U2417 ( .Q(tmp_trig_en), .DIN1(N1819), .DIN2(N4746) );
  xor2s1 U2418 ( .Q(N4320), .DIN1(tmp_N4320), .DIN2(tmp_trig_en) );
endmodule
