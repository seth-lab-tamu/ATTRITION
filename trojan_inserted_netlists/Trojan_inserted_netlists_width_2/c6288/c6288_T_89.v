...
nor2s1 U1970 ( .Q(tmp_N5287), .DIN1(N5160), .DIN2(N5221) );
...
nor2s1 U2416 ( .Q(N6288), .DIN1(N6285), .DIN2(N6286) );
  and2s1 U2417 ( .Q(tmp_trig_en), .DIN1(N1710), .DIN2(N4812) );
  xor2s1 U2418 ( .Q(N5287), .DIN1(tmp_N5287), .DIN2(tmp_trig_en) );
endmodule
