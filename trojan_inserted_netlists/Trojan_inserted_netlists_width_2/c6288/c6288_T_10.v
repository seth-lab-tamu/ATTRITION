...
nor2s1 U1644 ( .Q(tmp_N4534), .DIN1(N4411), .DIN2(N4470) );
...
nor2s1 U2416 ( .Q(N6288), .DIN1(N6285), .DIN2(N6286) );
  and2s1 U2417 ( .Q(tmp_trig_en), .DIN1(N1528), .DIN2(N1538) );
  xor2s1 U2418 ( .Q(N4534), .DIN1(tmp_N4534), .DIN2(tmp_trig_en) );
endmodule
