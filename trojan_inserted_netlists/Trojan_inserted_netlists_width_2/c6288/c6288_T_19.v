...
nor2s1 U1666 ( .Q(tmp_N4578), .DIN1(N4512), .DIN2(N4509) );
...
nor2s1 U2416 ( .Q(N6288), .DIN1(N6285), .DIN2(N6286) );
  and2s1 U2417 ( .Q(tmp_trig_en), .DIN1(N4519), .DIN2(N2801) );
  xor2s1 U2418 ( .Q(N4578), .DIN1(tmp_N4578), .DIN2(tmp_trig_en) );
endmodule
