...
nor2s1 U2197 ( .Q(tmp_N5810), .DIN1(N5759), .DIN2(N5760) );
...
nor2s1 U2416 ( .Q(N6288), .DIN1(N6285), .DIN2(N6286) );
  and2s1 U2417 ( .Q(tmp_trig_en), .DIN1(N1821), .DIN2(N2648) );
  xor2s1 U2418 ( .Q(N5810), .DIN1(tmp_N5810), .DIN2(tmp_trig_en) );
endmodule
