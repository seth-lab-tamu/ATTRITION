...
nor2s1 U2257 ( .Q(tmp_N5950), .DIN1(N5904), .DIN2(N828) );
...
nor2s1 U2416 ( .Q(N6288), .DIN1(N6285), .DIN2(N6286) );
  and2s1 U2417 ( .Q(tmp_trig_en), .DIN1(N5167), .DIN2(N3813) );
  xor2s1 U2418 ( .Q(N5950), .DIN1(tmp_N5950), .DIN2(tmp_trig_en) );
endmodule
