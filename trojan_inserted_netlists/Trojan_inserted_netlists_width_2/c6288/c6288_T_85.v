...
nor2s1 U2037 ( .Q(tmp_N5439), .DIN1(N5383), .DIN2(N822) );
...
nor2s1 U2416 ( .Q(N6288), .DIN1(N6285), .DIN2(N6286) );
  and2s1 U2417 ( .Q(tmp_trig_en), .DIN1(N4696), .DIN2(N2016) );
  xor2s1 U2418 ( .Q(N5439), .DIN1(tmp_N5439), .DIN2(tmp_trig_en) );
endmodule
