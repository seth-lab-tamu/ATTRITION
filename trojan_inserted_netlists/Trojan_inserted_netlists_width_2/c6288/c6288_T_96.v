...
and2s1 U168 ( .Q(tmp_N1044), .DIN1(N171), .DIN2(N392) );
...
nor2s1 U2416 ( .Q(N6288), .DIN1(N6285), .DIN2(N6286) );
  and2s1 U2417 ( .Q(tmp_trig_en), .DIN1(N4941), .DIN2(N5658) );
  xor2s1 U2418 ( .Q(N1044), .DIN1(tmp_N1044), .DIN2(tmp_trig_en) );
endmodule
