...
and2s1 U82 ( .Q(tmp_N786), .DIN1(N86), .DIN2(N290) );
...
nor2s1 U2416 ( .Q(N6288), .DIN1(N6285), .DIN2(N6286) );
  and2s1 U2417 ( .Q(tmp_trig_en), .DIN1(N2026), .DIN2(N2342) );
  xor2s1 U2418 ( .Q(N786), .DIN1(tmp_N786), .DIN2(tmp_trig_en) );
endmodule
