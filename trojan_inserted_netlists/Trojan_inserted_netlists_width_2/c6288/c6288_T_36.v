...
nor2s1 U1198 ( .Q(tmp_N3499), .DIN1(N3377), .DIN2(N3433) );
...
nor2s1 U2416 ( .Q(N6288), .DIN1(N6285), .DIN2(N6286) );
  and2s1 U2417 ( .Q(tmp_trig_en), .DIN1(N1710), .DIN2(N3996) );
  xor2s1 U2418 ( .Q(N3499), .DIN1(tmp_N3499), .DIN2(tmp_trig_en) );
endmodule
