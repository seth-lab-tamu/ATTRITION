...
nor2s1 U2031 ( .Q(tmp_N5428), .DIN1(N5370), .DIN2(N5246) );
...
nor2s1 U2416 ( .Q(N6288), .DIN1(N6285), .DIN2(N6286) );
  and2s1 U2417 ( .Q(tmp_trig_en), .DIN1(N1688), .DIN2(N5234) );
  xor2s1 U2418 ( .Q(N5428), .DIN1(tmp_N5428), .DIN2(tmp_trig_en) );
endmodule
