...
nor2s1 U2172 ( .Q(tmp_N5759), .DIN1(N5642), .DIN2(N5700) );
...
nor2s1 U2416 ( .Q(N6288), .DIN1(N6285), .DIN2(N6286) );
  and2s1 U2417 ( .Q(tmp_trig_en), .DIN1(N3252), .DIN2(N4285) );
  xor2s1 U2418 ( .Q(N5759), .DIN1(tmp_N5759), .DIN2(tmp_trig_en) );
endmodule
