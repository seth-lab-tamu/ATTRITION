...
nor2s1 U1441 ( .Q(tmp_N4052), .DIN1(N4005), .DIN2(N4006) );
...
nor2s1 U2416 ( .Q(N6288), .DIN1(N6285), .DIN2(N6286) );
  and2s1 U2417 ( .Q(tmp_trig_en), .DIN1(N5051), .DIN2(N1686) );
  xor2s1 U2418 ( .Q(N4052), .DIN1(tmp_N4052), .DIN2(tmp_trig_en) );
endmodule
