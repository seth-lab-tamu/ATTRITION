...
and2s1 U107 ( .Q(tmp_N861), .DIN1(N103), .DIN2(N443) );
...
nor2s1 U2416 ( .Q(N6288), .DIN1(N6285), .DIN2(N6286) );
  and2s1 U2417 ( .Q(tmp_trig_en), .DIN1(N3996), .DIN2(N3813) );
  xor2s1 U2418 ( .Q(N861), .DIN1(tmp_N861), .DIN2(tmp_trig_en) );
endmodule
