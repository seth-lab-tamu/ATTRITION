...
nor2s1 U1627 ( .Q(tmp_N4499), .DIN1(N4435), .DIN2(N4374) );
...
nor2s1 U2416 ( .Q(N6288), .DIN1(N6285), .DIN2(N6286) );
  and2s1 U2417 ( .Q(tmp_trig_en), .DIN1(N2402), .DIN2(N2348) );
  xor2s1 U2418 ( .Q(N4499), .DIN1(tmp_N4499), .DIN2(tmp_trig_en) );
endmodule
