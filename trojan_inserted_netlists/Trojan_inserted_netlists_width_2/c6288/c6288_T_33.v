...
nor2s1 U1125 ( .Q(tmp_N3330), .DIN1(N3276), .DIN2(N3157) );
...
nor2s1 U2416 ( .Q(N6288), .DIN1(N6285), .DIN2(N6286) );
  and2s1 U2417 ( .Q(tmp_trig_en), .DIN1(N5780), .DIN2(N2026) );
  xor2s1 U2418 ( .Q(N3330), .DIN1(tmp_N3330), .DIN2(tmp_trig_en) );
endmodule
