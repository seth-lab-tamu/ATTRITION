...
nor2s1 U535 ( .Q(tmp_N1963), .DIN1(N1914), .DIN2(N1846) );
...
nor2s1 U2416 ( .Q(N6288), .DIN1(N6285), .DIN2(N6286) );
  and2s1 U2417 ( .Q(tmp_trig_en), .DIN1(N1854), .DIN2(N4159) );
  xor2s1 U2418 ( .Q(N1963), .DIN1(tmp_N1963), .DIN2(tmp_trig_en) );
endmodule
