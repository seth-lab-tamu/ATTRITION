...
nor2s1 U1266 ( .Q(tmp_N3663), .DIN1(N3604), .DIN2(N3481) );
...
nor2s1 U2416 ( .Q(N6288), .DIN1(N6285), .DIN2(N6286) );
  and2s1 U2417 ( .Q(tmp_0), .DIN1(N4675), .DIN2(N1710) );
  and2s1 U2418 ( .Q(tmp_1), .DIN1(N5101), .DIN2(N4183) );
  and2s1 U2419 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1) );
  xor2s1 U2420 ( .Q(N3663), .DIN1(tmp_N3663), .DIN2(tmp_trig_en) );
endmodule
