...
nor2s1 U2318 ( .Q(tmp_N6090), .DIN1(N6064), .DIN2(N636) );
...
nor2s1 U2416 ( .Q(N6288), .DIN1(N6285), .DIN2(N6286) );
  and2s1 U2417 ( .Q(tmp_0), .DIN1(N3160), .DIN2(N4737) );
  and2s1 U2418 ( .Q(tmp_1), .DIN1(N4013), .DIN2(N4009) );
  and2s1 U2419 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1) );
  xor2s1 U2420 ( .Q(N6090), .DIN1(tmp_N6090), .DIN2(tmp_trig_en) );
endmodule
