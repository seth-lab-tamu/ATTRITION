...
nor2s1 U1049 ( .Q(tmp_N3156), .DIN1(N3091), .DIN2(N705) );
...
nor2s1 U2416 ( .Q(N6288), .DIN1(N6285), .DIN2(N6286) );
  and2s1 U2417 ( .Q(tmp_0), .DIN1(N2743), .DIN2(N2801) );
  and2s1 U2418 ( .Q(tmp_1), .DIN1(N3996), .DIN2(N3860) );
  and2s1 U2419 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1) );
  xor2s1 U2420 ( .Q(N3156), .DIN1(tmp_N3156), .DIN2(tmp_trig_en) );
endmodule
