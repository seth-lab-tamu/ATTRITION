...
nor2s1 U1021 ( .Q(tmp_N3083), .DIN1(N3031), .DIN2(N609) );
...
nor2s1 U2416 ( .Q(N6288), .DIN1(N6285), .DIN2(N6286) );
  and2s1 U2417 ( .Q(tmp_0), .DIN1(N1516), .DIN2(N1869) );
  and2s1 U2418 ( .Q(tmp_1), .DIN1(N4339), .DIN2(N1859) );
  and2s1 U2419 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1) );
  xor2s1 U2420 ( .Q(N3083), .DIN1(tmp_N3083), .DIN2(tmp_trig_en) );
endmodule
