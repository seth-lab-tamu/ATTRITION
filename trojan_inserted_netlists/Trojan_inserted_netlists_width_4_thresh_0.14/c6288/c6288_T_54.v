...
and2s1 U54 ( .Q(tmp_N702), .DIN1(N52), .DIN2(N358) );
...
nor2s1 U2416 ( .Q(N6288), .DIN1(N6285), .DIN2(N6286) );
  and2s1 U2417 ( .Q(tmp_0), .DIN1(N2995), .DIN2(N4350) );
  and2s1 U2418 ( .Q(tmp_1), .DIN1(N3602), .DIN2(N2856) );
  and2s1 U2419 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1) );
  xor2s1 U2420 ( .Q(N702), .DIN1(tmp_N702), .DIN2(tmp_trig_en) );
endmodule
