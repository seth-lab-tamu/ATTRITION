...
nor2s1 U2207 ( .Q(tmp_N5834), .DIN1(N5785), .DIN2(N5786) );
...
nor2s1 U2416 ( .Q(N6288), .DIN1(N6285), .DIN2(N6286) );
  and2s1 U2417 ( .Q(tmp_0), .DIN1(N4984), .DIN2(N4047) );
  and2s1 U2418 ( .Q(tmp_1), .DIN1(N2154), .DIN2(N3329) );
  and2s1 U2419 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1) );
  xor2s1 U2420 ( .Q(N5834), .DIN1(tmp_N5834), .DIN2(tmp_trig_en) );
endmodule
