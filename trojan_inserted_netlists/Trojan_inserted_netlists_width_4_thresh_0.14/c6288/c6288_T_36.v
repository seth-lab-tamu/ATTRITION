...
nor2s1 U1377 ( .Q(tmp_N3908), .DIN1(N3850), .DIN2(N3851) );
...
nor2s1 U2416 ( .Q(N6288), .DIN1(N6285), .DIN2(N6286) );
  and2s1 U2417 ( .Q(tmp_0), .DIN1(N2841), .DIN2(N3590) );
  and2s1 U2418 ( .Q(tmp_1), .DIN1(N3333), .DIN2(N5030) );
  and2s1 U2419 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1) );
  xor2s1 U2420 ( .Q(N3908), .DIN1(tmp_N3908), .DIN2(tmp_trig_en) );
endmodule
