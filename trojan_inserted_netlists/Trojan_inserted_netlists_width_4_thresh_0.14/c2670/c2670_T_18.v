...
wire tmp_0, tmp_1, tmp_2, tmp_3, tmp_trig_en, tmp_n824, n279, n280, n281, n282, n283, n284, n285, n286, n288, n289, n290, 
  ...
  hi1s1 U777 ( .Q(tmp_0), .DIN(n773) );
  nor2s1 U778 ( .Q(tmp_1), .DIN1(tmp_0), .DIN2(n583) );
  hi1s1 U779 ( .Q(tmp_2), .DIN(n351) );
  nor2s1 U780 ( .Q(tmp_3), .DIN1(tmp_2), .DIN2(n530) );
  and2s1 U781 ( .Q(tmp_trig_en), .DIN1(tmp_1), .DIN2(tmp_3) );
  xor2s1 U782 ( .Q(n824), .DIN1(tmp_n824), .DIN2(tmp_trig_en) );
endmodule
