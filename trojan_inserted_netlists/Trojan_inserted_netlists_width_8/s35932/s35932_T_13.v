...
nor2s1 U6988 ( .Q(tmp_WX5173), .DIN1(n3374), .DIN2(n4851) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n4597), .DIN2(n4653) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n5580), .DIN2(n5307) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n4625), .DIN2(n5550) );
  nor2s1 U9448 ( .Q(tmp_3), .DIN1(n4977), .DIN2(n5245) );
  ...
  xor2s1 U9452 ( .Q(WX5173), .DIN1(tmp_WX5173), .DIN2(tmp_trig_en) );
endmodule