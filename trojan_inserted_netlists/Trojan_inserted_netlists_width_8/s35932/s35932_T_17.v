...
nor2s1 U8529 ( .Q(tmp_WX1284), .DIN1(n3393), .DIN2(n5730) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n4103), .DIN2(n4637) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n4477), .DIN2(n3767) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n5257), .DIN2(n5030) );
  nor2s1 U9448 ( .Q(tmp_3), .DIN1(n4968), .DIN2(n5094) );
  ...
  xor2s1 U9452 ( .Q(WX1284), .DIN1(tmp_WX1284), .DIN2(tmp_trig_en) );
endmodule