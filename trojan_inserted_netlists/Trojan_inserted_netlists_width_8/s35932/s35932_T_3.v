...
nnd4s1 U7739 ( .Q(tmp_WX3258), .DIN1(n5264), .DIN2(n5265), .DIN3(n5266), .DIN4(n5267) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n3912), .DIN2(n4892) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n4006), .DIN2(n3667) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n5244), .DIN2(n5282) );
  nor2s1 U9448 ( .Q(tmp_3), .DIN1(n4038), .DIN2(n4524) );
  ...
  xor2s1 U9452 ( .Q(WX3258), .DIN1(tmp_WX3258), .DIN2(tmp_trig_en) );
endmodule