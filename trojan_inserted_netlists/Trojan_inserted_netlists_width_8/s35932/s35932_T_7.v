...
nnd4s1 U8362 ( .Q(tmp_WX1949), .DIN1(n5637), .DIN2(n5638), .DIN3(n5639), .DIN4(n5640) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n4643), .DIN2(n4412) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n5874), .DIN2(n4255) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n6048), .DIN2(n5296) );
  nor2s1 U9448 ( .Q(tmp_3), .DIN1(n4247), .DIN2(n4594) );
  ...
  xor2s1 U9452 ( .Q(WX1949), .DIN1(tmp_WX1949), .DIN2(tmp_trig_en) );
endmodule