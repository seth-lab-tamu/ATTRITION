...
nor2s1 U5022 ( .Q(tmp_WX9831), .DIN1(n3378), .DIN2(n2960) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n5880), .DIN2(n5687) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n4925), .DIN2(n3910) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n5985), .DIN2(n5264) );
  nor2s1 U9448 ( .Q(tmp_3), .DIN1(n5874), .DIN2(n3833) );
  ...
  xor2s1 U9452 ( .Q(WX9831), .DIN1(tmp_WX9831), .DIN2(tmp_trig_en) );
endmodule