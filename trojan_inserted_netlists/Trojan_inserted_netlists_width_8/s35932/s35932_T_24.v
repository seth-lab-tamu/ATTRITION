...
nnd2s1 U8854 ( .Q(tmp_n5868), .DIN1(CRC_OUT_1_3), .DIN2(n3529) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n4794), .DIN2(n3742) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n4223), .DIN2(n4802) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n4932), .DIN2(n4567) );
  nor2s1 U9448 ( .Q(tmp_3), .DIN1(n4391), .DIN2(n4810) );
  ...
  xor2s1 U9452 ( .Q(n5868), .DIN1(tmp_n5868), .DIN2(tmp_trig_en) );
endmodule