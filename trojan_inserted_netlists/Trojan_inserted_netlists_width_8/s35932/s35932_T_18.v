...
nor2s1 U5402 ( .Q(tmp_WX8534), .DIN1(n3384), .DIN2(n2978) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n4022), .DIN2(n5314) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n4941), .DIN2(n4118) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n3613), .DIN2(n4297) );
  nor2s1 U9448 ( .Q(tmp_3), .DIN1(n3591), .DIN2(n5437) );
  ...
  xor2s1 U9452 ( .Q(WX8534), .DIN1(tmp_WX8534), .DIN2(tmp_trig_en) );
endmodule