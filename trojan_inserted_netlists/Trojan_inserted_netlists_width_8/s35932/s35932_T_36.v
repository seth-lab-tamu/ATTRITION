...
nor2s1 U5253 ( .Q(tmp_WX9082), .DIN1(n3380), .DIN2(n3785) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n5469), .DIN2(n4610) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n4906), .DIN2(n3898) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n4414), .DIN2(n3679) );
  nor2s1 U9448 ( .Q(tmp_3), .DIN1(n3905), .DIN2(n3877) );
  ...
  xor2s1 U9452 ( .Q(WX9082), .DIN1(tmp_WX9082), .DIN2(tmp_trig_en) );
endmodule