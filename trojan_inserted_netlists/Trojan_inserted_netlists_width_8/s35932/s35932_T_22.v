...
nnd4s1 U8960 ( .Q(tmp_WX11016), .DIN1(n5953), .DIN2(n5954), .DIN3(n5955), .DIN4(n5956) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n5526), .DIN2(n3720) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n5438), .DIN2(n5899) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n4401), .DIN2(n4949) );
  nor2s1 U9448 ( .Q(tmp_3), .DIN1(n3774), .DIN2(n4345) );
  ...
  xor2s1 U9452 ( .Q(WX11016), .DIN1(tmp_WX11016), .DIN2(tmp_trig_en) );
endmodule