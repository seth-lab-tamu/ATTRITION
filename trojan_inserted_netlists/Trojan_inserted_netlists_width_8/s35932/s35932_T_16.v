...
nor2s1 U8501 ( .Q(tmp_WX1310), .DIN1(n3392), .DIN2(n5715) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n4433), .DIN2(n4643) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n3712), .DIN2(n3875) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n3972), .DIN2(n4685) );
  nor2s1 U9448 ( .Q(tmp_3), .DIN1(n4754), .DIN2(n3931) );
  ...
  xor2s1 U9452 ( .Q(WX1310), .DIN1(tmp_WX1310), .DIN2(tmp_trig_en) );
endmodule