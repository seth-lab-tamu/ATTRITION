...
nnd2s1 U9054 ( .Q(tmp_n6021), .DIN1(DATA_0_26), .DIN2(n3485) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n4757), .DIN2(n3943) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n5470), .DIN2(n6042) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n4781), .DIN2(n5056) );
  nor2s1 U9448 ( .Q(tmp_3), .DIN1(n5462), .DIN2(n5560) );
  ...
  xor2s1 U9452 ( .Q(n6021), .DIN1(tmp_n6021), .DIN2(tmp_trig_en) );
endmodule