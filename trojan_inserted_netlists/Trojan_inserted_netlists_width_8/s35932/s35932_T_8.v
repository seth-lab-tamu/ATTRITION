...
nor2s1 U8658 ( .Q(tmp_WX11626), .DIN1(n3397), .DIN2(n5807) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n5153), .DIN2(n4167) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n3898), .DIN2(n5883) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n3877), .DIN2(n3856) );
  nor2s1 U9448 ( .Q(tmp_3), .DIN1(n4983), .DIN2(n4531) );
  ...
  xor2s1 U9452 ( .Q(WX11626), .DIN1(tmp_WX11626), .DIN2(tmp_trig_en) );
endmodule