...
nnd2s1 U8952 ( .Q(tmp_n5949), .DIN1(n3434), .DIN2(n3693) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n5617), .DIN2(n4770) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n3988), .DIN2(n3948) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n5069), .DIN2(n5336) );
  nor2s1 U9448 ( .Q(tmp_3), .DIN1(n3917), .DIN2(n3896) );
  ...
  xor2s1 U9452 ( .Q(n5949), .DIN1(tmp_n5949), .DIN2(tmp_trig_en) );
endmodule