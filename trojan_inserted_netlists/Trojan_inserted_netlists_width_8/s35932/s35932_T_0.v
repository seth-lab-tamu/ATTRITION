...
nor2s1 U6983 ( .Q(tmp_WX5177), .DIN1(n3374), .DIN2(n4848) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n5298), .DIN2(n3769) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n5871), .DIN2(n4428) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n4748), .DIN2(n3856) );
  nor2s1 U9448 ( .Q(tmp_3), .DIN1(n5525), .DIN2(n4991) );
  ...
  xor2s1 U9452 ( .Q(WX5177), .DIN1(tmp_WX5177), .DIN2(tmp_trig_en) );
endmodule