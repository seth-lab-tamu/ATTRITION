...
and2s1 U9114 ( .Q(tmp_WX10886), .DIN1(RESET), .DIN2(WX10889) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n5541), .DIN2(n4174) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n5338), .DIN2(n4097) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n5865), .DIN2(n4118) );
  nor2s1 U9448 ( .Q(tmp_3), .DIN1(n4694), .DIN2(n4991) );
  and2s1 U9449 ( .Q(tmp_mid_trig_1), .DIN1(tmp_0), .DIN2(tmp_1) );
  and2s1 U9450 ( .Q(tmp_mid_trig_2), .DIN1(tmp_2), .DIN2(tmp_3) );
  and2s1 U9451 ( .Q(tmp_trig_en), .DIN1(tmp_mid_trig_1), .DIN2(tmp_mid_trig_2) );
  xor2s1 U9452 ( .Q(WX10886), .DIN1(tmp_WX10886), .DIN2(tmp_trig_en) );
endmodule