...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n4492), .DIN2(n4725) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n5008), .DIN2(n5863) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n5851), .DIN2(n3871) );
  nor2s1 U9448 ( .Q(tmp_3), .DIN1(n3999), .DIN2(n5580) );
