...
nnd2s1 U8958 ( .Q(tmp_n5947), .DIN1(DATA_0_16), .DIN2(n3484) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n3720), .DIN2(n5422) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n5104), .DIN2(n6042) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n4886), .DIN2(n3624) );
  nor2s1 U9448 ( .Q(tmp_3), .DIN1(n3590), .DIN2(n6028) );
  ...
  xor2s1 U9452 ( .Q(n5947), .DIN1(tmp_n5947), .DIN2(tmp_trig_en) );
endmodule