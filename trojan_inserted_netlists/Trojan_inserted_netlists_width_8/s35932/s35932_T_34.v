...
hi1s1 U4797 ( .Q(tmp_n3421), .DIN(n3587) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n3998), .DIN2(n4732) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n4548), .DIN2(n4257) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n5071), .DIN2(n5988) );
  nor2s1 U9448 ( .Q(tmp_3), .DIN1(n3849), .DIN2(n4393) );
  ...
  xor2s1 U9452 ( .Q(n3421), .DIN1(tmp_n3421), .DIN2(tmp_trig_en) );
endmodule