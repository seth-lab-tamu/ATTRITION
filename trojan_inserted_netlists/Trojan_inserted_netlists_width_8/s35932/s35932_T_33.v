...
nor2s1 U7924 ( .Q(tmp_WX2601), .DIN1(n3413), .DIN2(n5393) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n3721), .DIN2(n3631) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n4414), .DIN2(n4400) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n4111), .DIN2(n4941) );
  nor2s1 U9448 ( .Q(tmp_3), .DIN1(n4195), .DIN2(n4892) );
  ...
  xor2s1 U9452 ( .Q(WX2601), .DIN1(tmp_WX2601), .DIN2(tmp_trig_en) );
endmodule