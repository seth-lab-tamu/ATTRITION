...
wire tmp_0, tmp_1, tmp_2, tmp_3, tmp_4, tmp_mid_trig_1, tmp_mid_trig_2, tmp_trig_en, tmp_n712, n279, n280, n281, n282, n283, n284, n285, n286, n288, n289, n290, 
  ...
  nor2s1 U779 ( .Q(tmp_2), .DIN1(tmp_1), .DIN2(n434) );
  and2s1 U780 ( .Q(tmp_3), .DIN1(N3881), .DIN2(n388) );
  nor2s1 U781 ( .Q(tmp_4), .DIN1(n392), .DIN2(n390) );
  and2s1 U782 ( .Q(tmp_mid_trig_1), .DIN1(tmp_0), .DIN2(tmp_2) );
  and2s1 U783 ( .Q(tmp_mid_trig_2), .DIN1(tmp_3), .DIN2(tmp_4) );
  and2s1 U784 ( .Q(tmp_trig_en), .DIN1(tmp_mid_trig_1), .DIN2(tmp_mid_trig_2) );
  xor2s1 U785 ( .Q(n712), .DIN1(tmp_n712), .DIN2(tmp_trig_en) );
endmodule
