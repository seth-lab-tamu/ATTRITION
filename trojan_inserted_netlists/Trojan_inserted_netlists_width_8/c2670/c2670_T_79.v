...
wire tmp_0, tmp_1, tmp_2, tmp_3, tmp_mid_trig_1, tmp_mid_trig_2, tmp_trig_en, tmp_n695, n279, n280, n281, n282, n283, n284, n285, n286, n288, n289, n290, 
  ...
  nor2s1 U777 ( .Q(tmp_0), .DIN1(n285), .DIN2(n295) );
  nor2s1 U778 ( .Q(tmp_1), .DIN1(n390), .DIN2(n667) );
  and2s1 U779 ( .Q(tmp_2), .DIN1(n713), .DIN2(n385) );
  nor2s1 U780 ( .Q(tmp_3), .DIN1(n848), .DIN2(n668) );
  ...
  xor2s1 U784 ( .Q(n695), .DIN1(tmp_n695), .DIN2(tmp_trig_en) );
endmodule
