...
wire tmp_0, tmp_1, tmp_2, tmp_3, tmp_4, tmp_mid_trig_1, tmp_mid_trig_2, tmp_trig_en, tmp_N3038, n279, n280, n281, n282, n283, n284, n285, n286, n288, n289, n290, 
  ...
  nor2s1 U777 ( .Q(tmp_0), .DIN1(N792), .DIN2(n848) );
  nor2s1 U778 ( .Q(tmp_1), .DIN1(n296), .DIN2(n849) );
  and2s1 U779 ( .Q(tmp_2), .DIN1(N1277), .DIN2(n292) );
  hi1s1 U780 ( .Q(tmp_3), .DIN(n391) );
  nor2s1 U781 ( .Q(tmp_4), .DIN1(tmp_3), .DIN2(n393) );
  and2s1 U782 ( .Q(tmp_mid_trig_1), .DIN1(tmp_0), .DIN2(tmp_1) );
  and2s1 U783 ( .Q(tmp_mid_trig_2), .DIN1(tmp_2), .DIN2(tmp_4) );
  and2s1 U784 ( .Q(tmp_trig_en), .DIN1(tmp_mid_trig_1), .DIN2(tmp_mid_trig_2) );
  xor2s1 U785 ( .Q(N3038), .DIN1(tmp_N3038), .DIN2(tmp_trig_en) );
endmodule
