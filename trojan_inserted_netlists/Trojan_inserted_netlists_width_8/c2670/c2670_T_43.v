...
wire tmp_0, tmp_1, tmp_2, tmp_3, tmp_4, tmp_5, tmp_mid_trig_1, tmp_mid_trig_2, tmp_trig_en, tmp_N1971, n279, n280, n281, n282, n283, n284, n285, n286, n288, n289, n290, 
  ...
  and2s1 U777 ( .Q(tmp_0), .DIN1(N3038), .DIN2(n292) );
  nor2s1 U778 ( .Q(tmp_1), .DIN1(N3079), .DIN2(n280) );
  ...
  and2s1 U783 ( .Q(tmp_mid_trig_1), .DIN1(tmp_0), .DIN2(tmp_1) );
  and2s1 U784 ( .Q(tmp_mid_trig_2), .DIN1(tmp_3), .DIN2(tmp_5) );
  and2s1 U785 ( .Q(tmp_trig_en), .DIN1(tmp_mid_trig_1), .DIN2(tmp_mid_trig_2) );
  xor2s1 U786 ( .Q(N1971), .DIN1(tmp_N1971), .DIN2(tmp_trig_en) );
endmodule
