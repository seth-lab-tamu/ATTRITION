...
wire tmp_0, tmp_1, tmp_2, tmp_3, tmp_mid_trig_1, tmp_mid_trig_2, tmp_trig_en, tmp_n300, n279, n280, n281, n282, n283, n284, n285, n286, n288, n289, n290, 
  ...
  nor2s1 U778 ( .Q(tmp_1), .DIN1(n487), .DIN2(n386) );
  nor2s1 U779 ( .Q(tmp_2), .DIN1(N1970), .DIN2(N1448) );
  nor2s1 U780 ( .Q(tmp_3), .DIN1(n296), .DIN2(n285) );
  ...
  xor2s1 U784 ( .Q(n300), .DIN1(tmp_n300), .DIN2(tmp_trig_en) );
endmodule
