...
wire tmp_0, tmp_1, tmp_2, tmp_3, tmp_mid_trig_1, tmp_mid_trig_2, tmp_trig_en, tmp_n371, n279, n280, n281, n282, n283, n284, n285, n286, n288, n289, n290, 
  ...
  nor2s1 U777 ( .Q(tmp_0), .DIN1(n486), .DIN2(n295) );
  and2s1 U778 ( .Q(tmp_1), .DIN1(n713), .DIN2(n382) );
  and2s1 U779 ( .Q(tmp_2), .DIN1(n761), .DIN2(n756) );
  and2s1 U780 ( .Q(tmp_3), .DIN1(n765), .DIN2(n385) );
  ...
  xor2s1 U784 ( .Q(n371), .DIN1(tmp_n371), .DIN2(tmp_trig_en) );
endmodule
