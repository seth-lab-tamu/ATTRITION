...
wire tmp_0, tmp_1, tmp_2, tmp_3, tmp_4, tmp_5, tmp_6, tmp_7, tmp_mid_trig_1, tmp_mid_trig_2, tmp_trig_en, tmp_N3038, n279, n280, n281, n282, n283, n284, n285, n286, n288, n289, n290, 
    ...
    nor2s1 U1 ( .Q(tmp_N3038), .DIN1(n279), .DIN2(n280) );
  ...
  hi1s1 U777 ( .Q(tmp_0), .DIN(n374) );
  nor2s1 U778 ( .Q(tmp_1), .DIN1(tmp_0), .DIN2(n289) );
  hi1s1 U779 ( .Q(tmp_2), .DIN(n391) );
  nor2s1 U780 ( .Q(tmp_3), .DIN1(tmp_2), .DIN2(N792) );
  hi1s1 U781 ( .Q(tmp_4), .DIN(n712) );
  nor2s1 U782 ( .Q(tmp_5), .DIN1(tmp_4), .DIN2(N1970) );
  hi1s1 U783 ( .Q(tmp_6), .DIN(n348) );
  nor2s1 U784 ( .Q(tmp_7), .DIN1(tmp_6), .DIN2(n386) );
  and2s1 U785 ( .Q(tmp_mid_trig_1), .DIN1(tmp_1), .DIN2(tmp_3) );
  and2s1 U786 ( .Q(tmp_mid_trig_2), .DIN1(tmp_5), .DIN2(tmp_7) );
  and2s1 U787 ( .Q(tmp_trig_en), .DIN1(tmp_mid_trig_1), .DIN2(tmp_mid_trig_2) );
  xor2s1 U788 ( .Q(N3038), .DIN1(tmp_N3038), .DIN2(tmp_trig_en) );
endmodule
