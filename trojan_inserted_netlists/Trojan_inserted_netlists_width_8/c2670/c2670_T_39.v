...
wire tmp_0, tmp_1, tmp_2, tmp_3, tmp_4, tmp_5, tmp_6, tmp_mid_trig_1, tmp_mid_trig_2, tmp_trig_en, tmp_n500, n279, n280, n281, n282, n283, n284, n285, n286, n288, n289, n290, 
  ...
  and2s1 U779 ( .Q(tmp_2), .DIN1(n761), .DIN2(n756) );
  hi1s1 U780 ( .Q(tmp_3), .DIN(n765) );
  ...
  xor2s1 U787 ( .Q(n500), .DIN1(tmp_n500), .DIN2(tmp_trig_en) );
endmodule
