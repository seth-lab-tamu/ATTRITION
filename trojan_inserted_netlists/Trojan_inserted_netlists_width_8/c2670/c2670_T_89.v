...
wire tmp_0, tmp_1, tmp_2, tmp_3, tmp_4, tmp_5, tmp_6, tmp_mid_trig_1, tmp_mid_trig_2, tmp_trig_en, tmp_n300, n279, n280, n281, n282, n283, n284, n285, n286, n288, n289, n290, 
  ...
  nor2s1 U778 ( .Q(tmp_1), .DIN1(tmp_0), .DIN2(n849) );
  ...
  nor2s1 U783 ( .Q(tmp_6), .DIN1(n295), .DIN2(N3882) );
  ...
  xor2s1 U787 ( .Q(n300), .DIN1(tmp_n300), .DIN2(tmp_trig_en) );
endmodule
