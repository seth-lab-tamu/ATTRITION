...
wire tmp_0, tmp_1, tmp_2, tmp_3, tmp_4, tmp_5, tmp_mid_trig_1, tmp_mid_trig_2, tmp_trig_en, tmp_n807, n279, n280, n281, n282, n283, n284, n285, n286, n288, n289, n290, 
    ...
    nor2s1 U343 ( .Q(tmp_n807), .DIN1(N272), .DIN2(n808) );
  ...
  nor2s1 U777 ( .Q(tmp_0), .DIN1(n668), .DIN2(n848) );
  hi1s1 U778 ( .Q(tmp_1), .DIN(N1277) );
  nor2s1 U779 ( .Q(tmp_2), .DIN1(tmp_1), .DIN2(n289) );
  hi1s1 U780 ( .Q(tmp_3), .DIN(n666) );
  nor2s1 U781 ( .Q(tmp_4), .DIN1(tmp_3), .DIN2(N1448) );
  nor2s1 U782 ( .Q(tmp_5), .DIN1(n389), .DIN2(n390) );
  ...
  xor2s1 U786 ( .Q(n807), .DIN1(tmp_n807), .DIN2(tmp_trig_en) );
endmodule
