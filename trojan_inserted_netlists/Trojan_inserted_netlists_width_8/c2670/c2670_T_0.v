...
wire tmp_0, tmp_1, tmp_2, tmp_3, tmp_4, tmp_5, tmp_6, tmp_mid_trig_1, tmp_mid_trig_2, tmp_trig_en, tmp_n378, n279, n280, n281, n282, n283, n284, n285, n286, n288, n289, n290, 
    ...
    nor2s1 U64 ( .Q(tmp_n378), .DIN1(n352), .DIN2(n379) );
  ...
  and2s1 U777 ( .Q(tmp_0), .DIN1(N3881), .DIN2(n388) );
  hi1s1 U778 ( .Q(tmp_1), .DIN(n382) );
  nor2s1 U779 ( .Q(tmp_2), .DIN1(tmp_1), .DIN2(n668) );
  hi1s1 U780 ( .Q(tmp_3), .DIN(n385) );
  nor2s1 U781 ( .Q(tmp_4), .DIN1(tmp_3), .DIN2(n296) );
  hi1s1 U782 ( .Q(tmp_5), .DIN(n666) );
  nor2s1 U783 ( .Q(tmp_6), .DIN1(tmp_5), .DIN2(n848) );
  ...
  xor2s1 U787 ( .Q(n378), .DIN1(tmp_n378), .DIN2(tmp_trig_en) );
endmodule
