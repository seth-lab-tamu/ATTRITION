...
wire tmp_0, tmp_1, tmp_2, tmp_3, tmp_4, tmp_mid_trig_1, tmp_mid_trig_2, tmp_trig_en, tmp_n824, n279, n280, n281, n282, n283, n284, n285, n286, n288, n289, n290, 
    ...
    nor2s1 U362 ( .Q(tmp_n824), .DIN1(N16), .DIN2(n391) );
  ...
  nor2s1 U777 ( .Q(tmp_0), .DIN1(n389), .DIN2(N792) );
  nor2s1 U778 ( .Q(tmp_1), .DIN1(n392), .DIN2(n285) );
  and2s1 U779 ( .Q(tmp_2), .DIN1(n374), .DIN2(n385) );
  ...
  xor2s1 U785 ( .Q(n824), .DIN1(tmp_n824), .DIN2(tmp_trig_en) );
endmodule
