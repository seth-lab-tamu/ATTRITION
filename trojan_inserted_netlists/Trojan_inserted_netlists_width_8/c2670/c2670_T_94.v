...
wire tmp_0, tmp_1, tmp_2, tmp_3, tmp_4, tmp_mid_trig_1, tmp_mid_trig_2, tmp_trig_en, tmp_n800, n279, n280, n281, n282, n283, n284, n285, n286, n288, n289, n290, 
    ...
    nor2s1 U336 ( .Q(tmp_n800), .DIN1(N5), .DIN2(n424) );
  ...
  nor2s1 U777 ( .Q(tmp_0), .DIN1(n849), .DIN2(n296) );
  and2s1 U778 ( .Q(tmp_1), .DIN1(n713), .DIN2(N1277) );
  hi1s1 U779 ( .Q(tmp_2), .DIN(n666) );
  nor2s1 U780 ( .Q(tmp_3), .DIN1(tmp_2), .DIN2(n393) );
  nor2s1 U781 ( .Q(tmp_4), .DIN1(n285), .DIN2(N3882) );
  ...
  xor2s1 U785 ( .Q(n800), .DIN1(tmp_n800), .DIN2(tmp_trig_en) );
endmodule
