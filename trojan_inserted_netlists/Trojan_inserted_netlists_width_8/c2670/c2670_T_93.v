...
wire tmp_0, tmp_1, tmp_2, tmp_3, tmp_4, tmp_mid_trig_1, tmp_mid_trig_2, tmp_trig_en, tmp_n392, n279, n280, n281, n282, n283, n284, n285, n286, n288, n289, n290, 
    ...
    nnd2s1 U240 ( .Q(tmp_n392), .DIN1(n695), .DIN2(n693) );
  ...
  nor2s1 U777 ( .Q(tmp_0), .DIN1(n393), .DIN2(n386) );
  hi1s1 U778 ( .Q(tmp_1), .DIN(n292) );
  nor2s1 U779 ( .Q(tmp_2), .DIN1(tmp_1), .DIN2(n434) );
  nor2s1 U780 ( .Q(tmp_3), .DIN1(n285), .DIN2(n389) );
  and2s1 U781 ( .Q(tmp_4), .DIN1(n765), .DIN2(n382) );
  ...
  xor2s1 U785 ( .Q(n392), .DIN1(tmp_n392), .DIN2(tmp_trig_en) );
endmodule
