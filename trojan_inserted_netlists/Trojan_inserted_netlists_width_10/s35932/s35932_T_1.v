...
hi1s1 U4794 ( .Q(tmp_n3418), .DIN(n3419) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n5960), .DIN2(n6048) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n4179), .DIN2(n3658) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n4953), .DIN2(n4770) );
  nor2s1 U9448 ( .Q(tmp_3), .DIN1(n4586), .DIN2(n4904) );
  nor2s1 U9449 ( .Q(tmp_4), .DIN1(n4525), .DIN2(n3972) );
  and5s1 U9450 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1), .DIN3(tmp_2), .DIN4(tmp_3), .DIN5(tmp_4) );
  xor2s1 U9451 ( .Q(n3418), .DIN1(tmp_n3418), .DIN2(tmp_trig_en) );
endmodule