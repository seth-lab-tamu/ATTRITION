...
nor2s1 U8626 ( .Q(tmp_WX11650), .DIN1(n3396), .DIN2(n5789) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n3911), .DIN2(n4461) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n4921), .DIN2(n4977) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n4650), .DIN2(n4266) );
  nor2s1 U9448 ( .Q(tmp_3), .DIN1(n4695), .DIN2(n5689) );
  nor2s1 U9449 ( .Q(tmp_4), .DIN1(n5172), .DIN2(n6041) );
  and5s1 U9450 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1), .DIN3(tmp_2), .DIN4(tmp_3), .DIN5(tmp_4) );
  xor2s1 U9451 ( .Q(WX11650), .DIN1(tmp_WX11650), .DIN2(tmp_trig_en) );
endmodule