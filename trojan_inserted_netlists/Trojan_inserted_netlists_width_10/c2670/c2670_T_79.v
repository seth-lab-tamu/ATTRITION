...
wire tmp_0, tmp_1, tmp_2, tmp_3, tmp_4, tmp_5, tmp_trig_en, tmp_N3038, n279, n280, n281, n282, n283, n284, n285, n286, n288, n289, n290, 
  ...
  and2s1 U777 ( .Q(tmp_0), .DIN1(n666), .DIN2(n712) );
  nor2s1 U778 ( .Q(tmp_1), .DIN1(n280), .DIN2(n386) );
  hi1s1 U779 ( .Q(tmp_2), .DIN(n382) );
  nor2s1 U780 ( .Q(tmp_3), .DIN1(tmp_2), .DIN2(n390) );
  nor2s1 U781 ( .Q(tmp_4), .DIN1(n295), .DIN2(N1448) );
  and2s1 U782 ( .Q(tmp_5), .DIN1(n292), .DIN2(N1277) );
  and5s1 U783 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1), .DIN3(tmp_3), .DIN4(tmp_4), .DIN5(tmp_5) );
  xor2s1 U784 ( .Q(N3038), .DIN1(tmp_N3038), .DIN2(tmp_trig_en) );
endmodule
