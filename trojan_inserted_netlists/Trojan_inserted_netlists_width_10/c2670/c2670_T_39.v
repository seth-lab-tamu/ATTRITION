...
wire tmp_0, tmp_1, tmp_2, tmp_3, tmp_4, tmp_5, tmp_trig_en, tmp_n293, n279, n280, n281, n282, n283, n284, n285, n286, n288, n289, n290, 
  ...
  nor2s1 U777 ( .Q(tmp_0), .DIN1(n393), .DIN2(N3079) );
  and2s1 U778 ( .Q(tmp_1), .DIN1(n385), .DIN2(N3038) );
  hi1s1 U779 ( .Q(tmp_2), .DIN(n712) );
  nor2s1 U780 ( .Q(tmp_3), .DIN1(tmp_2), .DIN2(n295) );
  and2s1 U781 ( .Q(tmp_4), .DIN1(n374), .DIN2(n382) );
  nor2s1 U782 ( .Q(tmp_5), .DIN1(n392), .DIN2(n849) );
