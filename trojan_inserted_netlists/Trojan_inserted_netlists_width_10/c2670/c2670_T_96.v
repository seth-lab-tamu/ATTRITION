...
wire tmp_0, tmp_1, tmp_2, tmp_3, tmp_4, tmp_5, tmp_6, tmp_trig_en, tmp_n280, n279, n280, n281, n282, n283, n284, n285, n286, n288, n289, n290, 
  ...
  and2s1 U779 ( .Q(tmp_2), .DIN1(N1277), .DIN2(n385) );
  nor2s1 U780 ( .Q(tmp_3), .DIN1(N1448), .DIN2(n285) );
  ...
  xor2s1 U785 ( .Q(n280), .DIN1(tmp_n280), .DIN2(tmp_trig_en) );
endmodule
