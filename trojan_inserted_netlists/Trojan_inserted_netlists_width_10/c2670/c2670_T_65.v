...
wire tmp_0, tmp_1, tmp_2, tmp_3, tmp_4, tmp_5, tmp_trig_en, tmp_n300, n279, n280, n281, n282, n283, n284, n285, n286, n288, n289, n290, 
  ...
  and2s1 U777 ( .Q(tmp_0), .DIN1(n761), .DIN2(N3881) );
  hi1s1 U778 ( .Q(tmp_1), .DIN(n292) );
  nor2s1 U779 ( .Q(tmp_2), .DIN1(tmp_1), .DIN2(n383) );
  nor2s1 U780 ( .Q(tmp_3), .DIN1(n487), .DIN2(N1448) );
  nor2s1 U781 ( .Q(tmp_4), .DIN1(n434), .DIN2(n280) );
  and2s1 U782 ( .Q(tmp_5), .DIN1(n712), .DIN2(n385) );
