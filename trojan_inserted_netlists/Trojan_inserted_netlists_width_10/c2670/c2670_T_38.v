...
wire tmp_0, tmp_1, tmp_2, tmp_3, tmp_4, tmp_5, tmp_6, tmp_trig_en, tmp_n280, n279, n280, n281, n282, n283, n284, n285, n286, n288, n289, n290, 
  ...
  hi1s1 U778 ( .Q(tmp_1), .DIN(n666) );
  nor2s1 U779 ( .Q(tmp_2), .DIN1(tmp_1), .DIN2(n289) );
  nor2s1 U780 ( .Q(tmp_3), .DIN1(n667), .DIN2(n392) );
  and2s1 U781 ( .Q(tmp_4), .DIN1(n385), .DIN2(n348) );
  hi1s1 U782 ( .Q(tmp_5), .DIN(n391) );
  nor2s1 U783 ( .Q(tmp_6), .DIN1(tmp_5), .DIN2(n389) );
  and5s1 U784 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_2), .DIN3(tmp_3), .DIN4(tmp_4), .DIN5(tmp_6) );
