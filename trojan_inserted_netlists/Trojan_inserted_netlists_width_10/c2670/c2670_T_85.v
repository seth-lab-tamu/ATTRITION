...
wire tmp_0, tmp_1, tmp_2, tmp_3, tmp_4, tmp_5, tmp_trig_en, tmp_N1971, n279, n280, n281, n282, n283, n284, n285, n286, n288, n289, n290, 
  ...
  nor2s1 U777 ( .Q(tmp_0), .DIN1(n486), .DIN2(n393) );
  hi1s1 U778 ( .Q(tmp_1), .DIN(N1277) );
  nor2s1 U779 ( .Q(tmp_2), .DIN1(tmp_1), .DIN2(n390) );
  and2s1 U780 ( .Q(tmp_3), .DIN1(n292), .DIN2(n382) );
  nor2s1 U781 ( .Q(tmp_4), .DIN1(n295), .DIN2(N3079) );
  and2s1 U782 ( .Q(tmp_5), .DIN1(n765), .DIN2(n385) );
  and5s1 U783 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_2), .DIN3(tmp_3), .DIN4(tmp_4), .DIN5(tmp_5) );
