...
wire tmp_0, tmp_1, tmp_2, tmp_3, tmp_4, tmp_5, tmp_trig_en, tmp_N799, n279, n280, n281, n282, n283, n284, n285, n286, n288, n289, n290, 
  ...
  and2s1 U777 ( .Q(tmp_0), .DIN1(n348), .DIN2(N3881) );
  nor2s1 U778 ( .Q(tmp_1), .DIN1(n849), .DIN2(n285) );
  nor2s1 U779 ( .Q(tmp_2), .DIN1(n280), .DIN2(N3882) );
  and2s1 U780 ( .Q(tmp_3), .DIN1(n385), .DIN2(n391) );
