...
wire tmp_0, tmp_1, tmp_2, tmp_3, tmp_4, tmp_5, tmp_6, tmp_trig_en, tmp_N3038, n279, n280, n281, n282, n283, n284, n285, n286, n288, n289, n290, 
  ...
  and2s1 U779 ( .Q(tmp_2), .DIN1(n712), .DIN2(n756) );
  nor2s1 U780 ( .Q(tmp_3), .DIN1(n386), .DIN2(n280) );
  and2s1 U781 ( .Q(tmp_4), .DIN1(N3881), .DIN2(n391) );
  hi1s1 U782 ( .Q(tmp_5), .DIN(N1277) );
  nor2s1 U783 ( .Q(tmp_6), .DIN1(tmp_5), .DIN2(n487) );
  and5s1 U784 ( .Q(tmp_trig_en), .DIN1(tmp_1), .DIN2(tmp_2), .DIN3(tmp_3), .DIN4(tmp_4), .DIN5(tmp_6) );
