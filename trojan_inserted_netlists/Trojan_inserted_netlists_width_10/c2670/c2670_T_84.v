...
wire tmp_0, tmp_1, tmp_2, tmp_3, tmp_4, tmp_5, tmp_trig_en, tmp_N799, n279, n280, n281, n282, n283, n284, n285, n286, n288, n289, n290, 
  ...
  nor2s1 U777 ( .Q(tmp_0), .DIN1(n280), .DIN2(n667) );
  and2s1 U778 ( .Q(tmp_1), .DIN1(n374), .DIN2(n348) );
  nor2s1 U779 ( .Q(tmp_2), .DIN1(N1970), .DIN2(n668) );
  hi1s1 U780 ( .Q(tmp_3), .DIN(n391) );
  nor2s1 U781 ( .Q(tmp_4), .DIN1(tmp_3), .DIN2(n848) );
  nor2s1 U782 ( .Q(tmp_5), .DIN1(N3079), .DIN2(n296) );
