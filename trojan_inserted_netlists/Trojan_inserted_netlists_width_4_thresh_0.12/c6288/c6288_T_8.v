...
nor2s1 U690 ( .Q(tmp_N2330), .DIN1(N2230), .DIN2(N2277) );
...
nor2s1 U2416 ( .Q(N6288), .DIN1(N6285), .DIN2(N6286) );
  and2s1 U2417 ( .Q(tmp_0), .DIN1(N3746), .DIN2(N3339) );
  and2s1 U2418 ( .Q(tmp_1), .DIN1(N4089), .DIN2(N2340) );
  and2s1 U2419 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1) );
  xor2s1 U2420 ( .Q(N2330), .DIN1(tmp_N2330), .DIN2(tmp_trig_en) );
endmodule
