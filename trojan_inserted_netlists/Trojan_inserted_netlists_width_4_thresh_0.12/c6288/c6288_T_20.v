...
and2s1 U9 ( .Q(tmp_N567), .DIN1(N1), .DIN2(N409) );
...
nor2s1 U2416 ( .Q(N6288), .DIN1(N6285), .DIN2(N6286) );
  and2s1 U2417 ( .Q(tmp_0), .DIN1(N4439), .DIN2(N1541) );
  and2s1 U2418 ( .Q(tmp_1), .DIN1(N2326), .DIN2(N2506) );
  and2s1 U2419 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1) );
  xor2s1 U2420 ( .Q(N567), .DIN1(tmp_N567), .DIN2(tmp_trig_en) );
endmodule
