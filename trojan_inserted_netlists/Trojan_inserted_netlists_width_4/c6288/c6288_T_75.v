...
hi1s1 U2342 ( .Q(tmp_N6141), .DIN(N6138) );
...
nor2s1 U2416 ( .Q(N6288), .DIN1(N6285), .DIN2(N6286) );
  and2s1 U2417 ( .Q(tmp_0), .DIN1(N3131), .DIN2(N1824) );
  and2s1 U2418 ( .Q(tmp_1), .DIN1(N1531), .DIN2(N3408) );
  and2s1 U2419 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1) );
  xor2s1 U2420 ( .Q(N6141), .DIN1(tmp_N6141), .DIN2(tmp_trig_en) );
endmodule
