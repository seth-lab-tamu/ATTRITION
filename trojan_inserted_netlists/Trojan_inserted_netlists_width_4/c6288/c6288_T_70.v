...
nor2s1 U1872 ( .Q(tmp_N5065), .DIN1(N4947), .DIN2(N5005) );
...
nor2s1 U2416 ( .Q(N6288), .DIN1(N6285), .DIN2(N6286) );
  and2s1 U2417 ( .Q(tmp_0), .DIN1(N4285), .DIN2(N3474) );
  and2s1 U2418 ( .Q(tmp_1), .DIN1(N2336), .DIN2(N5725) );
  and2s1 U2419 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1) );
  xor2s1 U2420 ( .Q(N5065), .DIN1(tmp_N5065), .DIN2(tmp_trig_en) );
endmodule
