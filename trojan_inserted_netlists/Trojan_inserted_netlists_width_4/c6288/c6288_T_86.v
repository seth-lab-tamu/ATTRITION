...
and2s1 U84 ( .Q(tmp_N792), .DIN1(N86), .DIN2(N324) );
...
nor2s1 U2416 ( .Q(N6288), .DIN1(N6285), .DIN2(N6286) );
  and2s1 U2417 ( .Q(tmp_0), .DIN1(N2348), .DIN2(N2024) );
  and2s1 U2418 ( .Q(tmp_1), .DIN1(N4993), .DIN2(N2340) );
  and2s1 U2419 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1) );
  xor2s1 U2420 ( .Q(N792), .DIN1(tmp_N792), .DIN2(tmp_trig_en) );
endmodule
