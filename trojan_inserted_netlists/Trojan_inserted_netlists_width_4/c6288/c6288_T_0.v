...
nor2s1 U620 ( .Q(tmp_N2165), .DIN1(N2097), .DIN2(N696) );
...
nor2s1 U2416 ( .Q(N6288), .DIN1(N6285), .DIN2(N6286) );
  and2s1 U2417 ( .Q(tmp_0), .DIN1(N2543), .DIN2(N4993) );
  and2s1 U2418 ( .Q(tmp_1), .DIN1(N5780), .DIN2(N1712) );
  and2s1 U2419 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1) );
  xor2s1 U2420 ( .Q(N2165), .DIN1(tmp_N2165), .DIN2(tmp_trig_en) );
endmodule
