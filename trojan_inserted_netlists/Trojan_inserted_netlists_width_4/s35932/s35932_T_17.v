...
nor2s1 U5303 ( .Q(tmp_WX9034), .DIN1(n3382), .DIN2(n3811) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n5627), .DIN2(n4295) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n4762), .DIN2(n4643) );
  and2s1 U9447 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1) );
  xor2s1 U9448 ( .Q(WX9034), .DIN1(tmp_WX9034), .DIN2(tmp_trig_en) );
endmodule