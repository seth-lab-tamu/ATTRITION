...
nnd4s1 U5688 ( .Q(tmp_WX8406), .DIN1(n4036), .DIN2(n4037), .DIN3(n4038), .DIN4(n4039) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n4869), .DIN2(n5677) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n5272), .DIN2(n3588) );
  and2s1 U9447 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1) );
  xor2s1 U9448 ( .Q(WX8406), .DIN1(tmp_WX8406), .DIN2(tmp_trig_en) );
endmodule