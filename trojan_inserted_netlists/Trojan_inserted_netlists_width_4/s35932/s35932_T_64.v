...
hi1s1 U4762 ( .Q(tmp_n3386), .DIN(n3426) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n5567), .DIN2(n4643) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n3931), .DIN2(n3730) );
  and2s1 U9447 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1) );
  xor2s1 U9448 ( .Q(n3386), .DIN1(tmp_n3386), .DIN2(tmp_trig_en) );
endmodule