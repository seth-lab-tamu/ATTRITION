...
nnd4s1 U7838 ( .Q(tmp_WX3236), .DIN1(n5352), .DIN2(n5353), .DIN3(n5354), .DIN4(n5355) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n5008), .DIN2(n3756) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n5080), .DIN2(n4345) );
  and2s1 U9447 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1) );
  xor2s1 U9448 ( .Q(WX3236), .DIN1(tmp_WX3236), .DIN2(tmp_trig_en) );
endmodule