...
nnd4s1 U6255 ( .Q(tmp_WX704), .DIN1(n4342), .DIN2(n4343), .DIN3(n4344), .DIN4(n4345) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n3889), .DIN2(n5101) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n4876), .DIN2(n4567) );
  and2s1 U9447 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1) );
  xor2s1 U9448 ( .Q(WX704), .DIN1(tmp_WX704), .DIN2(tmp_trig_en) );
endmodule