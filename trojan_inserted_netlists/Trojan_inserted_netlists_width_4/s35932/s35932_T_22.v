...
nor2s1 U7091 ( .Q(tmp_WX4673), .DIN1(n3376), .DIN2(n3017) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n3890), .DIN2(n5924) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n4264), .DIN2(n4138) );
  and2s1 U9447 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1) );
  xor2s1 U9448 ( .Q(WX4673), .DIN1(tmp_WX4673), .DIN2(tmp_trig_en) );
endmodule