...
nor2s1 U6960 ( .Q(tmp_WX5199), .DIN1(n3373), .DIN2(n4837) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n4153), .DIN2(n5659) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n5445), .DIN2(n5493) );
  and2s1 U9447 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1) );
  xor2s1 U9448 ( .Q(WX5199), .DIN1(tmp_WX5199), .DIN2(tmp_trig_en) );
endmodule