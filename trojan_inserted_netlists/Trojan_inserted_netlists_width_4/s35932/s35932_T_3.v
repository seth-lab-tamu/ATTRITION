...
nnd4s1 U8323 ( .Q(tmp_WX1955), .DIN1(n5607), .DIN2(n5608), .DIN3(n5609), .DIN4(n5610) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n5627), .DIN2(n5249) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n4158), .DIN2(n4137) );
  and2s1 U9447 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1) );
  xor2s1 U9448 ( .Q(WX1955), .DIN1(tmp_WX1955), .DIN2(tmp_trig_en) );
endmodule