...
nnd4s1 U8080 ( .Q(tmp_WX1997), .DIN1(n5427), .DIN2(n5428), .DIN3(n5429), .DIN4(n5430) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n4692), .DIN2(n5992) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n4130), .DIN2(n4818) );
  and2s1 U9447 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1) );
  xor2s1 U9448 ( .Q(WX1997), .DIN1(tmp_WX1997), .DIN2(tmp_trig_en) );
endmodule