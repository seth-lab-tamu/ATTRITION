...
nnd4s1 U7674 ( .Q(tmp_WX3274), .DIN1(n5207), .DIN2(n5208), .DIN3(n5209), .DIN4(n5210) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n3854), .DIN2(n3676) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n5376), .DIN2(n5151) );
  and2s1 U9447 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1) );
  xor2s1 U9448 ( .Q(WX3274), .DIN1(tmp_WX3274), .DIN2(tmp_trig_en) );
endmodule