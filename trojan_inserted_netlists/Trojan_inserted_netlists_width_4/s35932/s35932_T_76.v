...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n4955), .DIN2(n4297) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n5956), .DIN2(n4489) );
  and2s1 U9447 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1) );
  xor2s1 U9448 ( .Q(n3418), .DIN1(tmp_n3418), .DIN2(tmp_trig_en) );
endmodule