...
nnd2s1 U8178 ( .Q(tmp_n5491), .DIN1(CRC_OUT_8_9), .DIN2(n3531) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n3665), .DIN2(n6001) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n4117), .DIN2(n3719) );
  and2s1 U9447 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1) );
  xor2s1 U9448 ( .Q(n5491), .DIN1(tmp_n5491), .DIN2(tmp_trig_en) );
endmodule