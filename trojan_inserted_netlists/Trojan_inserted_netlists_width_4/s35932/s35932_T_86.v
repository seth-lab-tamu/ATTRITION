...
nnd4s1 U7151 ( .Q(tmp_WX4581), .DIN1(n4883), .DIN2(n4884), .DIN3(n4885), .DIN4(n4886) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n4935), .DIN2(n4921) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n3732), .DIN2(n3714) );
  and2s1 U9447 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1) );
  xor2s1 U9448 ( .Q(WX4581), .DIN1(tmp_WX4581), .DIN2(tmp_trig_en) );
endmodule