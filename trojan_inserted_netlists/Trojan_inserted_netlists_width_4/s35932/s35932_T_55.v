...
hi1s1 U4833 ( .Q(tmp_n3457), .DIN(n3592) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n4773), .DIN2(n4105) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n5620), .DIN2(n5252) );
  and2s1 U9447 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1) );
  xor2s1 U9448 ( .Q(n3457), .DIN1(tmp_n3457), .DIN2(tmp_trig_en) );
endmodule