...
nor2s1 U5826 ( .Q(tmp_WX7747), .DIN1(n3388), .DIN2(n4084) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n3775), .DIN2(n5629) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n5669), .DIN2(n4139) );
  and2s1 U9447 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1) );
  xor2s1 U9448 ( .Q(WX7747), .DIN1(tmp_WX7747), .DIN2(tmp_trig_en) );
endmodule