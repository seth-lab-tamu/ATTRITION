...
nor2s1 U5414 ( .Q(tmp_WX8512), .DIN1(n3385), .DIN2(n3133) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n4159), .DIN2(n5918) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n4898), .DIN2(n4117) );
  and2s1 U9447 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1) );
  xor2s1 U9448 ( .Q(WX8512), .DIN1(tmp_WX8512), .DIN2(tmp_trig_en) );
endmodule