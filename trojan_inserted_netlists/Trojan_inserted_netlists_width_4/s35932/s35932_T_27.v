...
nor2s1 U5013 ( .Q(tmp_WX9849), .DIN1(n3377), .DIN2(n2951) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n5987), .DIN2(n4021) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n4672), .DIN2(n5006) );
  and2s1 U9447 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1) );
  xor2s1 U9448 ( .Q(WX9849), .DIN1(tmp_WX9849), .DIN2(tmp_trig_en) );
endmodule