...
nnd4s1 U8927 ( .Q(tmp_WX11024), .DIN1(n5928), .DIN2(n5929), .DIN3(n5930), .DIN4(n5931) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n5446), .DIN2(n5929) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n6000), .DIN2(n4352) );
  and2s1 U9447 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1) );
  xor2s1 U9448 ( .Q(WX11024), .DIN1(tmp_WX11024), .DIN2(tmp_trig_en) );
endmodule