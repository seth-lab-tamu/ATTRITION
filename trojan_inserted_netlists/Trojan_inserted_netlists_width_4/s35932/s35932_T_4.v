...
nnd2s1 U5496 ( .Q(tmp_n3861), .DIN1(CRC_OUT_3_6), .DIN2(n3547) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n6043), .DIN2(n5698) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n3941), .DIN2(n5222) );
  and2s1 U9447 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1) );
  xor2s1 U9448 ( .Q(n3861), .DIN1(tmp_n3861), .DIN2(tmp_trig_en) );
endmodule