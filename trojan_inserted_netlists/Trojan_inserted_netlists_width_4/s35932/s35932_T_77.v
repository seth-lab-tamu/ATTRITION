...
nor2s1 U7962 ( .Q(tmp_WX2565), .DIN1(n3415), .DIN2(n5413) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n4233), .DIN2(n3919) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n4195), .DIN2(n5237) );
  and2s1 U9447 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1) );
  xor2s1 U9448 ( .Q(WX2565), .DIN1(tmp_WX2565), .DIN2(tmp_trig_en) );
endmodule