...
nnd2s1 U5150 ( .Q(tmp_n3703), .DIN1(n3453), .DIN2(n3704) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n3654), .DIN2(n4218) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n5670), .DIN2(n3642) );
  and2s1 U9447 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1) );
  xor2s1 U9448 ( .Q(n3703), .DIN1(tmp_n3703), .DIN2(tmp_trig_en) );
endmodule