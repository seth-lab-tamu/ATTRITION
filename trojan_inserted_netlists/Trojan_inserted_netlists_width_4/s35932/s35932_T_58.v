...
nor2s1 U6590 ( .Q(tmp_WX5970), .DIN1(n3369), .DIN2(n2999) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n3913), .DIN2(n4380) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n5526), .DIN2(n5478) );
  and2s1 U9447 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1) );
  xor2s1 U9448 ( .Q(WX5970), .DIN1(tmp_WX5970), .DIN2(tmp_trig_en) );
endmodule