...
nnd2s1 U7309 ( .Q(tmp_n5024), .DIN1(n3477), .DIN2(n4753) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n5187), .DIN2(n5976) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n3883), .DIN2(n5912) );
  and2s1 U9447 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1) );
  xor2s1 U9448 ( .Q(n5024), .DIN1(tmp_n5024), .DIN2(tmp_trig_en) );
endmodule