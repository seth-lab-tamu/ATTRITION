...
nnd4s1 U5194 ( .Q(tmp_WX9703), .DIN1(n3754), .DIN2(n3755), .DIN3(n3756), .DIN4(n3757) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n3948), .DIN2(n4137) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n4615), .DIN2(n5085) );
  and2s1 U9447 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1) );
  xor2s1 U9448 ( .Q(WX9703), .DIN1(tmp_WX9703), .DIN2(tmp_trig_en) );
endmodule