...
nnd4s1 U8969 ( .Q(tmp_WX11014), .DIN1(n5960), .DIN2(n5961), .DIN3(n5962), .DIN4(n5963) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n5961), .DIN2(n3720) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n4366), .DIN2(n4805) );
  and2s1 U9447 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1) );
  xor2s1 U9448 ( .Q(WX11014), .DIN1(tmp_WX11014), .DIN2(tmp_trig_en) );
endmodule