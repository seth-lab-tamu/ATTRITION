...
nnd2s1 U7318 ( .Q(tmp_n5032), .DIN1(n3478), .DIN2(n4761) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n5145), .DIN2(n4877) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n5030), .DIN2(n5086) );
  and2s1 U9447 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1) );
  xor2s1 U9448 ( .Q(n5032), .DIN1(tmp_n5032), .DIN2(tmp_trig_en) );
endmodule