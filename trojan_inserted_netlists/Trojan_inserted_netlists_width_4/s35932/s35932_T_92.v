...
nnd2s1 U7776 ( .Q(tmp_n5299), .DIN1(n3480), .DIN2(n5028) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n4715), .DIN2(n5888) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n5006), .DIN2(n4763) );
  and2s1 U9447 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1) );
  xor2s1 U9448 ( .Q(n5299), .DIN1(tmp_n5299), .DIN2(tmp_trig_en) );
endmodule