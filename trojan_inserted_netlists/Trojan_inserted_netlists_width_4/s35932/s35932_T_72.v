...
nnd2s1 U6251 ( .Q(tmp_n4337), .DIN1(n3447), .DIN2(n4340) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n3718), .DIN2(n4671) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n5928), .DIN2(n5053) );
  and2s1 U9447 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1) );
  xor2s1 U9448 ( .Q(n4337), .DIN1(tmp_n4337), .DIN2(tmp_trig_en) );
endmodule