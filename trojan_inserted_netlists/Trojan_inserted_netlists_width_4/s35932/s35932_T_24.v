...
nor2s1 U8036 ( .Q(tmp_WX2065), .DIN1(n3391), .DIN2(n3076) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n5007), .DIN2(n4449) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n4724), .DIN2(n5322) );
  and2s1 U9447 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1) );
  xor2s1 U9448 ( .Q(WX2065), .DIN1(tmp_WX2065), .DIN2(tmp_trig_en) );
endmodule