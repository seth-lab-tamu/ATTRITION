...
nnd2s1 U9008 ( .Q(tmp_n5987), .DIN1(WX10849), .DIN2(n3495) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n3701), .DIN2(n4990) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n4406), .DIN2(n3629) );
  and2s1 U9447 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1) );
  xor2s1 U9448 ( .Q(n5987), .DIN1(tmp_n5987), .DIN2(tmp_trig_en) );
endmodule