...
hi1s1 U4772 ( .Q(tmp_n3396), .DIN(n3423) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n3676), .DIN2(n4794) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n4476), .DIN2(n4657) );
  and2s1 U9447 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1) );
  xor2s1 U9448 ( .Q(n3396), .DIN1(tmp_n3396), .DIN2(tmp_trig_en) );
endmodule