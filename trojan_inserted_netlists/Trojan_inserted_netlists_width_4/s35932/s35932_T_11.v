...
and2s1 U9137 ( .Q(tmp_WX10852), .DIN1(RESET), .DIN2(WX10855) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n5988), .DIN2(n3613) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n3950), .DIN2(n5378) );
  and2s1 U9447 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1) );
  xor2s1 U9448 ( .Q(WX10852), .DIN1(tmp_WX10852), .DIN2(tmp_trig_en) );
endmodule