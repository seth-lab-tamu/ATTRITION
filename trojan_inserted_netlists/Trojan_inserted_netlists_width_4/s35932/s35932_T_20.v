...
nnd2s1 U7395 ( .Q(tmp_n5095), .DIN1(n3440), .DIN2(n5100) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n4637), .DIN2(n5598) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n4248), .DIN2(n5166) );
  and2s1 U9447 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1) );
  xor2s1 U9448 ( .Q(n5095), .DIN1(tmp_n5095), .DIN2(tmp_trig_en) );
endmodule