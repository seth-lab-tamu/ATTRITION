...
nnd2s1 U5106 ( .Q(tmp_n3648), .DIN1(n3464), .DIN2(n3651) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n5283), .DIN2(n4290) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n3871), .DIN2(n4886) );
  and2s1 U9447 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1) );
  xor2s1 U9448 ( .Q(n3648), .DIN1(tmp_n3648), .DIN2(tmp_trig_en) );
endmodule