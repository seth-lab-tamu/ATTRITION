...
nor2s1 U2416 ( .Q(N6288), .DIN1(N6285), .DIN2(N6286) );
  and2s1 U2417 ( .Q(tmp_0), .DIN1(N1999), .DIN2(N2024) );
  and2s1 U2418 ( .Q(tmp_1), .DIN1(N1884), .DIN2(N4641) );
  and2s1 U2419 ( .Q(tmp_2), .DIN1(N2012), .DIN2(N4746) );
  and3s1 U2420 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1), .DIN3(tmp_2) );
  xor2s1 U2421 ( .Q(N4711), .DIN1(tmp_N4711), .DIN2(tmp_trig_en) );
endmodule
