...
wire tmp_0, tmp_1, tmp_2, tmp_3, tmp_trig_en, tmp_n814, n279, n280, n281, n282, n283, n284, n285, n286, n288, n289, n290, 
  ...
  nor2s1 U777 ( .Q(tmp_0), .DIN1(n295), .DIN2(n390) );
  nor2s1 U778 ( .Q(tmp_1), .DIN1(N792), .DIN2(N3882) );
  ...
  xor2s1 U782 ( .Q(n814), .DIN1(tmp_n814), .DIN2(tmp_trig_en) );
endmodule
