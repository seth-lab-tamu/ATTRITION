...
wire tmp_0, tmp_1, tmp_2, tmp_3, tmp_4, tmp_trig_en, tmp_n500, n279, n280, n281, n282, n283, n284, n285, n286, n288, n289, n290, 
  ...
  and2s1 U781 ( .Q(tmp_4), .DIN1(n385), .DIN2(N1277) );
  and3s1 U782 ( .Q(tmp_trig_en), .DIN1(tmp_1), .DIN2(tmp_3), .DIN3(tmp_4) );
  xor2s1 U783 ( .Q(n500), .DIN1(tmp_n500), .DIN2(tmp_trig_en) );
endmodule
