...
wire tmp_0, tmp_1, tmp_2, tmp_3, tmp_trig_en, tmp_n300, n279, n280, n281, n282, n283, n284, n285, n286, n288, n289, n290, 
  ...
  nor2s1 U780 ( .Q(tmp_3), .DIN1(N3079), .DIN2(N1448) );
  and3s1 U781 ( .Q(tmp_trig_en), .DIN1(tmp_1), .DIN2(tmp_2), .DIN3(tmp_3) );
  xor2s1 U782 ( .Q(n300), .DIN1(tmp_n300), .DIN2(tmp_trig_en) );
endmodule
