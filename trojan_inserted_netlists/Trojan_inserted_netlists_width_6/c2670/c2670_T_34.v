...
wire tmp_0, tmp_1, tmp_2, tmp_3, tmp_4, tmp_trig_en, tmp_n679, n279, n280, n281, n282, n283, n284, n285, n286, n288, n289, n290, 
    ...
    nor2s1 U314 ( .Q(tmp_n679), .DIN1(n778), .DIN2(n779) );
  ...
  nor2s1 U781 ( .Q(tmp_4), .DIN1(n390), .DIN2(N1448) );
  and3s1 U782 ( .Q(tmp_trig_en), .DIN1(tmp_1), .DIN2(tmp_3), .DIN3(tmp_4) );
  xor2s1 U783 ( .Q(n679), .DIN1(tmp_n679), .DIN2(tmp_trig_en) );
endmodule
