...
wire tmp_0, tmp_1, tmp_2, tmp_3, tmp_4, tmp_trig_en, tmp_n702, n279, n280, n281, n282, n283, n284, n285, n286, n288, n289, n290, 
    ...
    nor2s1 U350 ( .Q(tmp_n702), .DIN1(n812), .DIN2(n813) );
  ...
  nor2s1 U779 ( .Q(tmp_2), .DIN1(n383), .DIN2(N3882) );
  ...
  xor2s1 U783 ( .Q(n702), .DIN1(tmp_n702), .DIN2(tmp_trig_en) );
endmodule
