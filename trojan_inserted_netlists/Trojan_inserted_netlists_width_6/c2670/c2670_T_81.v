...
wire tmp_0, tmp_1, tmp_2, tmp_trig_en, tmp_n300, n279, n280, n281, n282, n283, n284, n285, n286, n288, n289, n290, 
  ...
  nor2s1 U777 ( .Q(tmp_0), .DIN1(N792), .DIN2(N1970) );
  and2s1 U778 ( .Q(tmp_1), .DIN1(n374), .DIN2(N1277) );
  nor2s1 U779 ( .Q(tmp_2), .DIN1(N1448), .DIN2(n280) );
  and3s1 U780 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1), .DIN3(tmp_2) );
  xor2s1 U781 ( .Q(n300), .DIN1(tmp_n300), .DIN2(tmp_trig_en) );
endmodule
