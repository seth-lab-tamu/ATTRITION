...
nnd4s1 U6061 ( .Q(tmp_WX7149), .DIN1(n4172), .DIN2(n4173), .DIN3(n4174), .DIN4(n4175) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n4651), .DIN2(n5180) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n4926), .DIN2(n5578) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n5468), .DIN2(n5452) );
  and3s1 U9448 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1), .DIN3(tmp_2) );
  xor2s1 U9449 ( .Q(WX7149), .DIN1(tmp_WX7149), .DIN2(tmp_trig_en) );
endmodule