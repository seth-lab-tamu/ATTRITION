...
nor2s1 U7960 ( .Q(tmp_WX2567), .DIN1(n3415), .DIN2(n5412) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n5259), .DIN2(n3654) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n5486), .DIN2(n5462) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n4338), .DIN2(n5000) );
  and3s1 U9448 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1), .DIN3(tmp_2) );
  xor2s1 U9449 ( .Q(WX2567), .DIN1(tmp_WX2567), .DIN2(tmp_trig_en) );
endmodule