...
nnd4s1 U7191 ( .Q(tmp_WX4571), .DIN1(n4918), .DIN2(n4919), .DIN3(n4920), .DIN4(n4921) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n3749), .DIN2(n5086) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n3599), .DIN2(n6058) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n3731), .DIN2(n3997) );
  and3s1 U9448 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1), .DIN3(tmp_2) );
  xor2s1 U9449 ( .Q(WX4571), .DIN1(tmp_WX4571), .DIN2(tmp_trig_en) );
endmodule