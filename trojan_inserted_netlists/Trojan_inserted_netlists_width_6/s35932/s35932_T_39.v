...
nnd4s1 U9029 ( .Q(tmp_WX11002), .DIN1(n6006), .DIN2(n6007), .DIN3(n6008), .DIN4(n6009) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n5905), .DIN2(n5210) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n5430), .DIN2(n3654) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n5196), .DIN2(n5881) );
  and3s1 U9448 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1), .DIN3(tmp_2) );
  xor2s1 U9449 ( .Q(WX11002), .DIN1(tmp_WX11002), .DIN2(tmp_trig_en) );
endmodule