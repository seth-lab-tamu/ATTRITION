...
nnd2s1 U6221 ( .Q(tmp_n4314), .DIN1(n3471), .DIN2(n4043) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n3713), .DIN2(n3677) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n4686), .DIN2(n4173) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n6008), .DIN2(n5930) );
  and3s1 U9448 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1), .DIN3(tmp_2) );
  xor2s1 U9449 ( .Q(n4314), .DIN1(tmp_n4314), .DIN2(tmp_trig_en) );
endmodule