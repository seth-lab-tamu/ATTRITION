...
nor2s1 U6617 ( .Q(tmp_WX5916), .DIN1(n3372), .DIN2(n3170) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n6036), .DIN2(n4947) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n5918), .DIN2(n5628) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n3611), .DIN2(n4905) );
  and3s1 U9448 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1), .DIN3(tmp_2) );
  xor2s1 U9449 ( .Q(WX5916), .DIN1(tmp_WX5916), .DIN2(tmp_trig_en) );
endmodule