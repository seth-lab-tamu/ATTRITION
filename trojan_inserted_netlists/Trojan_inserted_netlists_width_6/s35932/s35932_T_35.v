...
nor2s1 U5314 ( .Q(tmp_WX9024), .DIN1(n3383), .DIN2(n3817) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n5222), .DIN2(n4519) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n4406), .DIN2(n5969) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n5436), .DIN2(n3635) );
  and3s1 U9448 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1), .DIN3(tmp_2) );
  xor2s1 U9449 ( .Q(WX9024), .DIN1(tmp_WX9024), .DIN2(tmp_trig_en) );
endmodule