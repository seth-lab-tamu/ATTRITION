...
nor2s1 U5415 ( .Q(tmp_WX8510), .DIN1(n3386), .DIN2(n3134) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n3856), .DIN2(n4022) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n3870), .DIN2(n4652) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n5429), .DIN2(n4393) );
  and3s1 U9448 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1), .DIN3(tmp_2) );
  xor2s1 U9449 ( .Q(WX8510), .DIN1(tmp_WX8510), .DIN2(tmp_trig_en) );
endmodule