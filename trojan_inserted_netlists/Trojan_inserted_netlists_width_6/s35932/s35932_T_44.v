...
nnd2s1 U5205 ( .Q(tmp_n3769), .DIN1(n3452), .DIN2(n3770) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n3718), .DIN2(n4144) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n5344), .DIN2(n4594) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n5687), .DIN2(n4730) );
  and3s1 U9448 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1), .DIN3(tmp_2) );
  xor2s1 U9449 ( .Q(n3769), .DIN1(tmp_n3769), .DIN2(tmp_trig_en) );
endmodule