...
nor2s1 U6605 ( .Q(tmp_WX5940), .DIN1(n3371), .DIN2(n3158) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n5346), .DIN2(n5354) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n5895), .DIN2(n6037) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n5699), .DIN2(n6051) );
  and3s1 U9448 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1), .DIN3(tmp_2) );
  xor2s1 U9449 ( .Q(WX5940), .DIN1(tmp_WX5940), .DIN2(tmp_trig_en) );
endmodule