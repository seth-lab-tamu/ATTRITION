...
nor2s1 U7926 ( .Q(tmp_WX2599), .DIN1(n3413), .DIN2(n5394) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n5007), .DIN2(n5525) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n5913), .DIN2(n4724) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n5015), .DIN2(n4435) );
  and3s1 U9448 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1), .DIN3(tmp_2) );
  xor2s1 U9449 ( .Q(WX2599), .DIN1(tmp_WX2599), .DIN2(tmp_trig_en) );
endmodule