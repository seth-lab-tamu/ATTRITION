...
nnd4s1 U7802 ( .Q(tmp_WX3244), .DIN1(n5320), .DIN2(n5321), .DIN3(n5322), .DIN4(n5323) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n4699), .DIN2(n5946) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n5368), .DIN2(n5687) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n4622), .DIN2(n4311) );
  and3s1 U9448 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1), .DIN3(tmp_2) );
  xor2s1 U9449 ( .Q(WX3244), .DIN1(tmp_WX3244), .DIN2(tmp_trig_en) );
endmodule