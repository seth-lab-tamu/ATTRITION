...
nor2s1 U6972 ( .Q(tmp_WX5187), .DIN1(n3373), .DIN2(n4843) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n4175), .DIN2(n4023) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n5347), .DIN2(n4387) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n4970), .DIN2(n4168) );
  and3s1 U9448 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1), .DIN3(tmp_2) );
  xor2s1 U9449 ( .Q(WX5187), .DIN1(tmp_WX5187), .DIN2(tmp_trig_en) );
endmodule