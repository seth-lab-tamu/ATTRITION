...
nnd2s1 U6478 ( .Q(tmp_n4549), .DIN1(CRC_OUT_9_29), .DIN2(n3540) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n3641), .DIN2(n3695) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n4187), .DIN2(n4117) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n5250), .DIN2(n4166) );
  and3s1 U9448 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1), .DIN3(tmp_2) );
  xor2s1 U9449 ( .Q(n4549), .DIN1(tmp_n4549), .DIN2(tmp_trig_en) );
endmodule