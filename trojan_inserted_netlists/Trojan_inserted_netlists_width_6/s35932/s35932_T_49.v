...
nor2s1 U5795 ( .Q(tmp_WX7775), .DIN1(n3387), .DIN2(n4068) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n5937), .DIN2(n4820) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n4132), .DIN2(n4603) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n3601), .DIN2(n4756) );
  and3s1 U9448 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1), .DIN3(tmp_2) );
  xor2s1 U9449 ( .Q(WX7775), .DIN1(tmp_WX7775), .DIN2(tmp_trig_en) );
endmodule