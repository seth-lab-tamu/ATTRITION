...
nor2s1 U8511 ( .Q(tmp_WX1300), .DIN1(n3393), .DIN2(n5720) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n4659), .DIN2(n5258) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n3667), .DIN2(n5883) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n4496), .DIN2(n6016) );
  and3s1 U9448 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1), .DIN3(tmp_2) );
  xor2s1 U9449 ( .Q(WX1300), .DIN1(tmp_WX1300), .DIN2(tmp_trig_en) );
endmodule