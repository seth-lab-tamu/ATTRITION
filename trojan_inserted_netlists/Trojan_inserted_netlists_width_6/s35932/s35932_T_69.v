...
nnd2s1 U6180 ( .Q(tmp_n4273), .DIN1(n3448), .DIN2(n4278) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n3910), .DIN2(n5868) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n4967), .DIN2(n4615) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n5352), .DIN2(n4426) );
  and3s1 U9448 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1), .DIN3(tmp_2) );
  xor2s1 U9449 ( .Q(n4273), .DIN1(tmp_n4273), .DIN2(tmp_trig_en) );
endmodule