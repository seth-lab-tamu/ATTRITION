...
nnd2s1 U7296 ( .Q(tmp_n5007), .DIN1(n3441), .DIN2(n5012) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n4933), .DIN2(n4484) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n5014), .DIN2(n5222) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n4533), .DIN2(n5588) );
  and3s1 U9448 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1), .DIN3(tmp_2) );
  xor2s1 U9449 ( .Q(n5007), .DIN1(tmp_n5007), .DIN2(tmp_trig_en) );
endmodule