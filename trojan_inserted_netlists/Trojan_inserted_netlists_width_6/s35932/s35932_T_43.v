...
nor2s1 U6613 ( .Q(tmp_WX5924), .DIN1(n3372), .DIN2(n3166) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n3957), .DIN2(n5894) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n3617), .DIN2(n4975) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n4280), .DIN2(n4926) );
  and3s1 U9448 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1), .DIN3(tmp_2) );
  xor2s1 U9449 ( .Q(WX5924), .DIN1(tmp_WX5924), .DIN2(tmp_trig_en) );
endmodule