...
nor2s1 U7495 ( .Q(tmp_WX3858), .DIN1(n3409), .DIN2(n5138) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n4006), .DIN2(n4510) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n5533), .DIN2(n5216) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n3998), .DIN2(n4297) );
  and3s1 U9448 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1), .DIN3(tmp_2) );
  xor2s1 U9449 ( .Q(WX3858), .DIN1(tmp_WX3858), .DIN2(tmp_trig_en) );
endmodule