...
nnd4s1 U8903 ( .Q(tmp_WX11030), .DIN1(n5910), .DIN2(n5911), .DIN3(n5912), .DIN4(n5913) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n5881), .DIN2(n3836) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n5371), .DIN2(n4499) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n4709), .DIN2(n5252) );
  and3s1 U9448 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1), .DIN3(tmp_2) );
  xor2s1 U9449 ( .Q(WX11030), .DIN1(tmp_WX11030), .DIN2(tmp_trig_en) );
endmodule