...
nor2s1 U6999 ( .Q(tmp_WX5163), .DIN1(n3374), .DIN2(n4857) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n5931), .DIN2(n5549) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n3715), .DIN2(n5202) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n3667), .DIN2(n4202) );
  and3s1 U9448 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1), .DIN3(tmp_2) );
  xor2s1 U9449 ( .Q(WX5163), .DIN1(tmp_WX5163), .DIN2(tmp_trig_en) );
endmodule