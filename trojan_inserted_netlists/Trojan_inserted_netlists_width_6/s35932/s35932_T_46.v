...
nor2s1 U6523 ( .Q(tmp_WX6444), .DIN1(n3368), .DIN2(n4581) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n5882), .DIN2(n5094) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n4672), .DIN2(n3855) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n5894), .DIN2(n5900) );
  and3s1 U9448 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1), .DIN3(tmp_2) );
  xor2s1 U9449 ( .Q(WX6444), .DIN1(tmp_WX6444), .DIN2(tmp_trig_en) );
endmodule