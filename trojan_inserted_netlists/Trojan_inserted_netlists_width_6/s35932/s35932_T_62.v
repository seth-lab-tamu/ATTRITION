...
nor2s1 U7504 ( .Q(tmp_WX3850), .DIN1(n3409), .DIN2(n5143) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n3658), .DIN2(n5922) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n5567), .DIN2(n4165) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n4044), .DIN2(n5539) );
  and3s1 U9448 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1), .DIN3(tmp_2) );
  xor2s1 U9449 ( .Q(WX3850), .DIN1(tmp_WX3850), .DIN2(tmp_trig_en) );
endmodule