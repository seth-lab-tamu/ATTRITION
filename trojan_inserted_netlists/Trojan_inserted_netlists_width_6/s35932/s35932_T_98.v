...
nor2s1 U5290 ( .Q(tmp_WX9046), .DIN1(n3382), .DIN2(n3804) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n4708), .DIN2(n5258) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n4673), .DIN2(n5346) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n5509), .DIN2(n3619) );
  and3s1 U9448 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1), .DIN3(tmp_2) );
  xor2s1 U9449 ( .Q(WX9046), .DIN1(tmp_WX9046), .DIN2(tmp_trig_en) );
endmodule