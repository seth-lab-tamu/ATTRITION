...
nnd2s1 U7853 ( .Q(tmp_n5362), .DIN1(n3438), .DIN2(n5367) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n4105), .DIN2(n4765) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n3951), .DIN2(n3991) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n5259), .DIN2(n3666) );
  and3s1 U9448 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1), .DIN3(tmp_2) );
  xor2s1 U9449 ( .Q(n5362), .DIN1(tmp_n5362), .DIN2(tmp_trig_en) );
endmodule