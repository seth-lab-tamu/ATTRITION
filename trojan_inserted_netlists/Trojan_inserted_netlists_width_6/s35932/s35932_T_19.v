...
nor2s1 U5271 ( .Q(tmp_WX9064), .DIN1(n3381), .DIN2(n3794) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n5274), .DIN2(n5461) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n3733), .DIN2(n4038) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n5167), .DIN2(n5877) );
  and3s1 U9448 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1), .DIN3(tmp_2) );
  xor2s1 U9449 ( .Q(WX9064), .DIN1(tmp_WX9064), .DIN2(tmp_trig_en) );
endmodule