...
nor2s1 U7559 ( .Q(tmp_WX3378), .DIN1(n3410), .DIN2(n3055) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n4146), .DIN2(n5853) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n5549), .DIN2(n3655) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n4610), .DIN2(n3942) );
  and3s1 U9448 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1), .DIN3(tmp_2) );
  xor2s1 U9449 ( .Q(WX3378), .DIN1(tmp_WX3378), .DIN2(tmp_trig_en) );
endmodule