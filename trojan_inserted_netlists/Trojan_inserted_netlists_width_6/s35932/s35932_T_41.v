...
nnd4s1 U5529 ( .Q(tmp_WX8442), .DIN1(n3896), .DIN2(n3897), .DIN3(n3898), .DIN4(n3899) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n5101), .DIN2(n4319) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n5967), .DIN2(n5934) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n5567), .DIN2(n4311) );
  and3s1 U9448 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1), .DIN3(tmp_2) );
  xor2s1 U9449 ( .Q(WX8442), .DIN1(tmp_WX8442), .DIN2(tmp_trig_en) );
endmodule