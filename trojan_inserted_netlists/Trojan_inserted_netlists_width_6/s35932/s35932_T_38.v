...
nnd2s1 U6082 ( .Q(tmp_n4188), .DIN1(n3449), .DIN2(n4192) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n3628), .DIN2(n3903) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n4586), .DIN2(n4525) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n5531), .DIN2(n4044) );
  and3s1 U9448 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1), .DIN3(tmp_2) );
  xor2s1 U9449 ( .Q(n4188), .DIN1(tmp_n4188), .DIN2(tmp_trig_en) );
endmodule