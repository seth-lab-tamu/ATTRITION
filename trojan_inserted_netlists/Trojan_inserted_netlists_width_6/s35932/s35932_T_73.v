...
and2s1 U9145 ( .Q(tmp_WX10836), .DIN1(RESET), .DIN2(WX10839) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n4913), .DIN2(n3757) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n3697), .DIN2(n5995) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n4701), .DIN2(n5216) );
  and3s1 U9448 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1), .DIN3(tmp_2) );
  xor2s1 U9449 ( .Q(WX10836), .DIN1(tmp_WX10836), .DIN2(tmp_trig_en) );
endmodule