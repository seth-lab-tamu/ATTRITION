...
nor2s1 U5255 ( .Q(tmp_WX9080), .DIN1(n3380), .DIN2(n3786) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n3637), .DIN2(n4596) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n4885), .DIN2(n5679) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n4969), .DIN2(n3757) );
  and3s1 U9448 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1), .DIN3(tmp_2) );
  xor2s1 U9449 ( .Q(WX9080), .DIN1(tmp_WX9080), .DIN2(tmp_trig_en) );
endmodule