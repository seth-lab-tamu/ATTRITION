...
nor2s1 U1848 ( .Q(tmp_N5005), .DIN1(N4947), .DIN2(N4881) );
...
nor2s1 U2416 ( .Q(N6288), .DIN1(N6285), .DIN2(N6286) );
  and2s1 U2417 ( .Q(tmp_0), .DIN1(N2018), .DIN2(N1576) );
  and2s1 U2418 ( .Q(tmp_1), .DIN1(N1563), .DIN2(N2004) );
  and2s1 U2419 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1) );
  xor2s1 U2420 ( .Q(N5005), .DIN1(tmp_N5005), .DIN2(tmp_trig_en) );
endmodule
