...
nor2s1 U839 ( .Q(tmp_N2664), .DIN1(N2615), .DIN2(N2503) );
...
nor2s1 U2416 ( .Q(N6288), .DIN1(N6285), .DIN2(N6286) );
  and2s1 U2417 ( .Q(tmp_0), .DIN1(N2026), .DIN2(N2018) );
  and2s1 U2418 ( .Q(tmp_1), .DIN1(N2586), .DIN2(N1568) );
  and2s1 U2419 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1) );
  xor2s1 U2420 ( .Q(N2664), .DIN1(tmp_N2664), .DIN2(tmp_trig_en) );
endmodule
