...
wire tmp_0, tmp_1, tmp_trig_en, tmp_n813, n279, n280, n281, n282, n283, n284, n285, n286, n288, n289, n290, 
  ...
  nor2s1 U778 ( .Q(tmp_1), .DIN1(n389), .DIN2(n849) );
  and2s1 U779 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1) );
  xor2s1 U780 ( .Q(n813), .DIN1(tmp_n813), .DIN2(tmp_trig_en) );
endmodule
