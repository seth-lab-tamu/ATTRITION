...
nnd2s1 U8195 ( .Q(tmp_n5509), .DIN1(n3437), .DIN2(n4416) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n4715), .DIN2(n5468) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n4693), .DIN2(n4505) );
  and2s1 U9447 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1) );
  xor2s1 U9448 ( .Q(n5509), .DIN1(tmp_n5509), .DIN2(tmp_trig_en) );
endmodule