...
and2s1 U9133 ( .Q(tmp_WX10860), .DIN1(RESET), .DIN2(WX10863) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n4912), .DIN2(n4779) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n4240), .DIN2(n5500) );
  and2s1 U9447 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1) );
  xor2s1 U9448 ( .Q(WX10860), .DIN1(tmp_WX10860), .DIN2(tmp_trig_en) );
endmodule