...
nnd4s1 U6004 ( .Q(tmp_WX7163), .DIN1(n4123), .DIN2(n4124), .DIN3(n4125), .DIN4(n4126) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n5850), .DIN2(n6048) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n5657), .DIN2(n3868) );
  and2s1 U9447 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1) );
  xor2s1 U9448 ( .Q(WX7163), .DIN1(tmp_WX7163), .DIN2(tmp_trig_en) );
endmodule