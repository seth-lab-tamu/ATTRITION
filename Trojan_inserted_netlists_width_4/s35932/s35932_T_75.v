...
nor2s1 U8645 ( .Q(tmp_WX11638), .DIN1(n3396), .DIN2(n5800) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n4195), .DIN2(n3982) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n5258), .DIN2(n3715) );
  and2s1 U9447 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1) );
  xor2s1 U9448 ( .Q(WX11638), .DIN1(tmp_WX11638), .DIN2(tmp_trig_en) );
endmodule