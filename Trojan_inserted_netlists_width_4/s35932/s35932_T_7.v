...
nnd4s1 U8871 ( .Q(tmp_WX11038), .DIN1(n5886), .DIN2(n5887), .DIN3(n5888), .DIN4(n5889) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n4249), .DIN2(n5995) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n4934), .DIN2(n3697) );
  and2s1 U9447 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1) );
  xor2s1 U9448 ( .Q(WX11038), .DIN1(tmp_WX11038), .DIN2(tmp_trig_en) );
endmodule