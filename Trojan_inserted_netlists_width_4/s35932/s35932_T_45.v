...
nnd2s1 U7289 ( .Q(tmp_n4997), .DIN1(CRC_OUT_6_18), .DIN2(n3536) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n4773), .DIN2(n4992) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n4147), .DIN2(n4408) );
  and2s1 U9447 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1) );
  xor2s1 U9448 ( .Q(n4997), .DIN1(tmp_n4997), .DIN2(tmp_trig_en) );
endmodule