...
nnd2s1 U7184 ( .Q(tmp_n4914), .DIN1(n3476), .DIN2(n4642) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n3647), .DIN2(n4053) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n5229), .DIN2(n4707) );
  and2s1 U9447 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1) );
  xor2s1 U9448 ( .Q(n4914), .DIN1(tmp_n4914), .DIN2(tmp_trig_en) );
endmodule