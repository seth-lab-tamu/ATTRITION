...
nnd4s1 U5089 ( .Q(tmp_WX9745), .DIN1(n3628), .DIN2(n3629), .DIN3(n3630), .DIN4(n3631) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n4415), .DIN2(n4290) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n4949), .DIN2(n3720) );
  and2s1 U9447 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1) );
  xor2s1 U9448 ( .Q(WX9745), .DIN1(tmp_WX9745), .DIN2(tmp_trig_en) );
endmodule