...
nnd4s1 U8887 ( .Q(tmp_WX11034), .DIN1(n5898), .DIN2(n5899), .DIN3(n5900), .DIN4(n5901) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n4518), .DIN2(n5272) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n5013), .DIN2(n4826) );
  and2s1 U9447 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1) );
  xor2s1 U9448 ( .Q(WX11034), .DIN1(tmp_WX11034), .DIN2(tmp_trig_en) );
endmodule