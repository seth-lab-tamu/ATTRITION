...
nnd2s1 U7873 ( .Q(tmp_n5376), .DIN1(CRC_OUT_7_31), .DIN2(n3532) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n3767), .DIN2(n3623) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n5054), .DIN2(n4755) );
  and2s1 U9447 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1) );
  xor2s1 U9448 ( .Q(n5376), .DIN1(tmp_n5376), .DIN2(tmp_trig_en) );
endmodule