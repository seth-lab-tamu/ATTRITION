...
nor2s1 U6515 ( .Q(tmp_WX6452), .DIN1(n3369), .DIN2(n4577) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n5955), .DIN2(n4145) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n3683), .DIN2(n4512) );
  and2s1 U9447 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1) );
  xor2s1 U9448 ( .Q(WX6452), .DIN1(tmp_WX6452), .DIN2(tmp_trig_en) );
endmodule