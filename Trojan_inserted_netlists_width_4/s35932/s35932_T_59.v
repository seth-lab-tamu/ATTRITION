...
nnd2s1 U5098 ( .Q(tmp_n3634), .DIN1(CRC_OUT_2_7), .DIN2(n3550) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n5436), .DIN2(n5281) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n4173), .DIN2(n4891) );
  and2s1 U9447 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1) );
  xor2s1 U9448 ( .Q(n3634), .DIN1(tmp_n3634), .DIN2(tmp_trig_en) );
endmodule