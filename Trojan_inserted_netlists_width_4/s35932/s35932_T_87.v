...
nor2s1 U8608 ( .Q(tmp_WX11668), .DIN1(n3395), .DIN2(n5780) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n4890), .DIN2(n5467) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n5874), .DIN2(n3706) );
  and2s1 U9447 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1) );
  xor2s1 U9448 ( .Q(WX11668), .DIN1(tmp_WX11668), .DIN2(tmp_trig_en) );
endmodule