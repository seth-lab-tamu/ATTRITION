...
nnd4s1 U6156 ( .Q(tmp_WX7127), .DIN1(n4255), .DIN2(n4256), .DIN3(n4257), .DIN4(n4258) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n4023), .DIN2(n5462) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n3864), .DIN2(n5347) );
  and2s1 U9447 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1) );
  xor2s1 U9448 ( .Q(WX7127), .DIN1(tmp_WX7127), .DIN2(tmp_trig_en) );
endmodule