...
nnd2s1 U6453 ( .Q(tmp_n4531), .DIN1(n3445), .DIN2(n4536) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n3862), .DIN2(n3855) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n5062), .DIN2(n4224) );
  and2s1 U9447 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1) );
  xor2s1 U9448 ( .Q(n4531), .DIN1(tmp_n4531), .DIN2(tmp_trig_en) );
endmodule