...
nor2s1 U5263 ( .Q(tmp_WX9072), .DIN1(n3380), .DIN2(n3790) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n4330), .DIN2(n4639) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n5245), .DIN2(n4709) );
  and2s1 U9447 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1) );
  xor2s1 U9448 ( .Q(WX9072), .DIN1(tmp_WX9072), .DIN2(tmp_trig_en) );
endmodule