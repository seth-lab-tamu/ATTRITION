...
nor2s1 U5784 ( .Q(tmp_WX7785), .DIN1(n3387), .DIN2(n4063) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n4319), .DIN2(n3903) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n4650), .DIN2(n5928) );
  and2s1 U9447 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1) );
  xor2s1 U9448 ( .Q(WX7785), .DIN1(tmp_WX7785), .DIN2(tmp_trig_en) );
endmodule