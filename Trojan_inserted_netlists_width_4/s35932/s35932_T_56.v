...
nnd2s1 U5133 ( .Q(tmp_n3676), .DIN1(CRC_OUT_2_14), .DIN2(n3549) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n4884), .DIN2(n5094) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n3719), .DIN2(n3677) );
  and2s1 U9447 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1) );
  xor2s1 U9448 ( .Q(n3676), .DIN1(tmp_n3676), .DIN2(tmp_trig_en) );
endmodule