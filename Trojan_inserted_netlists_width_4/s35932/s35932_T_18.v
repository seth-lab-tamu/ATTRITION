...
nor2s1 U8016 ( .Q(tmp_WX2105), .DIN1(n3417), .DIN2(n3040) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n5371), .DIN2(n4534) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n4133), .DIN2(n5168) );
  and2s1 U9447 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1) );
  xor2s1 U9448 ( .Q(WX2105), .DIN1(tmp_WX2105), .DIN2(tmp_trig_en) );
endmodule