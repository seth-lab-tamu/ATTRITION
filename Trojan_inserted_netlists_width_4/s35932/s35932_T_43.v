...
nor2s1 U5275 ( .Q(tmp_WX9060), .DIN1(n3381), .DIN2(n3796) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n3751), .DIN2(n3856) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n5469), .DIN2(n5970) );
  and2s1 U9447 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1) );
  xor2s1 U9448 ( .Q(WX9060), .DIN1(tmp_WX9060), .DIN2(tmp_trig_en) );
endmodule