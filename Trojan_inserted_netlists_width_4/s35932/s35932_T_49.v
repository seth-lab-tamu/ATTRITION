...
nnd2s1 U6137 ( .Q(tmp_n4231), .DIN1(CRC_OUT_4_19), .DIN2(n3544) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n5161), .DIN2(n4015) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n4242), .DIN2(n4551) );
  and2s1 U9447 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1) );
  xor2s1 U9448 ( .Q(n4231), .DIN1(tmp_n4231), .DIN2(tmp_trig_en) );
endmodule