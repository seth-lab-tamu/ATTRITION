...
nor2s1 U8027 ( .Q(tmp_WX2083), .DIN1(n3397), .DIN2(n3058) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n5209), .DIN2(n5216) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n3974), .DIN2(n4414) );
  and2s1 U9447 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1) );
  xor2s1 U9448 ( .Q(WX2083), .DIN1(tmp_WX2083), .DIN2(tmp_trig_en) );
endmodule