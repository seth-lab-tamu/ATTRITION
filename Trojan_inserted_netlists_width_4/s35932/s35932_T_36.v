...
nor2s1 U7498 ( .Q(tmp_WX3856), .DIN1(n3409), .DIN2(n5140) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n4021), .DIN2(n4568) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n5329), .DIN2(n5698) );
  and2s1 U9447 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1) );
  xor2s1 U9448 ( .Q(WX3856), .DIN1(tmp_WX3856), .DIN2(tmp_trig_en) );
endmodule