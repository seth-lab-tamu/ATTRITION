...
nor2s1 U7467 ( .Q(tmp_WX3884), .DIN1(n3407), .DIN2(n5123) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n4330), .DIN2(n5196) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n4031), .DIN2(n5072) );
  and2s1 U9447 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1) );
  xor2s1 U9448 ( .Q(WX3884), .DIN1(tmp_WX3884), .DIN2(tmp_trig_en) );
endmodule