...
nnd2s1 U8885 ( .Q(tmp_n5893), .DIN1(DATA_0_7), .DIN2(n3484) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n3780), .DIN2(n5870) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n5054), .DIN2(n6043) );
  and2s1 U9447 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1) );
  xor2s1 U9448 ( .Q(n5893), .DIN1(tmp_n5893), .DIN2(tmp_trig_en) );
endmodule