...
nor2s1 U5422 ( .Q(tmp_WX8498), .DIN1(n3386), .DIN2(n3140) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n5281), .DIN2(n5858) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n6015), .DIN2(n4357) );
  and2s1 U9447 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1) );
  xor2s1 U9448 ( .Q(WX8498), .DIN1(tmp_WX8498), .DIN2(tmp_trig_en) );
endmodule