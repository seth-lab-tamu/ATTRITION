...
nnd2s1 U6019 ( .Q(tmp_n4130), .DIN1(CRC_OUT_4_5), .DIN2(n3545) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n4827), .DIN2(n4117) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n5046), .DIN2(n4378) );
  and2s1 U9447 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1) );
  xor2s1 U9448 ( .Q(n4130), .DIN1(tmp_n4130), .DIN2(tmp_trig_en) );
endmodule