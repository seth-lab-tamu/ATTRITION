...
nnd2s1 U6749 ( .Q(tmp_n4695), .DIN1(n3474), .DIN2(n4199) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n4763), .DIN2(n5648) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n4427), .DIN2(n4152) );
  and2s1 U9447 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1) );
  xor2s1 U9448 ( .Q(n4695), .DIN1(tmp_n4695), .DIN2(tmp_trig_en) );
endmodule