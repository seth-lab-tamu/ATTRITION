...
wire tmp_0, tmp_1, tmp_2, tmp_trig_en, tmp_N1028, n279, n280, n281, n282, n283, n284, n285, n286, n288, n289, n290, 
    ...
    nnd2s1 U21 ( .Q(tmp_N1028), .DIN1(N7), .DIN2(N237) );
  ...
  nor2s1 U779 ( .Q(tmp_2), .DIN1(N792), .DIN2(N1970) );
  and2s1 U780 ( .Q(tmp_trig_en), .DIN1(tmp_1), .DIN2(tmp_2) );
  xor2s1 U781 ( .Q(N1028), .DIN1(tmp_N1028), .DIN2(tmp_trig_en) );
endmodule
