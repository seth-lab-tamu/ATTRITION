...
wire tmp_0, tmp_1, tmp_trig_en, tmp_N2925, n279, n280, n281, n282, n283, n284, n285, n286, n288, n289, n290, 
    ...
    hi1s1 U457 ( .Q(tmp_N2925), .DIN(n656) );
  ...
  xor2s1 U780 ( .Q(N2925), .DIN1(tmp_N2925), .DIN2(tmp_trig_en) );
endmodule
