...
wire tmp_0, tmp_1, tmp_2, tmp_trig_en, tmp_n703, n279, n280, n281, n282, n283, n284, n285, n286, n288, n289, n290, 
    ...
    nor2s1 U353 ( .Q(tmp_n703), .DIN1(n815), .DIN2(n816) );
  ...
  nor2s1 U779 ( .Q(tmp_2), .DIN1(n849), .DIN2(N1448) );
  and2s1 U780 ( .Q(tmp_trig_en), .DIN1(tmp_1), .DIN2(tmp_2) );
  xor2s1 U781 ( .Q(n703), .DIN1(tmp_n703), .DIN2(tmp_trig_en) );
endmodule
