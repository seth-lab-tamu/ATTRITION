...
wire tmp_trig_en, tmp_n678, n279, n280, n281, n282, n283, n284, n285, n286, n288, n289, n290, 
  ...
  and2s1 U777 ( .Q(tmp_trig_en), .DIN1(n759), .DIN2(N1277) );
  xor2s1 U778 ( .Q(n678), .DIN1(tmp_n678), .DIN2(tmp_trig_en) );
endmodule
