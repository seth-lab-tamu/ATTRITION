...
wire tmp_0, tmp_N1726, n279, n280, n281, n282, n283, n284, n285, n286, n288, n289, n290, 
    ...
    hi1s1 U460 ( .Q(tmp_N1726), .DIN(n430) );
  ...
  xor2s1 U778 ( .Q(N1726), .DIN1(tmp_N1726), .DIN2(tmp_trig_en) );
endmodule
