...
wire tmp_0, tmp_n488, n279, n280, n281, n282, n283, n284, n285, n286, n288, n289, n290, 
    ...
    nnd2s1 U576 ( .Q(tmp_n488), .DIN1(N269), .DIN2(n434) );
  ...
  nor2s1 U777 ( .Q(tmp_trig_en), .DIN1(n295), .DIN2(n296) );
  xor2s1 U778 ( .Q(n488), .DIN1(tmp_n488), .DIN2(tmp_trig_en) );
endmodule
