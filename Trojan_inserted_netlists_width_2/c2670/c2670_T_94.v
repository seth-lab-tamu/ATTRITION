...
wire tmp_0, tmp_n790, n279, n280, n281, n282, n283, n284, n285, n286, n288, n289, n290, 
    ...
    nor2s1 U324 ( .Q(tmp_n790), .DIN1(N34), .DIN2(n403) );
  ...
  nor2s1 U777 ( .Q(tmp_trig_en), .DIN1(n289), .DIN2(N792) );
  xor2s1 U778 ( .Q(n790), .DIN1(tmp_n790), .DIN2(tmp_trig_en) );
endmodule
