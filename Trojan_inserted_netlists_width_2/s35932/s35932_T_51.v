...
nnd4s1 U6238 ( .Q(tmp_WX7109), .DIN1(n4327), .DIN2(n4328), .DIN3(n4329), .DIN4(n4330) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_trig_en), .DIN1(n5345), .DIN2(n4021) );
  xor2s1 U9446 ( .Q(WX7109), .DIN1(tmp_WX7109), .DIN2(tmp_trig_en) );
endmodule