...
and2s1 U9149 ( .Q(tmp_WX10828), .DIN1(RESET), .DIN2(WX10831) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_trig_en), .DIN1(n3625), .DIN2(n4449) );
  xor2s1 U9446 ( .Q(WX10828), .DIN1(tmp_WX10828), .DIN2(tmp_trig_en) );
endmodule