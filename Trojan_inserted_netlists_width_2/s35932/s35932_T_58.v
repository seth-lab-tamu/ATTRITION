...
hi1s1 U4753 ( .Q(tmp_n3377), .DIN(n3429) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_trig_en), .DIN1(n4787), .DIN2(n4357) );
  xor2s1 U9446 ( .Q(n3377), .DIN1(tmp_n3377), .DIN2(tmp_trig_en) );
endmodule