...
nnd2s1 U5625 ( .Q(tmp_n3983), .DIN1(n3468), .DIN2(n3728) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_trig_en), .DIN1(n4288), .DIN2(n4658) );
  xor2s1 U9446 ( .Q(n3983), .DIN1(tmp_n3983), .DIN2(tmp_trig_en) );
endmodule