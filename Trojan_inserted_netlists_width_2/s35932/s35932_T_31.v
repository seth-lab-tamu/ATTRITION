...
nnd2s1 U6862 ( .Q(tmp_n4786), .DIN1(CRC_OUT_5_26), .DIN2(n3538) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_trig_en), .DIN1(n3622), .DIN2(n4622) );
  xor2s1 U9446 ( .Q(n4786), .DIN1(tmp_n4786), .DIN2(tmp_trig_en) );
endmodule