...
nnd4s1 U5579 ( .Q(tmp_WX8430), .DIN1(n3940), .DIN2(n3941), .DIN3(n3942), .DIN4(n3943) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_trig_en), .DIN1(n4279), .DIN2(n4869) );
  xor2s1 U9446 ( .Q(WX8430), .DIN1(tmp_WX8430), .DIN2(tmp_trig_en) );
endmodule