...
nnd2s1 U7287 ( .Q(tmp_n4999), .DIN1(n3441), .DIN2(n5004) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_trig_en), .DIN1(n5452), .DIN2(n4166) );
  xor2s1 U9446 ( .Q(n4999), .DIN1(tmp_n4999), .DIN2(tmp_trig_en) );
endmodule