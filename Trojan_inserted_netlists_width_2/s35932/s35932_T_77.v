...
hi1s1 U4770 ( .Q(tmp_n3394), .DIN(n3424) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_trig_en), .DIN1(n3737), .DIN2(n4045) );
  xor2s1 U9446 ( .Q(n3394), .DIN1(tmp_n3394), .DIN2(tmp_trig_en) );
endmodule