...
nnd2s1 U8090 ( .Q(tmp_n5427), .DIN1(CRC_OUT_8_1), .DIN2(n3532) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_trig_en), .DIN1(n4450), .DIN2(n4210) );
  xor2s1 U9446 ( .Q(n5427), .DIN1(tmp_n5427), .DIN2(tmp_trig_en) );
endmodule