...
nnd2s1 U8840 ( .Q(tmp_n5865), .DIN1(n3435), .DIN2(n3609) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_trig_en), .DIN1(n4118), .DIN2(n4351) );
  xor2s1 U9446 ( .Q(n5865), .DIN1(tmp_n5865), .DIN2(tmp_trig_en) );
endmodule