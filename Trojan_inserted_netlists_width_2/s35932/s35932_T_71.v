...
nor2s1 U8493 ( .Q(tmp_WX1318), .DIN1(n3392), .DIN2(n5711) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_trig_en), .DIN1(n4870), .DIN2(n4707) );
  xor2s1 U9446 ( .Q(WX1318), .DIN1(tmp_WX1318), .DIN2(tmp_trig_en) );
endmodule