...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_trig_en), .DIN1(n4706), .DIN2(n4447) );
  xor2s1 U9446 ( .Q(WX3244), .DIN1(tmp_WX3244), .DIN2(tmp_trig_en) );
endmodule