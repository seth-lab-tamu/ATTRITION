...
nnd2s1 U6385 ( .Q(tmp_n4456), .DIN1(n3446), .DIN2(n4459) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_trig_en), .DIN1(n3854), .DIN2(n3917) );
  xor2s1 U9446 ( .Q(n4456), .DIN1(tmp_n4456), .DIN2(tmp_trig_en) );
endmodule