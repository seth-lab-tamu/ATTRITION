...
nnd2s1 U6349 ( .Q(tmp_n4414), .DIN1(n3446), .DIN2(n4417) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_trig_en), .DIN1(n4263), .DIN2(n5200) );
  xor2s1 U9446 ( .Q(n4414), .DIN1(tmp_n4414), .DIN2(tmp_trig_en) );
endmodule