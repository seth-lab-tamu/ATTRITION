...
nnd2s1 U6379 ( .Q(tmp_n4449), .DIN1(n3446), .DIN2(n4452) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_trig_en), .DIN1(n3768), .DIN2(n3951) );
  xor2s1 U9446 ( .Q(n4449), .DIN1(tmp_n4449), .DIN2(tmp_trig_en) );
endmodule