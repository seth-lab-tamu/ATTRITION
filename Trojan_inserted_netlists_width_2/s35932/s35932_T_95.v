...
nnd4s1 U7748 ( .Q(tmp_WX3256), .DIN1(n5272), .DIN2(n5273), .DIN3(n5274), .DIN4(n5275) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_trig_en), .DIN1(n3841), .DIN2(n5852) );
  xor2s1 U9446 ( .Q(WX3256), .DIN1(tmp_WX3256), .DIN2(tmp_trig_en) );
endmodule