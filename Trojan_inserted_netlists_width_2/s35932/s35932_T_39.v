...
nor2s1 U5279 ( .Q(tmp_WX9056), .DIN1(n3381), .DIN2(n3798) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_trig_en), .DIN1(n3763), .DIN2(n4941) );
  xor2s1 U9446 ( .Q(WX9056), .DIN1(tmp_WX9056), .DIN2(tmp_trig_en) );
endmodule