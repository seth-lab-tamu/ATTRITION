...
nnd2s1 U7633 ( .Q(tmp_n5165), .DIN1(CRC_OUT_7_3), .DIN2(n3534) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_trig_en), .DIN1(n4052), .DIN2(n4636) );
  xor2s1 U9446 ( .Q(n5165), .DIN1(tmp_n5165), .DIN2(tmp_trig_en) );
endmodule