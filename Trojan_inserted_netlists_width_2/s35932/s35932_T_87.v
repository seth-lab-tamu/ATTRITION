...
nnd2s1 U7736 ( .Q(tmp_n5258), .DIN1(n3439), .DIN2(n5263) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_trig_en), .DIN1(n4030), .DIN2(n4820) );
  xor2s1 U9446 ( .Q(n5258), .DIN1(tmp_n5258), .DIN2(tmp_trig_en) );
endmodule