...
nnd2s1 U9010 ( .Q(tmp_n5985), .DIN1(CRC_OUT_1_21), .DIN2(n3527) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_trig_en), .DIN1(n3708), .DIN2(n5371) );
  xor2s1 U9446 ( .Q(n5985), .DIN1(tmp_n5985), .DIN2(tmp_trig_en) );
endmodule