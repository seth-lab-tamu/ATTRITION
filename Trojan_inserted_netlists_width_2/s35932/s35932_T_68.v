...
nnd4s1 U5456 ( .Q(tmp_WX8460), .DIN1(n3833), .DIN2(n3834), .DIN3(n3835), .DIN4(n3836) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_trig_en), .DIN1(n4036), .DIN2(n4356) );
  xor2s1 U9446 ( .Q(WX8460), .DIN1(tmp_WX8460), .DIN2(tmp_trig_en) );
endmodule