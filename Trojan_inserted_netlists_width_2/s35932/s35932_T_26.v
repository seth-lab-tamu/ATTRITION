...
nnd2s1 U5502 ( .Q(tmp_n3870), .DIN1(n3452), .DIN2(n3874) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_trig_en), .DIN1(n5928), .DIN2(n4685) );
  xor2s1 U9446 ( .Q(n3870), .DIN1(tmp_n3870), .DIN2(tmp_trig_en) );
endmodule