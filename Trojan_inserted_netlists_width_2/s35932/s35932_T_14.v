...
nnd2s1 U6162 ( .Q(tmp_n4257), .DIN1(n3448), .DIN2(n4262) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_trig_en), .DIN1(n5376), .DIN2(n4826) );
  xor2s1 U9446 ( .Q(n4257), .DIN1(tmp_n4257), .DIN2(tmp_trig_en) );
endmodule