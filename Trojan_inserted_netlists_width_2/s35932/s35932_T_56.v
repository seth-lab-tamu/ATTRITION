...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_trig_en), .DIN1(n4878), .DIN2(n4241) );
  xor2s1 U9446 ( .Q(WX3360), .DIN1(tmp_WX3360), .DIN2(tmp_trig_en) );
endmodule