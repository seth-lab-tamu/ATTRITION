...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_trig_en), .DIN1(n3882), .DIN2(n5264) );
  xor2s1 U9446 ( .Q(n5974), .DIN1(tmp_n5974), .DIN2(tmp_trig_en) );
endmodule