...
nnd4s1 U5634 ( .Q(tmp_WX8418), .DIN1(n3988), .DIN2(n3989), .DIN3(n3990), .DIN4(n3991) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_trig_en), .DIN1(n4215), .DIN2(n4377) );
  xor2s1 U9446 ( .Q(WX8418), .DIN1(tmp_WX8418), .DIN2(tmp_trig_en) );
endmodule