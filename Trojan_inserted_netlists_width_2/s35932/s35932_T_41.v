...
nnd2s1 U9063 ( .Q(tmp_n6028), .DIN1(DATA_0_27), .DIN2(n3485) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_trig_en), .DIN1(n4787), .DIN2(n4616) );
  xor2s1 U9446 ( .Q(n6028), .DIN1(tmp_n6028), .DIN2(tmp_trig_en) );
endmodule