...
nnd2s1 U7180 ( .Q(tmp_n4906), .DIN1(n3442), .DIN2(n4910) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_trig_en), .DIN1(n5189), .DIN2(n4373) );
  xor2s1 U9446 ( .Q(n4906), .DIN1(tmp_n4906), .DIN2(tmp_trig_en) );
endmodule