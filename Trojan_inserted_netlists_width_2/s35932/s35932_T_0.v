...
nor2s1 U7008 ( .Q(tmp_WX5155), .DIN1(n3375), .DIN2(n4861) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_trig_en), .DIN1(n4681), .DIN2(n5238) );
  xor2s1 U9446 ( .Q(WX5155), .DIN1(tmp_WX5155), .DIN2(tmp_trig_en) );
endmodule