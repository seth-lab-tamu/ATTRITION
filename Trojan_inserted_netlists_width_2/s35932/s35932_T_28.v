...
nnd2s1 U8916 ( .Q(tmp_n5918), .DIN1(WX10869), .DIN2(n3496) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_trig_en), .DIN1(n3695), .DIN2(n4693) );
  xor2s1 U9446 ( .Q(n5918), .DIN1(tmp_n5918), .DIN2(tmp_trig_en) );
endmodule