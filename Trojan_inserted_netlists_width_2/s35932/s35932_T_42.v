...
nnd2s1 U5110 ( .Q(tmp_n3655), .DIN1(n3454), .DIN2(n3656) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_trig_en), .DIN1(n4912), .DIN2(n4216) );
  xor2s1 U9446 ( .Q(n3655), .DIN1(tmp_n3655), .DIN2(tmp_trig_en) );
endmodule