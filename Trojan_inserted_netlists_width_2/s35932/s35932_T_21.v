...
nnd4s1 U7380 ( .Q(tmp_WX4527), .DIN1(n5085), .DIN2(n5086), .DIN3(n5087), .DIN4(n5088) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_trig_en), .DIN1(n5443), .DIN2(n4762) );
  xor2s1 U9446 ( .Q(WX4527), .DIN1(tmp_WX4527), .DIN2(tmp_trig_en) );
endmodule