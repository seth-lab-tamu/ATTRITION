...
nnd2s1 U5559 ( .Q(tmp_n3919), .DIN1(n3451), .DIN2(n3923) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_trig_en), .DIN1(n4242), .DIN2(n5347) );
  xor2s1 U9446 ( .Q(n3919), .DIN1(tmp_n3919), .DIN2(tmp_trig_en) );
endmodule