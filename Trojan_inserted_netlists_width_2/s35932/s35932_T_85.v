...
nor2s1 U5286 ( .Q(tmp_WX9050), .DIN1(n3381), .DIN2(n3802) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_trig_en), .DIN1(n4667), .DIN2(n4970) );
  xor2s1 U9446 ( .Q(WX9050), .DIN1(tmp_WX9050), .DIN2(tmp_trig_en) );
endmodule