...
nor2s1 U6592 ( .Q(tmp_WX5966), .DIN1(n3369), .DIN2(n3001) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_trig_en), .DIN1(n4414), .DIN2(n5063) );
  xor2s1 U9446 ( .Q(WX5966), .DIN1(tmp_WX5966), .DIN2(tmp_trig_en) );
endmodule