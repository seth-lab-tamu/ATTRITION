...
nnd2s1 U5083 ( .Q(tmp_n3616), .DIN1(CRC_OUT_2_4), .DIN2(n3550) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_trig_en), .DIN1(n4345), .DIN2(n4963) );
  xor2s1 U9446 ( .Q(n3616), .DIN1(tmp_n3616), .DIN2(tmp_trig_en) );
endmodule