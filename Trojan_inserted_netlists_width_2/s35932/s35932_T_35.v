...
nor2s1 U8495 ( .Q(tmp_WX1316), .DIN1(n3392), .DIN2(n5712) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_trig_en), .DIN1(n3847), .DIN2(n5242) );
  xor2s1 U9446 ( .Q(WX1316), .DIN1(tmp_WX1316), .DIN2(tmp_trig_en) );
endmodule