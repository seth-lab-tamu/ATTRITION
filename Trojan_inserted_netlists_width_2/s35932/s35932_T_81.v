...
nor2s1 U7958 ( .Q(tmp_WX2569), .DIN1(n3415), .DIN2(n5411) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_trig_en), .DIN1(n5900), .DIN2(n5962) );
  xor2s1 U9446 ( .Q(WX2569), .DIN1(tmp_WX2569), .DIN2(tmp_trig_en) );
endmodule