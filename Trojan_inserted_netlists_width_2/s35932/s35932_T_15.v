...
nnd2s1 U8910 ( .Q(tmp_n5910), .DIN1(CRC_OUT_1_10), .DIN2(n3528) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_trig_en), .DIN1(n4787), .DIN2(n5361) );
  xor2s1 U9446 ( .Q(n5910), .DIN1(tmp_n5910), .DIN2(tmp_trig_en) );
endmodule