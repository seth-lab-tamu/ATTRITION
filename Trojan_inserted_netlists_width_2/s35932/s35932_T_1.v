...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_trig_en), .DIN1(n4202), .DIN2(n3926) );
  xor2s1 U9446 ( .Q(WX2559), .DIN1(tmp_WX2559), .DIN2(tmp_trig_en) );
endmodule