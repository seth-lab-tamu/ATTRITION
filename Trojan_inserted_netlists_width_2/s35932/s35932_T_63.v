...
nor2s1 U5028 ( .Q(tmp_WX9819), .DIN1(n3378), .DIN2(n3110) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_trig_en), .DIN1(n3870), .DIN2(n5525) );
  xor2s1 U9446 ( .Q(WX9819), .DIN1(tmp_WX9819), .DIN2(tmp_trig_en) );
endmodule