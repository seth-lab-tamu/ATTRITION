...
nnd2s1 U7683 ( .Q(tmp_n5217), .DIN1(n3479), .DIN2(n4945) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_trig_en), .DIN1(n5548), .DIN2(n5558) );
  xor2s1 U9446 ( .Q(n5217), .DIN1(tmp_n5217), .DIN2(tmp_trig_en) );
endmodule