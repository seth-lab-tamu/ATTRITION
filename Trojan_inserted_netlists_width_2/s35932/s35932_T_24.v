...
nnd2s1 U8439 ( .Q(tmp_n5687), .DIN1(CRC_OUT_8_30), .DIN2(n3529) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_trig_en), .DIN1(n3862), .DIN2(n5313) );
  xor2s1 U9446 ( .Q(n5687), .DIN1(tmp_n5687), .DIN2(tmp_trig_en) );
endmodule