...
nor2s1 U6955 ( .Q(tmp_WX5203), .DIN1(n3372), .DIN2(n4835) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_trig_en), .DIN1(n4393), .DIN2(n4297) );
  xor2s1 U9446 ( .Q(WX5203), .DIN1(tmp_WX5203), .DIN2(tmp_trig_en) );
endmodule