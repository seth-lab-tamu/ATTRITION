...
nnd2s1 U7782 ( .Q(tmp_n5297), .DIN1(WX3091), .DIN2(n3501) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_trig_en), .DIN1(n3883), .DIN2(n4651) );
  xor2s1 U9446 ( .Q(n5297), .DIN1(tmp_n5297), .DIN2(tmp_trig_en) );
endmodule