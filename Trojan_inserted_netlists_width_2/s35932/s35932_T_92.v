...
nor2s1 U8012 ( .Q(tmp_WX2113), .DIN1(n3416), .DIN2(n3036) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_trig_en), .DIN1(n4912), .DIN2(n5194) );
  xor2s1 U9446 ( .Q(WX2113), .DIN1(tmp_WX2113), .DIN2(tmp_trig_en) );
endmodule