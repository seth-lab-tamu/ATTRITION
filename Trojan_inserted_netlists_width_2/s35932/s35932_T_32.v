...
nnd2s1 U5095 ( .Q(tmp_n3637), .DIN1(n3454), .DIN2(n3638) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_trig_en), .DIN1(n3843), .DIN2(n4646) );
  xor2s1 U9446 ( .Q(n3637), .DIN1(tmp_n3637), .DIN2(tmp_trig_en) );
endmodule