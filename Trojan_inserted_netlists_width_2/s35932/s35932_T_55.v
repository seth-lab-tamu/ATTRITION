...
nor2s1 U5269 ( .Q(tmp_WX9066), .DIN1(n3381), .DIN2(n3793) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_trig_en), .DIN1(n5960), .DIN2(n5868) );
  xor2s1 U9446 ( .Q(WX9066), .DIN1(tmp_WX9066), .DIN2(tmp_trig_en) );
endmodule