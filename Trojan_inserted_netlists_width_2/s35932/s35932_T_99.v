...
nnd2s1 U7619 ( .Q(tmp_n5161), .DIN1(n3478), .DIN2(n4889) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_trig_en), .DIN1(n3883), .DIN2(n3949) );
  xor2s1 U9446 ( .Q(n5161), .DIN1(tmp_n5161), .DIN2(tmp_trig_en) );
endmodule