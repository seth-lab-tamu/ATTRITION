...
nor2s1 U1172 ( .Q(tmp_N3445), .DIN1(N3386), .DIN2(N900) );
...
nor2s1 U2416 ( .Q(N6288), .DIN1(N6285), .DIN2(N6286) );
  and2s1 U2417 ( .Q(tmp_trig_en), .DIN1(N1551), .DIN2(N2221) );
  xor2s1 U2418 ( .Q(N3445), .DIN1(tmp_N3445), .DIN2(tmp_trig_en) );
endmodule
