...
nor2s1 U2285 ( .Q(tmp_N6014), .DIN1(N5981), .DIN2(N732) );
...
nor2s1 U2416 ( .Q(N6288), .DIN1(N6285), .DIN2(N6286) );
  and2s1 U2417 ( .Q(tmp_trig_en), .DIN1(N1884), .DIN2(N1556) );
  xor2s1 U2418 ( .Q(N6014), .DIN1(tmp_N6014), .DIN2(tmp_trig_en) );
endmodule
