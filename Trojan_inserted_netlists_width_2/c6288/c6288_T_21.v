...
nor2s1 U2416 ( .Q(N6288), .DIN1(N6285), .DIN2(N6286) );
  and2s1 U2417 ( .Q(tmp_trig_en), .DIN1(N5670), .DIN2(N1692) );
  xor2s1 U2418 ( .Q(N2040), .DIN1(tmp_N2040), .DIN2(tmp_trig_en) );
endmodule
