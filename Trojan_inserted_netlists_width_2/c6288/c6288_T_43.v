...
nor2s1 U616 ( .Q(tmp_N2159), .DIN1(N2043), .DIN2(N2093) );
...
nor2s1 U2416 ( .Q(N6288), .DIN1(N6285), .DIN2(N6286) );
  and2s1 U2417 ( .Q(tmp_trig_en), .DIN1(N1698), .DIN2(N2801) );
  xor2s1 U2418 ( .Q(N2159), .DIN1(tmp_N2159), .DIN2(tmp_trig_en) );
endmodule
