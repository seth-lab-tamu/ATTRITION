...
nor2s1 U1342 ( .Q(tmp_N3836), .DIN1(N3768), .DIN2(N663) );
...
nor2s1 U2416 ( .Q(N6288), .DIN1(N6285), .DIN2(N6286) );
  and2s1 U2417 ( .Q(tmp_trig_en), .DIN1(N1849), .DIN2(N2014) );
  xor2s1 U2418 ( .Q(N3836), .DIN1(tmp_N3836), .DIN2(tmp_trig_en) );
endmodule
