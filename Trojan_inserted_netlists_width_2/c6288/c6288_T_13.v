...
nor2s1 U2340 ( .Q(tmp_N6135), .DIN1(N6128), .DIN2(N6129) );
...
nor2s1 U2416 ( .Q(N6288), .DIN1(N6285), .DIN2(N6286) );
  and2s1 U2417 ( .Q(tmp_trig_en), .DIN1(N1688), .DIN2(N1523) );
  xor2s1 U2418 ( .Q(N6135), .DIN1(tmp_N6135), .DIN2(tmp_trig_en) );
endmodule
