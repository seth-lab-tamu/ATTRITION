...
nor2s1 U896 ( .Q(tmp_N2807), .DIN1(N2745), .DIN2(N558) );
...
nor2s1 U2416 ( .Q(N6288), .DIN1(N6285), .DIN2(N6286) );
  and2s1 U2417 ( .Q(tmp_trig_en), .DIN1(N3996), .DIN2(N3360) );
  xor2s1 U2418 ( .Q(N2807), .DIN1(tmp_N2807), .DIN2(tmp_trig_en) );
endmodule
