...
nor2s1 U1502 ( .Q(tmp_N4199), .DIN1(N4130), .DIN2(N810) );
...
nor2s1 U2416 ( .Q(N6288), .DIN1(N6285), .DIN2(N6286) );
  and2s1 U2417 ( .Q(tmp_trig_en), .DIN1(N1874), .DIN2(N4285) );
  xor2s1 U2418 ( .Q(N4199), .DIN1(tmp_N4199), .DIN2(tmp_trig_en) );
endmodule
