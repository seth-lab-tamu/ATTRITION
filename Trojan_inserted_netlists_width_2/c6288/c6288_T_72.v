...
nor2s1 U1736 ( .Q(tmp_N4739), .DIN1(N4687), .DIN2(N4688) );
...
nor2s1 U2416 ( .Q(N6288), .DIN1(N6285), .DIN2(N6286) );
  and2s1 U2417 ( .Q(tmp_trig_en), .DIN1(N1874), .DIN2(N3321) );
  xor2s1 U2418 ( .Q(N4739), .DIN1(tmp_N4739), .DIN2(tmp_trig_en) );
endmodule
