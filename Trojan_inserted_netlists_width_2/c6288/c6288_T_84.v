...
nor2s1 U850 ( .Q(tmp_N2675), .DIN1(N2639), .DIN2(N2640) );
...
nor2s1 U2416 ( .Q(N6288), .DIN1(N6285), .DIN2(N6286) );
  and2s1 U2417 ( .Q(tmp_trig_en), .DIN1(N1884), .DIN2(N4746) );
  xor2s1 U2418 ( .Q(N2675), .DIN1(tmp_N2675), .DIN2(tmp_trig_en) );
endmodule
