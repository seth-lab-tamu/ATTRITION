...
nor2s1 U2016 ( .Q(tmp_N5399), .DIN1(N5280), .DIN2(N5339) );
...
nor2s1 U2416 ( .Q(N6288), .DIN1(N6285), .DIN2(N6286) );
  and2s1 U2417 ( .Q(tmp_trig_en), .DIN1(N3996), .DIN2(N1578) );
  xor2s1 U2418 ( .Q(N5399), .DIN1(tmp_N5399), .DIN2(tmp_trig_en) );
endmodule
