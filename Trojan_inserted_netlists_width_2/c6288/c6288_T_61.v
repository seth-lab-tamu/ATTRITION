...
nor2s1 U1427 ( .Q(tmp_N4019), .DIN1(N3975), .DIN2(N3976) );
...
nor2s1 U2416 ( .Q(N6288), .DIN1(N6285), .DIN2(N6286) );
  and2s1 U2417 ( .Q(tmp_trig_en), .DIN1(N5234), .DIN2(N2028) );
  xor2s1 U2418 ( .Q(N4019), .DIN1(tmp_N4019), .DIN2(tmp_trig_en) );
endmodule
