...
and2s1 U145 ( .Q(tmp_N975), .DIN1(N154), .DIN2(N273) );
...
nor2s1 U2416 ( .Q(N6288), .DIN1(N6285), .DIN2(N6286) );
  and2s1 U2417 ( .Q(tmp_trig_en), .DIN1(N1571), .DIN2(N2137) );
  xor2s1 U2418 ( .Q(N975), .DIN1(tmp_N975), .DIN2(tmp_trig_en) );
endmodule
