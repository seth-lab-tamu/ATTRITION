...
nor2s1 U1879 ( .Q(tmp_N5072), .DIN1(N5017), .DIN2(N4896) );
...
nor2s1 U2416 ( .Q(N6288), .DIN1(N6285), .DIN2(N6286) );
  and2s1 U2417 ( .Q(tmp_trig_en), .DIN1(N2026), .DIN2(N4159) );
  xor2s1 U2418 ( .Q(N5072), .DIN1(tmp_N5072), .DIN2(tmp_trig_en) );
endmodule
