...
nor2s1 U1378 ( .Q(tmp_N3911), .DIN1(N3855), .DIN2(N3856) );
...
nor2s1 U2416 ( .Q(N6288), .DIN1(N6285), .DIN2(N6286) );
  and2s1 U2417 ( .Q(tmp_trig_en), .DIN1(N4519), .DIN2(N3942) );
  xor2s1 U2418 ( .Q(N3911), .DIN1(tmp_N3911), .DIN2(tmp_trig_en) );
endmodule
