...
nor2s1 U2273 ( .Q(tmp_N5988), .DIN1(N5904), .DIN2(N5950) );
...
nor2s1 U2416 ( .Q(N6288), .DIN1(N6285), .DIN2(N6286) );
  and2s1 U2417 ( .Q(tmp_trig_en), .DIN1(N1546), .DIN2(N2743) );
  xor2s1 U2418 ( .Q(N5988), .DIN1(tmp_N5988), .DIN2(tmp_trig_en) );
endmodule
