...
nor2s1 U492 ( .Q(tmp_N1860), .DIN1(N1791), .DIN2(N885) );
...
nor2s1 U2416 ( .Q(N6288), .DIN1(N6285), .DIN2(N6286) );
  and2s1 U2417 ( .Q(tmp_trig_en), .DIN1(N1558), .DIN2(N4460) );
  xor2s1 U2418 ( .Q(N1860), .DIN1(tmp_N1860), .DIN2(tmp_trig_en) );
endmodule
