...
nor2s1 U2085 ( .Q(tmp_N5557), .DIN1(N5493), .DIN2(N5494) );
...
nor2s1 U2416 ( .Q(N6288), .DIN1(N6285), .DIN2(N6286) );
  and2s1 U2417 ( .Q(tmp_trig_en), .DIN1(N4393), .DIN2(N4171) );
  xor2s1 U2418 ( .Q(N5557), .DIN1(tmp_N5557), .DIN2(tmp_trig_en) );
endmodule
