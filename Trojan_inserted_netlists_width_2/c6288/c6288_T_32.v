...
nor2s1 U1478 ( .Q(tmp_N4155), .DIN1(N4091), .DIN2(N1101) );
...
nor2s1 U2416 ( .Q(N6288), .DIN1(N6285), .DIN2(N6286) );
  and2s1 U2417 ( .Q(tmp_trig_en), .DIN1(N2682), .DIN2(N1710) );
  xor2s1 U2418 ( .Q(N4155), .DIN1(tmp_N4155), .DIN2(tmp_trig_en) );
endmodule
