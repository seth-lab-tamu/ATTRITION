...
nor2s1 U1680 ( .Q(tmp_N4613), .DIN1(N4561), .DIN2(N4562) );
...
nor2s1 U2416 ( .Q(N6288), .DIN1(N6285), .DIN2(N6286) );
  and2s1 U2417 ( .Q(tmp_trig_en), .DIN1(N1548), .DIN2(N3131) );
  xor2s1 U2418 ( .Q(N4613), .DIN1(tmp_N4613), .DIN2(tmp_trig_en) );
endmodule
