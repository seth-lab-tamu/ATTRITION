...
nor2s1 U2416 ( .Q(N6288), .DIN1(N6285), .DIN2(N6286) );
  and2s1 U2417 ( .Q(tmp_trig_en), .DIN1(N1849), .DIN2(N3321) );
  xor2s1 U2418 ( .Q(N2548), .DIN1(tmp_N2548), .DIN2(tmp_trig_en) );
endmodule
