...
hi1s1 U281 ( .Q(tmp_N1380), .DIN(N1327) );
...
nor2s1 U2416 ( .Q(N6288), .DIN1(N6285), .DIN2(N6286) );
  and2s1 U2417 ( .Q(tmp_trig_en), .DIN1(N3131), .DIN2(N2342) );
  xor2s1 U2418 ( .Q(N1380), .DIN1(tmp_N1380), .DIN2(tmp_trig_en) );
endmodule
