...
nor2s1 U2283 ( .Q(tmp_N6010), .DIN1(N5975), .DIN2(N5935) );
...
nor2s1 U2416 ( .Q(N6288), .DIN1(N6285), .DIN2(N6286) );
  and2s1 U2417 ( .Q(tmp_trig_en), .DIN1(N2648), .DIN2(N2328) );
  xor2s1 U2418 ( .Q(N6010), .DIN1(tmp_N6010), .DIN2(tmp_trig_en) );
endmodule
