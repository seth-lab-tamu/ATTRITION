...
nor2s1 U1572 ( .Q(tmp_N4361), .DIN1(N4254), .DIN2(N4310) );
...
nor2s1 U2416 ( .Q(N6288), .DIN1(N6285), .DIN2(N6286) );
  and2s1 U2417 ( .Q(tmp_trig_en), .DIN1(N5063), .DIN2(N3697) );
  xor2s1 U2418 ( .Q(N4361), .DIN1(tmp_N4361), .DIN2(tmp_trig_en) );
endmodule
