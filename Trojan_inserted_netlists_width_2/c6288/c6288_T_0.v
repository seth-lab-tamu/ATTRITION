...
nor2s1 U1828 ( .Q(tmp_N4956), .DIN1(N4899), .DIN2(N4900) );
...
nor2s1 U2416 ( .Q(N6288), .DIN1(N6285), .DIN2(N6286) );
  and2s1 U2417 ( .Q(tmp_trig_en), .DIN1(N5780), .DIN2(N1558) );
  xor2s1 U2418 ( .Q(N4956), .DIN1(tmp_N4956), .DIN2(tmp_trig_en) );
endmodule
