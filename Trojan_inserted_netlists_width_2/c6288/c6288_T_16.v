...
nor2s1 U2416 ( .Q(N6288), .DIN1(N6285), .DIN2(N6286) );
  and2s1 U2417 ( .Q(tmp_trig_en), .DIN1(N5364), .DIN2(N2014) );
  xor2s1 U2418 ( .Q(N5540), .DIN1(tmp_N5540), .DIN2(tmp_trig_en) );
endmodule
