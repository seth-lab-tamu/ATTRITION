...
nor2s1 U1295 ( .Q(tmp_N3715), .DIN1(N3668), .DIN2(N3669) );
...
nor2s1 U2416 ( .Q(N6288), .DIN1(N6285), .DIN2(N6286) );
  and2s1 U2417 ( .Q(tmp_trig_en), .DIN1(N1692), .DIN2(N3014) );
  xor2s1 U2418 ( .Q(N3715), .DIN1(tmp_N3715), .DIN2(tmp_trig_en) );
endmodule
