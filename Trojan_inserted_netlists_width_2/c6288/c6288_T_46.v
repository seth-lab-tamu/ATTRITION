...
nor2s1 U2007 ( .Q(tmp_N5378), .DIN1(N5259), .DIN2(N5318) );
...
nor2s1 U2416 ( .Q(N6288), .DIN1(N6285), .DIN2(N6286) );
  and2s1 U2417 ( .Q(tmp_trig_en), .DIN1(N4448), .DIN2(N1702) );
  xor2s1 U2418 ( .Q(N5378), .DIN1(tmp_N5378), .DIN2(tmp_trig_en) );
endmodule
