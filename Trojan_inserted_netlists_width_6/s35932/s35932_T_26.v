...
nnd2s1 U8368 ( .Q(tmp_n5639), .DIN1(n3435), .DIN2(n4514) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n4869), .DIN2(n5922) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n4511), .DIN2(n5312) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n4601), .DIN2(n4123) );
  and3s1 U9448 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1), .DIN3(tmp_2) );
  xor2s1 U9449 ( .Q(n5639), .DIN1(tmp_n5639), .DIN2(tmp_trig_en) );
endmodule