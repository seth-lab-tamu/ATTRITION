...
nnd2s1 U8985 ( .Q(tmp_n5968), .DIN1(DATA_0_19), .DIN2(n3485) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n5056), .DIN2(n4464) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n5430), .DIN2(n3738) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n5863), .DIN2(n3678) );
  and3s1 U9448 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1), .DIN3(tmp_2) );
  xor2s1 U9449 ( .Q(n5968), .DIN1(tmp_n5968), .DIN2(tmp_trig_en) );
endmodule