...
nnd2s1 U6667 ( .Q(tmp_n4615), .DIN1(CRC_OUT_5_3), .DIN2(n3540) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n3855), .DIN2(n5976) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n3725), .DIN2(n4145) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n3973), .DIN2(n3707) );
  and3s1 U9448 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1), .DIN3(tmp_2) );
  xor2s1 U9449 ( .Q(n4615), .DIN1(tmp_n4615), .DIN2(tmp_trig_en) );
endmodule