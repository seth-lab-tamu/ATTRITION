...
nor2s1 U5929 ( .Q(tmp_WX7249), .DIN1(n3370), .DIN2(n2990) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n5037), .DIN2(n5328) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n5451), .DIN2(n4095) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n4890), .DIN2(n4426) );
  and3s1 U9448 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1), .DIN3(tmp_2) );
  xor2s1 U9449 ( .Q(WX7249), .DIN1(tmp_WX7249), .DIN2(tmp_trig_en) );
endmodule