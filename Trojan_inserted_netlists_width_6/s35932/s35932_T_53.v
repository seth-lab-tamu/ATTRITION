...
nor2s1 U7912 ( .Q(tmp_WX2613), .DIN1(n3413), .DIN2(n5387) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n4401), .DIN2(n4977) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n4569), .DIN2(n3836) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n4387), .DIN2(n3738) );
  and3s1 U9448 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1), .DIN3(tmp_2) );
  xor2s1 U9449 ( .Q(WX2613), .DIN1(tmp_WX2613), .DIN2(tmp_trig_en) );
endmodule