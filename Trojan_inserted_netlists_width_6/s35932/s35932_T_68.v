...
nnd4s1 U8427 ( .Q(tmp_WX1939), .DIN1(n5687), .DIN2(n5688), .DIN3(n5689), .DIN4(n5690) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n3778), .DIN2(n5850) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n5419), .DIN2(n3956) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n4826), .DIN2(n3917) );
  and3s1 U9448 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1), .DIN3(tmp_2) );
  xor2s1 U9449 ( .Q(WX1939), .DIN1(tmp_WX1939), .DIN2(tmp_trig_en) );
endmodule