...
nnd4s1 U7666 ( .Q(tmp_WX3276), .DIN1(n5200), .DIN2(n5201), .DIN3(n5202), .DIN4(n5203) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n4956), .DIN2(n5182) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n5259), .DIN2(n4485) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n3654), .DIN2(n3822) );
  and3s1 U9448 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1), .DIN3(tmp_2) );
  xor2s1 U9449 ( .Q(WX3276), .DIN1(tmp_WX3276), .DIN2(tmp_trig_en) );
endmodule