...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n5250), .DIN2(n5955) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n4819), .DIN2(n4448) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n4795), .DIN2(n4947) );
  and3s1 U9448 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1), .DIN3(tmp_2) );
  xor2s1 U9449 ( .Q(n5929), .DIN1(tmp_n5929), .DIN2(tmp_trig_en) );
endmodule