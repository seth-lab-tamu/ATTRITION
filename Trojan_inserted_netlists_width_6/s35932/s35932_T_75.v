...
nor2s1 U5793 ( .Q(tmp_WX7777), .DIN1(n3387), .DIN2(n4067) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n4616), .DIN2(n3965) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n4166), .DIN2(n3981) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n5250), .DIN2(n4982) );
  and3s1 U9448 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1), .DIN3(tmp_2) );
  xor2s1 U9449 ( .Q(WX7777), .DIN1(tmp_WX7777), .DIN2(tmp_trig_en) );
endmodule