...
nor2s1 U6600 ( .Q(tmp_WX5950), .DIN1(n3370), .DIN2(n3009) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n4217), .DIN2(n5649) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n6023), .DIN2(n5970) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n3685), .DIN2(n5689) );
  and3s1 U9448 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1), .DIN3(tmp_2) );
  xor2s1 U9449 ( .Q(WX5950), .DIN1(tmp_WX5950), .DIN2(tmp_trig_en) );
endmodule