...
nor2s1 U7487 ( .Q(tmp_WX3866), .DIN1(n3408), .DIN2(n5134) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n5912), .DIN2(n4587) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n3876), .DIN2(n3890) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n5377), .DIN2(n3925) );
  and3s1 U9448 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1), .DIN3(tmp_2) );
  xor2s1 U9449 ( .Q(WX3866), .DIN1(tmp_WX3866), .DIN2(tmp_trig_en) );
endmodule