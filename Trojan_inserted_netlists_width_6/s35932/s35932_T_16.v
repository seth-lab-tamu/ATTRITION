...
nnd4s1 U8987 ( .Q(tmp_WX11010), .DIN1(n5974), .DIN2(n5975), .DIN3(n5976), .DIN4(n5977) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n4095), .DIN2(n4826) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n5557), .DIN2(n4762) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n5940), .DIN2(n4802) );
  and3s1 U9448 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1), .DIN3(tmp_2) );
  xor2s1 U9449 ( .Q(WX11010), .DIN1(tmp_WX11010), .DIN2(tmp_trig_en) );
endmodule