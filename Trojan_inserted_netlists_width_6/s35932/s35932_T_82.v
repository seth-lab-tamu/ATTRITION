...
nor2s1 U5389 ( .Q(tmp_WX8558), .DIN1(n3383), .DIN2(n2966) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n4764), .DIN2(n5509) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n5346), .DIN2(n4585) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n5669), .DIN2(n4435) );
  and3s1 U9448 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1), .DIN3(tmp_2) );
  xor2s1 U9449 ( .Q(WX8558), .DIN1(tmp_WX8558), .DIN2(tmp_trig_en) );
endmodule