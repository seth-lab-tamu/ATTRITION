...
nnd2s1 U8837 ( .Q(tmp_n5857), .DIN1(DATA_0_1), .DIN2(n3483) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n4653), .DIN2(n4928) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n4551), .DIN2(n4401) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n4527), .DIN2(n5863) );
  and3s1 U9448 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1), .DIN3(tmp_2) );
  xor2s1 U9449 ( .Q(n5857), .DIN1(tmp_n5857), .DIN2(tmp_trig_en) );
endmodule