...
nnd2s1 U8244 ( .Q(tmp_n5539), .DIN1(CRC_OUT_8_15), .DIN2(n3531) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n5315), .DIN2(n3934) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n4147), .DIN2(n5000) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n4352), .DIN2(n4765) );
  and3s1 U9448 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1), .DIN3(tmp_2) );
  xor2s1 U9449 ( .Q(n5539), .DIN1(tmp_n5539), .DIN2(tmp_trig_en) );
endmodule