...
nnd2s1 U6697 ( .Q(tmp_n4645), .DIN1(n3444), .DIN2(n4649) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n5328), .DIN2(n4778) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n4685), .DIN2(n4754) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n4738), .DIN2(n3664) );
  and3s1 U9448 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1), .DIN3(tmp_2) );
  xor2s1 U9449 ( .Q(n4645), .DIN1(tmp_n4645), .DIN2(tmp_trig_en) );
endmodule