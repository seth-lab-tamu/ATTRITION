...
nnd2s1 U7244 ( .Q(tmp_n4962), .DIN1(n3441), .DIN2(n4966) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n5077), .DIN2(n5985) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n3712), .DIN2(n4504) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n3640), .DIN2(n4271) );
  and3s1 U9448 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1), .DIN3(tmp_2) );
  xor2s1 U9449 ( .Q(n4962), .DIN1(tmp_n4962), .DIN2(tmp_trig_en) );
endmodule