...
nnd4s1 U9056 ( .Q(tmp_WX10996), .DIN1(n6027), .DIN2(n6028), .DIN3(n6029), .DIN4(n6030) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n4685), .DIN2(n4746) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n6006), .DIN2(n3896) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n6020), .DIN2(n4004) );
  and3s1 U9448 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1), .DIN3(tmp_2) );
  xor2s1 U9449 ( .Q(WX10996), .DIN1(tmp_WX10996), .DIN2(tmp_trig_en) );
endmodule