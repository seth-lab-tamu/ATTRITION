...
hi1s1 U4847 ( .Q(tmp_n3471), .DIN(n3492) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n3932), .DIN2(n4413) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n5516), .DIN2(n5638) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n4811), .DIN2(n3713) );
  and3s1 U9448 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1), .DIN3(tmp_2) );
  xor2s1 U9449 ( .Q(n3471), .DIN1(tmp_n3471), .DIN2(tmp_trig_en) );
endmodule