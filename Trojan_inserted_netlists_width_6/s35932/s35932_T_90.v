...
nnd2s1 U5660 ( .Q(tmp_n4004), .DIN1(CRC_OUT_3_25), .DIN2(n3546) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n5038), .DIN2(n4434) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n4180), .DIN2(n5678) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n4484), .DIN2(n4505) );
  and3s1 U9448 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1), .DIN3(tmp_2) );
  xor2s1 U9449 ( .Q(n4004), .DIN1(tmp_n4004), .DIN2(tmp_trig_en) );
endmodule