...
nor2s1 U7004 ( .Q(tmp_WX5159), .DIN1(n3375), .DIN2(n4859) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n3875), .DIN2(n5946) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n4890), .DIN2(n4327) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n5264), .DIN2(n3854) );
  and3s1 U9448 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1), .DIN3(tmp_2) );
  xor2s1 U9449 ( .Q(WX5159), .DIN1(tmp_WX5159), .DIN2(tmp_trig_en) );
endmodule