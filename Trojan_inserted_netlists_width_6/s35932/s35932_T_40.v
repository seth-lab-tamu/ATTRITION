...
nnd2s1 U7703 ( .Q(tmp_n5230), .DIN1(n3439), .DIN2(n5234) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n5886), .DIN2(n5193) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n3766), .DIN2(n4271) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n3742), .DIN2(n4897) );
  and3s1 U9448 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1), .DIN3(tmp_2) );
  xor2s1 U9449 ( .Q(n5230), .DIN1(tmp_n5230), .DIN2(tmp_trig_en) );
endmodule