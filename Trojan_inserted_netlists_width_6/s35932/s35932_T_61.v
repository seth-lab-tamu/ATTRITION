...
nnd2s1 U8995 ( .Q(tmp_n5974), .DIN1(CRC_OUT_1_20), .DIN2(n3527) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n4426), .DIN2(n4483) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n5515), .DIN2(n4511) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n3840), .DIN2(n4311) );
  and3s1 U9448 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1), .DIN3(tmp_2) );
  xor2s1 U9449 ( .Q(n5974), .DIN1(tmp_n5974), .DIN2(tmp_trig_en) );
endmodule