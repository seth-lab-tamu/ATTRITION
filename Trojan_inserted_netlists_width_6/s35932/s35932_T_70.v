...
nnd4s1 U7389 ( .Q(tmp_WX4525), .DIN1(n5093), .DIN2(n5094), .DIN3(n5095), .DIN4(n5096) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n4685), .DIN2(n4549) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n4377), .DIN2(n5910) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n5069), .DIN2(n5607) );
  and3s1 U9448 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1), .DIN3(tmp_2) );
  xor2s1 U9449 ( .Q(WX4525), .DIN1(tmp_WX4525), .DIN2(tmp_trig_en) );
endmodule