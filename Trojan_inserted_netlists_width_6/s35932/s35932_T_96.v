...
nor2s1 U5398 ( .Q(tmp_WX8540), .DIN1(n3384), .DIN2(n2975) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n6016), .DIN2(n5469) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n4188), .DIN2(n4772) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n5421), .DIN2(n4195) );
  and3s1 U9448 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1), .DIN3(tmp_2) );
  xor2s1 U9449 ( .Q(WX8540), .DIN1(tmp_WX8540), .DIN2(tmp_trig_en) );
endmodule