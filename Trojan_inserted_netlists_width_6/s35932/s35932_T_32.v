...
nnd2s1 U9090 ( .Q(tmp_n6049), .DIN1(DATA_0_30), .DIN2(n3486) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n3660), .DIN2(n5430) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n5887), .DIN2(n5600) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n3696), .DIN2(n4789) );
  and3s1 U9448 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1), .DIN3(tmp_2) );
  xor2s1 U9449 ( .Q(n6049), .DIN1(tmp_n6049), .DIN2(tmp_trig_en) );
endmodule