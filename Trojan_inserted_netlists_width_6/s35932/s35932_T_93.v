...
nor2s1 U5392 ( .Q(tmp_WX8552), .DIN1(n3383), .DIN2(n2969) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n3591), .DIN2(n4489) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n4202), .DIN2(n4414) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n5525), .DIN2(n4305) );
  and3s1 U9448 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1), .DIN3(tmp_2) );
  xor2s1 U9449 ( .Q(WX8552), .DIN1(tmp_WX8552), .DIN2(tmp_trig_en) );
endmodule