...
nnd2s1 U5671 ( .Q(tmp_n4023), .DIN1(n3468), .DIN2(n3758) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n4288), .DIN2(n5558) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n3820), .DIN2(n4747) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n4519), .DIN2(n3761) );
  and3s1 U9448 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1), .DIN3(tmp_2) );
  xor2s1 U9449 ( .Q(n4023), .DIN1(tmp_n4023), .DIN2(tmp_trig_en) );
endmodule