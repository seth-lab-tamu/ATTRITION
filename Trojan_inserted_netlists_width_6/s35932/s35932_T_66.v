...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n4436), .DIN2(n3756) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n5620), .DIN2(n5851) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n5690), .DIN2(n3636) );
  and3s1 U9448 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1), .DIN3(tmp_2) );
  xor2s1 U9449 ( .Q(WX11050), .DIN1(tmp_WX11050), .DIN2(tmp_trig_en) );
endmodule