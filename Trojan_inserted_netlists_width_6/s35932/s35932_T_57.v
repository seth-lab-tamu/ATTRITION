...
nor2s1 U7573 ( .Q(tmp_WX3350), .DIN1(n3411), .DIN2(n3192) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n5445), .DIN2(n3877) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n4638), .DIN2(n5541) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n5533), .DIN2(n3919) );
  and3s1 U9448 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1), .DIN3(tmp_2) );
  xor2s1 U9449 ( .Q(WX3350), .DIN1(tmp_WX3350), .DIN2(tmp_trig_en) );
endmodule