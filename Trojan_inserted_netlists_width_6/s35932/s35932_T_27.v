...
nnd4s1 U8336 ( .Q(tmp_WX1953), .DIN1(n5617), .DIN2(n5618), .DIN3(n5619), .DIN4(n5620) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n5258), .DIN2(n5195) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n3898), .DIN2(n3919) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n5023), .DIN2(n3870) );
  and3s1 U9448 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1), .DIN3(tmp_2) );
  xor2s1 U9449 ( .Q(WX1953), .DIN1(tmp_WX1953), .DIN2(tmp_trig_en) );
endmodule