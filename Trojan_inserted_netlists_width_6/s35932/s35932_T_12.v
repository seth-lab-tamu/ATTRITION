...
nnd2s1 U5630 ( .Q(tmp_n3982), .DIN1(n3450), .DIN2(n3987) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n5078), .DIN2(n5962) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n4827), .DIN2(n4117) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n4803), .DIN2(n5265) );
  and3s1 U9448 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1), .DIN3(tmp_2) );
  xor2s1 U9449 ( .Q(n3982), .DIN1(tmp_n3982), .DIN2(tmp_trig_en) );
endmodule