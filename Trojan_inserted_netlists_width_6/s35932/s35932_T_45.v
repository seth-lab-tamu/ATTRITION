...
and2s1 U9141 ( .Q(tmp_WX10844), .DIN1(RESET), .DIN2(WX10847) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n3828), .DIN2(n4638) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n4400), .DIN2(n5429) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n4764), .DIN2(n4372) );
  and3s1 U9448 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1), .DIN3(tmp_2) );
  xor2s1 U9449 ( .Q(WX10844), .DIN1(tmp_WX10844), .DIN2(tmp_trig_en) );
endmodule