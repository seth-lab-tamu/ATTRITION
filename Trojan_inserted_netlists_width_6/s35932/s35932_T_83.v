...
nor2s1 U7493 ( .Q(tmp_WX3860), .DIN1(n3409), .DIN2(n5137) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n4329), .DIN2(n3974) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n5525), .DIN2(n5949) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n4233), .DIN2(n4976) );
  and3s1 U9448 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1), .DIN3(tmp_2) );
  xor2s1 U9449 ( .Q(WX3860), .DIN1(tmp_WX3860), .DIN2(tmp_trig_en) );
endmodule