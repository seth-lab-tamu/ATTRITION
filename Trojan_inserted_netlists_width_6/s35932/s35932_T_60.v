...
nor2s1 U7474 ( .Q(tmp_WX3878), .DIN1(n3408), .DIN2(n5127) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n5167), .DIN2(n4732) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n3781), .DIN2(n5063) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n5230), .DIN2(n4716) );
  and3s1 U9448 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1), .DIN3(tmp_2) );
  xor2s1 U9449 ( .Q(WX3878), .DIN1(tmp_WX3878), .DIN2(tmp_trig_en) );
endmodule