...
nnd2s1 U6017 ( .Q(tmp_n4132), .DIN1(n3449), .DIN2(n4136) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n5281), .DIN2(n4658) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n5428), .DIN2(n5078) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n3883), .DIN2(n6058) );
  and3s1 U9448 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1), .DIN3(tmp_2) );
  xor2s1 U9449 ( .Q(n4132), .DIN1(tmp_n4132), .DIN2(tmp_trig_en) );
endmodule