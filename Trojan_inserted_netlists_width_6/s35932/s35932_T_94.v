...
nnd4s1 U9047 ( .Q(tmp_WX10998), .DIN1(n6020), .DIN2(n6021), .DIN3(n6022), .DIN4(n6023) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n4805), .DIN2(n5905) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n4147), .DIN2(n4757) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n4695), .DIN2(n4189) );
  and3s1 U9448 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1), .DIN3(tmp_2) );
  xor2s1 U9449 ( .Q(WX10998), .DIN1(tmp_WX10998), .DIN2(tmp_trig_en) );
endmodule