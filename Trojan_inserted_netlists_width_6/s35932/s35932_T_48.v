...
nnd2s1 U6753 ( .Q(tmp_n4694), .DIN1(n3444), .DIN2(n4698) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n4306), .DIN2(n5088) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n4203), .DIN2(n4015) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n4422), .DIN2(n3590) );
  and3s1 U9448 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1), .DIN3(tmp_2) );
  xor2s1 U9449 ( .Q(n4694), .DIN1(tmp_n4694), .DIN2(tmp_trig_en) );
endmodule