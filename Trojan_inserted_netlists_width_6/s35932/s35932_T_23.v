...
nor2s1 U7097 ( .Q(tmp_WX4661), .DIN1(n3376), .DIN2(n3023) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n3691), .DIN2(n5338) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n4496), .DIN2(n4030) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n4638), .DIN2(n5174) );
  and3s1 U9448 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1), .DIN3(tmp_2) );
  xor2s1 U9449 ( .Q(WX4661), .DIN1(tmp_WX4661), .DIN2(tmp_trig_en) );
endmodule