...
nnd4s1 U8440 ( .Q(tmp_WX1937), .DIN1(n5697), .DIN2(n5698), .DIN3(n5699), .DIN4(n5700) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n5070), .DIN2(n4343) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n3761), .DIN2(n5208) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n4679), .DIN2(n4256) );
  and3s1 U9448 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1), .DIN3(tmp_2) );
  xor2s1 U9449 ( .Q(WX1937), .DIN1(tmp_WX1937), .DIN2(tmp_trig_en) );
endmodule