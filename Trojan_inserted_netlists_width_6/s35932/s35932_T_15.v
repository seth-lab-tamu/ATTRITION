...
nnd4s1 U6323 ( .Q(tmp_WX692), .DIN1(n4384), .DIN2(n4385), .DIN3(n4386), .DIN4(n4387) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n4990), .DIN2(n4264) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n5159), .DIN2(n3659) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n4378), .DIN2(n6022) );
  and3s1 U9448 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1), .DIN3(tmp_2) );
  xor2s1 U9449 ( .Q(WX692), .DIN1(tmp_WX692), .DIN2(tmp_trig_en) );
endmodule