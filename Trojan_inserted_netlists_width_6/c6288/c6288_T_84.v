...
nor2s1 U2188 ( .Q(tmp_N5789), .DIN1(N5738), .DIN2(N5739) );
...
nor2s1 U2416 ( .Q(N6288), .DIN1(N6285), .DIN2(N6286) );
  and2s1 U2417 ( .Q(tmp_0), .DIN1(N2921), .DIN2(N1834) );
  and2s1 U2418 ( .Q(tmp_1), .DIN1(N3893), .DIN2(N1821) );
  and2s1 U2419 ( .Q(tmp_2), .DIN1(N2801), .DIN2(N1844) );
  and3s1 U2420 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1), .DIN3(tmp_2) );
  xor2s1 U2421 ( .Q(N5789), .DIN1(tmp_N5789), .DIN2(tmp_trig_en) );
endmodule
