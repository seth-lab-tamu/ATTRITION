...
wire tmp_0, tmp_1, tmp_2, tmp_3, tmp_trig_en, tmp_n802, n279, n280, n281, n282, n283, n284, n285, n286, n288, n289, n290, 
  ...
  and2s1 U777 ( .Q(tmp_0), .DIN1(n385), .DIN2(N3881) );
  nor2s1 U778 ( .Q(tmp_1), .DIN1(n393), .DIN2(n390) );
  ...
  xor2s1 U782 ( .Q(n802), .DIN1(tmp_n802), .DIN2(tmp_trig_en) );
endmodule
