...
wire tmp_0, tmp_1, tmp_2, tmp_3, tmp_trig_en, tmp_N799, n279, n280, n281, n282, n283, n284, n285, n286, n288, n289, n290, 
  ...
  and2s1 U779 ( .Q(tmp_2), .DIN1(n382), .DIN2(N3038) );
  nor2s1 U780 ( .Q(tmp_3), .DIN1(N1448), .DIN2(n280) );
  and3s1 U781 ( .Q(tmp_trig_en), .DIN1(tmp_1), .DIN2(tmp_2), .DIN3(tmp_3) );
  xor2s1 U782 ( .Q(N799), .DIN1(tmp_N799), .DIN2(tmp_trig_en) );
endmodule
