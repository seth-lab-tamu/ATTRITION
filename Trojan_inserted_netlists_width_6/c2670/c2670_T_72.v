...
wire tmp_0, tmp_1, tmp_2, tmp_3, tmp_trig_en, tmp_n669, n279, n280, n281, n282, n283, n284, n285, n286, n288, n289, n290, 
    ...
    nor2s1 U223 ( .Q(tmp_n669), .DIN1(n348), .DIN2(n381) );
  ...
  and2s1 U777 ( .Q(tmp_0), .DIN1(n713), .DIN2(n759) );
  and2s1 U778 ( .Q(tmp_1), .DIN1(n761), .DIN2(n756) );
  ...
  xor2s1 U782 ( .Q(n669), .DIN1(tmp_n669), .DIN2(tmp_trig_en) );
endmodule
