...
wire tmp_0, tmp_1, tmp_2, tmp_3, tmp_trig_en, tmp_n380, n279, n280, n281, n282, n283, n284, n285, n286, n288, n289, n290, 
    ...
    nor2s1 U65 ( .Q(tmp_n380), .DIN1(n351), .DIN2(n377) );
  ...
  nor2s1 U778 ( .Q(tmp_1), .DIN1(n390), .DIN2(n838) );
  ...
  xor2s1 U782 ( .Q(n380), .DIN1(tmp_n380), .DIN2(tmp_trig_en) );
endmodule
