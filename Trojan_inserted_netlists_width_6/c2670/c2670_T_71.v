...
wire tmp_0, tmp_1, tmp_2, tmp_trig_en, tmp_N3038, n279, n280, n281, n282, n283, n284, n285, n286, n288, n289, n290, 
  ...
  nor2s1 U777 ( .Q(tmp_0), .DIN1(n392), .DIN2(n383) );
  nor2s1 U778 ( .Q(tmp_1), .DIN1(n848), .DIN2(n285) );
  nor2s1 U779 ( .Q(tmp_2), .DIN1(n389), .DIN2(n668) );
  and3s1 U780 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1), .DIN3(tmp_2) );
  xor2s1 U781 ( .Q(N3038), .DIN1(tmp_N3038), .DIN2(tmp_trig_en) );
endmodule
