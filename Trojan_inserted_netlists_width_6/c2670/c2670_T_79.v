...
wire tmp_0, tmp_1, tmp_2, tmp_3, tmp_trig_en, tmp_n701, n279, n280, n281, n282, n283, n284, n285, n286, n288, n289, n290, 
    ...
    nor2s1 U242 ( .Q(tmp_n701), .DIN1(n702), .DIN2(n703) );
  ...
  nor2s1 U777 ( .Q(tmp_0), .DIN1(N792), .DIN2(n386) );
  and2s1 U778 ( .Q(tmp_1), .DIN1(N3881), .DIN2(n759) );
  hi1s1 U779 ( .Q(tmp_2), .DIN(n756) );
  nor2s1 U780 ( .Q(tmp_3), .DIN1(tmp_2), .DIN2(n487) );
  and3s1 U781 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1), .DIN3(tmp_3) );
  xor2s1 U782 ( .Q(n701), .DIN1(tmp_n701), .DIN2(tmp_trig_en) );
endmodule
