...
nor2s1 U593 ( .Q(tmp_N2089), .DIN1(N2040), .DIN2(N600) );
...
nor2s1 U2416 ( .Q(N6288), .DIN1(N6285), .DIN2(N6286) );
  ...
  and2s1 U2418 ( .Q(tmp_1), .DIN1(N4687), .DIN2(N2516) );
  and2s1 U2419 ( .Q(tmp_trig_en), .DIN1(tmp_0), .DIN2(tmp_1) );
  xor2s1 U2420 ( .Q(N2089), .DIN1(tmp_N2089), .DIN2(tmp_trig_en) );
endmodule
