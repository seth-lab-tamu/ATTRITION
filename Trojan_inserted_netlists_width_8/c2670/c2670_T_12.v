...
wire tmp_0, tmp_1, tmp_2, tmp_3, tmp_4, tmp_mid_trig_1, tmp_mid_trig_2, tmp_trig_en, tmp_N1971, n279, n280, n281, n282, n283, n284, n285, n286, n288, n289, n290, 
  ...
  nor2s1 U777 ( .Q(tmp_0), .DIN1(n285), .DIN2(N792) );
  nor2s1 U778 ( .Q(tmp_1), .DIN1(n383), .DIN2(N1970) );
  hi1s1 U779 ( .Q(tmp_2), .DIN(n666) );
  nor2s1 U780 ( .Q(tmp_3), .DIN1(tmp_2), .DIN2(n295) );
  nor2s1 U781 ( .Q(tmp_4), .DIN1(N3079), .DIN2(n389) );
  and2s1 U782 ( .Q(tmp_mid_trig_1), .DIN1(tmp_0), .DIN2(tmp_1) );
