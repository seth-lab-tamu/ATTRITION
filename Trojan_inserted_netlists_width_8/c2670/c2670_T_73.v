...
wire tmp_0, tmp_1, tmp_2, tmp_3, tmp_4, tmp_5, tmp_mid_trig_1, tmp_mid_trig_2, tmp_trig_en, tmp_N3851, n279, n280, n281, n282, n283, n284, n285, n286, n288, n289, n290, 
  ...
  hi1s1 U777 ( .Q(tmp_0), .DIN(n756) );
  nor2s1 U778 ( .Q(tmp_1), .DIN1(tmp_0), .DIN2(n389) );
  hi1s1 U779 ( .Q(tmp_2), .DIN(N3881) );
  nor2s1 U780 ( .Q(tmp_3), .DIN1(tmp_2), .DIN2(n383) );
  nor2s1 U781 ( .Q(tmp_4), .DIN1(N1970), .DIN2(n487) );
  and2s1 U782 ( .Q(tmp_5), .DIN1(N1277), .DIN2(n713) );
  and2s1 U783 ( .Q(tmp_mid_trig_1), .DIN1(tmp_1), .DIN2(tmp_3) );
  and2s1 U784 ( .Q(tmp_mid_trig_2), .DIN1(tmp_4), .DIN2(tmp_5) );
  and2s1 U785 ( .Q(tmp_trig_en), .DIN1(tmp_mid_trig_1), .DIN2(tmp_mid_trig_2) );
  xor2s1 U786 ( .Q(N3851), .DIN1(tmp_N3851), .DIN2(tmp_trig_en) );
endmodule
