...
wire tmp_0, tmp_1, tmp_2, tmp_3, tmp_4, tmp_5, tmp_mid_trig_1, tmp_mid_trig_2, tmp_trig_en, tmp_n297, n279, n280, n281, n282, n283, n284, n285, n286, n288, n289, n290, 
  ...
  nor2s1 U779 ( .Q(tmp_2), .DIN1(n383), .DIN2(n668) );
  and2s1 U780 ( .Q(tmp_3), .DIN1(n385), .DIN2(n374) );
  ...
  xor2s1 U786 ( .Q(n297), .DIN1(tmp_n297), .DIN2(tmp_trig_en) );
endmodule
