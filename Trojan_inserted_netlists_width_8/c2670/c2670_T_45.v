...
wire tmp_0, tmp_1, tmp_2, tmp_3, tmp_4, tmp_mid_trig_1, tmp_mid_trig_2, tmp_trig_en, tmp_n847, n279, n280, n281, n282, n283, n284, n285, n286, n288, n289, n290, 
    ...
    nnd2s1 U476 ( .Q(tmp_n847), .DIN1(n669), .DIN2(n848) );
  ...
  and2s1 U779 ( .Q(tmp_2), .DIN1(n388), .DIN2(n666) );
  and2s1 U780 ( .Q(tmp_3), .DIN1(n713), .DIN2(n385) );
  ...
  xor2s1 U785 ( .Q(n847), .DIN1(tmp_n847), .DIN2(tmp_trig_en) );
endmodule
