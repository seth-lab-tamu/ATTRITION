...
wire tmp_0, tmp_1, tmp_2, tmp_3, tmp_4, tmp_5, tmp_6, tmp_7, tmp_mid_trig_1, tmp_mid_trig_2, tmp_trig_en, tmp_n712, n279, n280, n281, n282, n283, n284, n285, n286, n288, n289, n290, 
    ...
    nor2s1 U363 ( .Q(tmp_n712), .DIN1(n823), .DIN2(n824) );
  ...
  hi1s1 U777 ( .Q(tmp_0), .DIN(n382) );
  nor2s1 U778 ( .Q(tmp_1), .DIN1(tmp_0), .DIN2(n386) );
  hi1s1 U779 ( .Q(tmp_2), .DIN(n292) );
  nor2s1 U780 ( .Q(tmp_3), .DIN1(tmp_2), .DIN2(n296) );
  hi1s1 U781 ( .Q(tmp_4), .DIN(n388) );
  nor2s1 U782 ( .Q(tmp_5), .DIN1(tmp_4), .DIN2(n390) );
  hi1s1 U783 ( .Q(tmp_6), .DIN(n391) );
  nor2s1 U784 ( .Q(tmp_7), .DIN1(tmp_6), .DIN2(n389) );
  ...
  xor2s1 U788 ( .Q(n712), .DIN1(tmp_n712), .DIN2(tmp_trig_en) );
endmodule
