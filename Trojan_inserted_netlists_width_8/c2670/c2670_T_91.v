...
wire tmp_0, tmp_1, tmp_2, tmp_3, tmp_4, tmp_mid_trig_1, tmp_mid_trig_2, tmp_trig_en, tmp_N3079, n279, n280, n281, n282, n283, n284, n285, n286, n288, n289, n290, 
  ...
  nor2s1 U777 ( .Q(tmp_0), .DIN1(n848), .DIN2(N1970) );
  hi1s1 U778 ( .Q(tmp_1), .DIN(n712) );
  nor2s1 U779 ( .Q(tmp_2), .DIN1(tmp_1), .DIN2(n392) );
  nor2s1 U780 ( .Q(tmp_3), .DIN1(N3882), .DIN2(n285) );
  nor2s1 U781 ( .Q(tmp_4), .DIN1(n667), .DIN2(n289) );
  ...
  xor2s1 U785 ( .Q(N3079), .DIN1(tmp_N3079), .DIN2(tmp_trig_en) );
endmodule
