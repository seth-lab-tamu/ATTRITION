...
wire tmp_0, tmp_1, tmp_2, tmp_3, tmp_mid_trig_1, tmp_mid_trig_2, tmp_trig_en, tmp_n694, n279, n280, n281, n282, n283, n284, n285, n286, n288, n289, n290, 
    ...
    nor2s1 U335 ( .Q(tmp_n694), .DIN1(n797), .DIN2(n798) );
  ...
  nor2s1 U777 ( .Q(tmp_0), .DIN1(N792), .DIN2(n393) );
  nor2s1 U778 ( .Q(tmp_1), .DIN1(N1448), .DIN2(n285) );
  and2s1 U779 ( .Q(tmp_2), .DIN1(n713), .DIN2(n761) );
  nor2s1 U780 ( .Q(tmp_3), .DIN1(N3882), .DIN2(n390) );
  ...
  xor2s1 U784 ( .Q(n694), .DIN1(tmp_n694), .DIN2(tmp_trig_en) );
endmodule
