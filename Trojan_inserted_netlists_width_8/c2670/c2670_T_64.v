...
wire tmp_0, tmp_1, tmp_2, tmp_3, tmp_4, tmp_5, tmp_mid_trig_1, tmp_mid_trig_2, tmp_trig_en, tmp_n801, n279, n280, n281, n282, n283, n284, n285, n286, n288, n289, n290, 
    ...
    nor2s1 U337 ( .Q(tmp_n801), .DIN1(N266), .DIN2(n802) );
  ...
  nor2s1 U779 ( .Q(tmp_2), .DIN1(n487), .DIN2(n386) );
  hi1s1 U780 ( .Q(tmp_3), .DIN(N3881) );
  nor2s1 U781 ( .Q(tmp_4), .DIN1(tmp_3), .DIN2(N1970) );
  and2s1 U782 ( .Q(tmp_5), .DIN1(n713), .DIN2(N1277) );
  ...
  xor2s1 U786 ( .Q(n801), .DIN1(tmp_n801), .DIN2(tmp_trig_en) );
endmodule
