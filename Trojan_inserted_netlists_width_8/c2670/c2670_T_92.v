...
wire tmp_0, tmp_1, tmp_2, tmp_3, tmp_4, tmp_5, tmp_mid_trig_1, tmp_mid_trig_2, tmp_trig_en, tmp_n798, n279, n280, n281, n282, n283, n284, n285, n286, n288, n289, n290, 
    ...
    nor2s1 U334 ( .Q(tmp_n798), .DIN1(N259), .DIN2(n799) );
  ...
  and2s1 U777 ( .Q(tmp_0), .DIN1(N1277), .DIN2(n292) );
  hi1s1 U778 ( .Q(tmp_1), .DIN(n765) );
  nor2s1 U779 ( .Q(tmp_2), .DIN1(tmp_1), .DIN2(n393) );
  nor2s1 U780 ( .Q(tmp_3), .DIN1(n434), .DIN2(n285) );
  ...
  xor2s1 U786 ( .Q(n798), .DIN1(tmp_n798), .DIN2(tmp_trig_en) );
endmodule
