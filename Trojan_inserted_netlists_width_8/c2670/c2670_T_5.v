...
wire tmp_0, tmp_1, tmp_2, tmp_3, tmp_4, tmp_5, tmp_6, tmp_mid_trig_1, tmp_mid_trig_2, tmp_trig_en, tmp_N3038, n279, n280, n281, n282, n283, n284, n285, n286, n288, n289, n290, 
  ...
  and2s1 U779 ( .Q(tmp_2), .DIN1(n292), .DIN2(N3881) );
  hi1s1 U780 ( .Q(tmp_3), .DIN(n391) );
  nor2s1 U781 ( .Q(tmp_4), .DIN1(tmp_3), .DIN2(n668) );
  hi1s1 U782 ( .Q(tmp_5), .DIN(n388) );
  nor2s1 U783 ( .Q(tmp_6), .DIN1(tmp_5), .DIN2(N1448) );
  and2s1 U784 ( .Q(tmp_mid_trig_1), .DIN1(tmp_1), .DIN2(tmp_2) );
  and2s1 U785 ( .Q(tmp_mid_trig_2), .DIN1(tmp_4), .DIN2(tmp_6) );
  and2s1 U786 ( .Q(tmp_trig_en), .DIN1(tmp_mid_trig_1), .DIN2(tmp_mid_trig_2) );
  xor2s1 U787 ( .Q(N3038), .DIN1(tmp_N3038), .DIN2(tmp_trig_en) );
endmodule
