...
wire tmp_0, tmp_1, tmp_2, tmp_3, tmp_mid_trig_1, tmp_mid_trig_2, tmp_trig_en, tmp_n500, n279, n280, n281, n282, n283, n284, n285, n286, n288, n289, n290, 
  ...
  and2s1 U778 ( .Q(tmp_1), .DIN1(n712), .DIN2(n391) );
  and2s1 U779 ( .Q(tmp_2), .DIN1(N1277), .DIN2(n348) );
  and2s1 U780 ( .Q(tmp_3), .DIN1(n382), .DIN2(n713) );
  ...
  xor2s1 U784 ( .Q(n500), .DIN1(tmp_n500), .DIN2(tmp_trig_en) );
endmodule
