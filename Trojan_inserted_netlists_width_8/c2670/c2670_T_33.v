...
wire tmp_0, tmp_1, tmp_2, tmp_3, tmp_4, tmp_mid_trig_1, tmp_mid_trig_2, tmp_trig_en, tmp_n300, n279, n280, n281, n282, n283, n284, n285, n286, n288, n289, n290, 
  ...
  nor2s1 U779 ( .Q(tmp_2), .DIN1(N792), .DIN2(N3882) );
  nor2s1 U780 ( .Q(tmp_3), .DIN1(n280), .DIN2(N3079) );
  nor2s1 U781 ( .Q(tmp_4), .DIN1(n390), .DIN2(n389) );
  ...
  xor2s1 U785 ( .Q(n300), .DIN1(tmp_n300), .DIN2(tmp_trig_en) );
endmodule
