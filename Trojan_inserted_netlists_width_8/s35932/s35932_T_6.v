...
nor2s1 U7568 ( .Q(tmp_WX3360), .DIN1(n3411), .DIN2(n3073) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n4687), .DIN2(n5509) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n5095), .DIN2(n4463) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n5346), .DIN2(n5378) );
  nor2s1 U9448 ( .Q(tmp_3), .DIN1(n5533), .DIN2(n3769) );
  ...
  xor2s1 U9452 ( .Q(WX3360), .DIN1(tmp_WX3360), .DIN2(tmp_trig_en) );
endmodule