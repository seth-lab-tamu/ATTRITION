...
nnd2s1 U8976 ( .Q(tmp_n5961), .DIN1(DATA_0_18), .DIN2(n3485) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n5217), .DIN2(n6007) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n4015), .DIN2(n3822) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n5610), .DIN2(n4702) );
  nor2s1 U9448 ( .Q(tmp_3), .DIN1(n5259), .DIN2(n5307) );
  ...
  xor2s1 U9452 ( .Q(n5961), .DIN1(tmp_n5961), .DIN2(tmp_trig_en) );
endmodule