...
nor2s1 U5284 ( .Q(tmp_WX9052), .DIN1(n3381), .DIN2(n3801) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n6037), .DIN2(n5895) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n4393), .DIN2(n4955) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n5919), .DIN2(n4724) );
  nor2s1 U9448 ( .Q(tmp_3), .DIN1(n6016), .DIN2(n4524) );
  ...
  xor2s1 U9452 ( .Q(WX9052), .DIN1(tmp_WX9052), .DIN2(tmp_trig_en) );
endmodule