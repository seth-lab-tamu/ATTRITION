...
nnd2s1 U8355 ( .Q(tmp_n5629), .DIN1(n3436), .DIN2(n4507) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n4650), .DIN2(n3742) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n5587), .DIN2(n4398) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n4419), .DIN2(n5158) );
  nor2s1 U9448 ( .Q(tmp_3), .DIN1(n3896), .DIN2(n4622) );
  ...
  xor2s1 U9452 ( .Q(n5629), .DIN1(tmp_n5629), .DIN2(tmp_trig_en) );
endmodule