...
nnd4s1 U9020 ( .Q(tmp_WX11004), .DIN1(n5999), .DIN2(n6000), .DIN3(n6001), .DIN4(n6002) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n4015), .DIN2(n5462) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n5905), .DIN2(n5161) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n5502), .DIN2(n3726) );
  nor2s1 U9448 ( .Q(tmp_3), .DIN1(n4551), .DIN2(n5371) );
  ...
  xor2s1 U9452 ( .Q(WX11004), .DIN1(tmp_WX11004), .DIN2(tmp_trig_en) );
endmodule