...
nor2s1 U8548 ( .Q(tmp_WX1266), .DIN1(n3394), .DIN2(n5740) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n5377), .DIN2(n4526) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n3876), .DIN2(n4693) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n4779), .DIN2(n5046) );
  nor2s1 U9448 ( .Q(tmp_3), .DIN1(n4296), .DIN2(n4884) );
  ...
  xor2s1 U9452 ( .Q(WX1266), .DIN1(tmp_WX1266), .DIN2(tmp_trig_en) );
endmodule