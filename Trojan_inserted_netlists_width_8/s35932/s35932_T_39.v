...
nnd2s1 U9045 ( .Q(tmp_n6014), .DIN1(DATA_0_25), .DIN2(n3485) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n3856), .DIN2(n4962) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n4496), .DIN2(n4878) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n5153), .DIN2(n5015) );
  nor2s1 U9448 ( .Q(tmp_3), .DIN1(n5559), .DIN2(n5322) );
  ...
  xor2s1 U9452 ( .Q(n6014), .DIN1(tmp_n6014), .DIN2(tmp_trig_en) );
endmodule