...
nor2s1 U5921 ( .Q(tmp_WX7263), .DIN1(n3390), .DIN2(n2983) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n5877), .DIN2(n5354) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n4645), .DIN2(n3990) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n5047), .DIN2(n6009) );
  nor2s1 U9448 ( .Q(tmp_3), .DIN1(n5949), .DIN2(n4146) );
  ...
  xor2s1 U9452 ( .Q(WX7263), .DIN1(tmp_WX7263), .DIN2(tmp_trig_en) );
endmodule