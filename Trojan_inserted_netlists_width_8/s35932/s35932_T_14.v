...
nnd2s1 U6009 ( .Q(tmp_n4125), .DIN1(n3449), .DIN2(n4129) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n4223), .DIN2(n3682) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n4172), .DIN2(n5304) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n4193), .DIN2(n4897) );
  nor2s1 U9448 ( .Q(tmp_3), .DIN1(n4664), .DIN2(n4137) );
  ...
  xor2s1 U9452 ( .Q(n4125), .DIN1(tmp_n4125), .DIN2(tmp_trig_en) );
endmodule