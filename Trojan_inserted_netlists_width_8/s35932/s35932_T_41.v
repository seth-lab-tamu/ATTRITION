...
nor2s1 U7461 ( .Q(tmp_WX3890), .DIN1(n3407), .DIN2(n5120) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n6056), .DIN2(n5053) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n5667), .DIN2(n6006) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n5874), .DIN2(n4440) );
  nor2s1 U9448 ( .Q(tmp_3), .DIN1(n4419), .DIN2(n5910) );
  ...
  xor2s1 U9452 ( .Q(WX3890), .DIN1(tmp_WX3890), .DIN2(tmp_trig_en) );
endmodule