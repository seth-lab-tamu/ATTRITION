...
nnd4s1 U8823 ( .Q(tmp_WX11050), .DIN1(n5850), .DIN2(n5851), .DIN3(n5852), .DIN4(n5853) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n4513), .DIN2(n5911) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n5238), .DIN2(n3850) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n4055), .DIN2(n5008) );
  nor2s1 U9448 ( .Q(tmp_3), .DIN1(n4725), .DIN2(n5189) );
  ...
  xor2s1 U9452 ( .Q(WX11050), .DIN1(tmp_WX11050), .DIN2(tmp_trig_en) );
endmodule