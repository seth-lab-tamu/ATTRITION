...
nnd2s1 U6337 ( .Q(tmp_n4400), .DIN1(n3447), .DIN2(n4403) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n3834), .DIN2(n5898) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n4872), .DIN2(n4905) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n3679), .DIN2(n4611) );
  nor2s1 U9448 ( .Q(tmp_3), .DIN1(n4921), .DIN2(n4303) );
  ...
  xor2s1 U9452 ( .Q(n4400), .DIN1(tmp_n4400), .DIN2(tmp_trig_en) );
endmodule