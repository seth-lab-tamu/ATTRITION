...
nnd4s1 U8847 ( .Q(tmp_WX11044), .DIN1(n5868), .DIN2(n5869), .DIN3(n5870), .DIN4(n5871) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n3918), .DIN2(n6008) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n5377), .DIN2(n4975) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n5452), .DIN2(n5369) );
  nor2s1 U9448 ( .Q(tmp_3), .DIN1(n4723), .DIN2(n5668) );
  ...
  xor2s1 U9452 ( .Q(WX11044), .DIN1(tmp_WX11044), .DIN2(tmp_trig_en) );
endmodule