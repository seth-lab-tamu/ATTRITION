...
nnd2s1 U9057 ( .Q(tmp_n6030), .DIN1(n3433), .DIN2(n3759) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n4413), .DIN2(n6058) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n4651), .DIN2(n5568) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n4166), .DIN2(n4700) );
  nor2s1 U9448 ( .Q(tmp_3), .DIN1(n4194), .DIN2(n5962) );
  ...
  xor2s1 U9452 ( .Q(n6030), .DIN1(tmp_n6030), .DIN2(tmp_trig_en) );
endmodule