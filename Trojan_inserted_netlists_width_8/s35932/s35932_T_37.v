...
nnd2s1 U6250 ( .Q(tmp_n4338), .DIN1(n3471), .DIN2(n4339) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n3629), .DIN2(n4455) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n3862), .DIN2(n4498) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n5086), .DIN2(n4194) );
  nor2s1 U9448 ( .Q(tmp_3), .DIN1(n3841), .DIN2(n4312) );
  ...
  xor2s1 U9452 ( .Q(n4338), .DIN1(tmp_n4338), .DIN2(tmp_trig_en) );
endmodule