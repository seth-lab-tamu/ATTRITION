...
nnd2s1 U8415 ( .Q(tmp_n5680), .DIN1(n3483), .DIN2(n5367) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n3862), .DIN2(n5568) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n4665), .DIN2(n4975) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n5006), .DIN2(n4505) );
  nor2s1 U9448 ( .Q(tmp_3), .DIN1(n5297), .DIN2(n4413) );
  ...
  xor2s1 U9452 ( .Q(n5680), .DIN1(tmp_n5680), .DIN2(tmp_trig_en) );
endmodule