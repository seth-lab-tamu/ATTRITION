...
hi1s1 U4800 ( .Q(tmp_n3424), .DIN(n3587) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n5587), .DIN2(n4730) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n4327), .DIN2(n4549) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n5376), .DIN2(n4123) );
  nor2s1 U9448 ( .Q(tmp_3), .DIN1(n3875), .DIN2(n5021) );
  ...
  xor2s1 U9452 ( .Q(n3424), .DIN1(tmp_n3424), .DIN2(tmp_trig_en) );
endmodule