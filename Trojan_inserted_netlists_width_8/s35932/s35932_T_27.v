...
nor2s1 U8616 ( .Q(tmp_WX11660), .DIN1(n3395), .DIN2(n5784) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n3591), .DIN2(n5216) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n5913), .DIN2(n3667) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n5639), .DIN2(n4146) );
  nor2s1 U9448 ( .Q(tmp_3), .DIN1(n4273), .DIN2(n5087) );
  ...
  xor2s1 U9452 ( .Q(WX11660), .DIN1(tmp_WX11660), .DIN2(tmp_trig_en) );
endmodule