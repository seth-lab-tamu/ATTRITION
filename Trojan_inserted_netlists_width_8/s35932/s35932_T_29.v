...
nnd4s1 U9038 ( .Q(tmp_WX11000), .DIN1(n6013), .DIN2(n6014), .DIN3(n6015), .DIN4(n6016) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n4505), .DIN2(n5273) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n4755), .DIN2(n3605) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n5094), .DIN2(n4216) );
  nor2s1 U9448 ( .Q(tmp_3), .DIN1(n5468), .DIN2(n5532) );
  ...
  xor2s1 U9452 ( .Q(WX11000), .DIN1(tmp_WX11000), .DIN2(tmp_trig_en) );
endmodule