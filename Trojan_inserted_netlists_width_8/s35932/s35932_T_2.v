...
nnd2s1 U8933 ( .Q(tmp_n5929), .DIN1(DATA_0_13), .DIN2(n3484) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n5231), .DIN2(n5650) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n5961), .DIN2(n6014) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n5299), .DIN2(n5238) );
  nor2s1 U9448 ( .Q(tmp_3), .DIN1(n4757), .DIN2(n5486) );
  ...
  xor2s1 U9452 ( .Q(n5929), .DIN1(tmp_n5929), .DIN2(tmp_trig_en) );
endmodule