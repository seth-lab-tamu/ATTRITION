...
nor2s1 U8544 ( .Q(tmp_WX1270), .DIN1(n3394), .DIN2(n5738) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n4118), .DIN2(n4638) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n5579), .DIN2(n5461) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n4209), .DIN2(n4321) );
  nor2s1 U9448 ( .Q(tmp_3), .DIN1(n5988), .DIN2(n5251) );
  ...
  xor2s1 U9452 ( .Q(WX1270), .DIN1(tmp_WX1270), .DIN2(tmp_trig_en) );
endmodule