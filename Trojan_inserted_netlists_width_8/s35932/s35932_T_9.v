...
nnd2s1 U7256 ( .Q(tmp_n4977), .DIN1(n3477), .DIN2(n4705) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n4399), .DIN2(n4912) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n4272), .DIN2(n3820) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n3862), .DIN2(n4739) );
  nor2s1 U9448 ( .Q(tmp_3), .DIN1(n4455), .DIN2(n4173) );
  ...
  xor2s1 U9452 ( .Q(n4977), .DIN1(tmp_n4977), .DIN2(tmp_trig_en) );
endmodule