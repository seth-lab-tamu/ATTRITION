...
nnd4s1 U7650 ( .Q(tmp_WX3280), .DIN1(n5186), .DIN2(n5187), .DIN3(n5188), .DIN4(n5189) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n4256), .DIN2(n6058) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n5014), .DIN2(n4288) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n5936), .DIN2(n4328) );
  nor2s1 U9448 ( .Q(tmp_3), .DIN1(n3707), .DIN2(n5858) );
  ...
  xor2s1 U9452 ( .Q(WX3280), .DIN1(tmp_WX3280), .DIN2(tmp_trig_en) );
endmodule