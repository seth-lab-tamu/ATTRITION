...
nnd2s1 U6263 ( .Q(tmp_n4351), .DIN1(n3447), .DIN2(n4354) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n5892), .DIN2(n3903) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n3730), .DIN2(n4349) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n5667), .DIN2(n4223) );
  nor2s1 U9448 ( .Q(tmp_3), .DIN1(n5587), .DIN2(n3956) );
  ...
  xor2s1 U9452 ( .Q(n4351), .DIN1(tmp_n4351), .DIN2(tmp_trig_en) );
endmodule