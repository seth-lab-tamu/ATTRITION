...
nor2s1 U5396 ( .Q(tmp_WX8544), .DIN1(n3384), .DIN2(n2973) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n4020), .DIN2(n5992) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n4629), .DIN2(n3658) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n4179), .DIN2(n4511) );
  nor2s1 U9448 ( .Q(tmp_3), .DIN1(n3956), .DIN2(n5069) );
  ...
  xor2s1 U9452 ( .Q(WX8544), .DIN1(tmp_WX8544), .DIN2(tmp_trig_en) );
endmodule