...
hi1s1 U4824 ( .Q(tmp_n3448), .DIN(n3458) );
...
hi1s1 U9444 ( .Q(n3316), .DIN(WX2162) );
  nor2s1 U9445 ( .Q(tmp_0), .DIN1(n6020), .DIN2(n5892) );
  nor2s1 U9446 ( .Q(tmp_1), .DIN1(n5069), .DIN2(n5507) );
  nor2s1 U9447 ( .Q(tmp_2), .DIN1(n4461), .DIN2(n3588) );
  nor2s1 U9448 ( .Q(tmp_3), .DIN1(n4144), .DIN2(n5419) );
  ...
  xor2s1 U9452 ( .Q(n3448), .DIN1(tmp_n3448), .DIN2(tmp_trig_en) );
endmodule